INSERT INTO `user_native`  (`email`, `password`, `first_name`, `last_name`, `user_name`) VALUES ('jdoe@corp.com', '$2a$04$oSWA81OzAMQfHh9q5m3iJurx9L4HGHimPzEaHqcONA9VNBFj6joc6', 'Joe', 'Doe','sparky');
