	...
	public static Connection getConnection() {
		...
		try {
			...
			if(connection==null) {
				...
				//connection = DriverManager.getConnection("jdbc:mysql://localhost:3308/dwh_inventory", "root", "adsAdmin1");
				connection = DriverManager.getConnection("jdbc:mysql://10.216.15.36:3306/dwh_inventory", "root", "ugauga");
