...
public class InterfaceConfigInfoChild {
    ...
    {
        return "ClassPojo [ipspaceName = "+ipspaceName+", flowcontrol = "+flowcontrol+", interfaceName = "+interfaceName+", macAddress = "+macAddress+", v4PrimaryAddress = "+v4PrimaryAddress+", mediatype = "+mediatype+"]";
    }
}
