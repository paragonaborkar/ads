...
package ads_data_no_git.adsload_subjob_sendemail_0_1;
...
/**
 * Job: ADSLoad_SubJob_SendEmail Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.0.20170510_1410
 * @status 
 */
public class ADSLoad_SubJob_SendEmail implements TalendJob {
...
public String getADS_EMAIL_AUTHENTICATION_PASSWORD(){
	...
	private final String jobName = "ADSLoad_SubJob_SendEmail";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ADSLoad_SubJob_SendEmail.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ADSLoad_SubJob_SendEmail.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class mainStruct implements routines.system.IPersistableRow<mainStruct> {
    final static byte[] commonByteArrayLock_ADS_DATA_NO_GIT_ADSLoad_SubJob_SendEmail = new byte[0];
    static byte[] commonByteArray_ADS_DATA_NO_GIT_ADSLoad_SubJob_SendEmail = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADS_DATA_NO_GIT_ADSLoad_SubJob_SendEmail.length) {
				if(length < 1024 && commonByteArray_ADS_DATA_NO_GIT_ADSLoad_SubJob_SendEmail.length == 0) {
   					commonByteArray_ADS_DATA_NO_GIT_ADSLoad_SubJob_SendEmail = new byte[1024];
				} else {
   					commonByteArray_ADS_DATA_NO_GIT_ADSLoad_SubJob_SendEmail = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADS_DATA_NO_GIT_ADSLoad_SubJob_SendEmail, 0, length);
			strReturn = new String(commonByteArray_ADS_DATA_NO_GIT_ADSLoad_SubJob_SendEmail, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADS_DATA_NO_GIT_ADSLoad_SubJob_SendEmail) {
 ...
 */
    ...
    public static void main(String[] args){
        final ADSLoad_SubJob_SendEmail ADSLoad_SubJob_SendEmailClass = new ADSLoad_SubJob_SendEmail();

        int exitCode = ADSLoad_SubJob_SendEmailClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ADSLoad_SubJob_SendEmail.class.getClassLoader().getResourceAsStream("ads_data_no_git/adsload_subjob_sendemail_0_1/contexts/"+contextStr+".properties");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ADSLoad_SubJob_SendEmail");
        }
...
/************************************************************************************************
 *     96679 characters generated by Talend Open Studio for Data Integration 
