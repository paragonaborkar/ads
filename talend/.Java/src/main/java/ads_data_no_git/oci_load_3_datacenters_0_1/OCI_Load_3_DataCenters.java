...
package ads_data_no_git.oci_load_3_datacenters_0_1;
...
/**
 * Job: OCI_Load_3_DataCenters Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.0.20170510_1410
 * @status 
 */
public class OCI_Load_3_DataCenters implements TalendJob {
...
public String getDwh_inventory_AdditionalParams(){
	...
	private final String jobName = "OCI_Load_3_DataCenters";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				OCI_Load_3_DataCenters.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(OCI_Load_3_DataCenters.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_ADS_DATA_NO_GIT_OCI_Load_3_DataCenters = new byte[0];
    static byte[] commonByteArray_ADS_DATA_NO_GIT_OCI_Load_3_DataCenters = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADS_DATA_NO_GIT_OCI_Load_3_DataCenters.length) {
				if(length < 1024 && commonByteArray_ADS_DATA_NO_GIT_OCI_Load_3_DataCenters.length == 0) {
   					commonByteArray_ADS_DATA_NO_GIT_OCI_Load_3_DataCenters = new byte[1024];
				} else {
   					commonByteArray_ADS_DATA_NO_GIT_OCI_Load_3_DataCenters = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADS_DATA_NO_GIT_OCI_Load_3_DataCenters, 0, length);
			strReturn = new String(commonByteArray_ADS_DATA_NO_GIT_OCI_Load_3_DataCenters, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADS_DATA_NO_GIT_OCI_Load_3_DataCenters) {
...
public static class maiStruct implements routines.system.IPersistableRow<maiStruct> {
    final static byte[] commonByteArrayLock_ADS_DATA_NO_GIT_OCI_Load_3_DataCenters = new byte[0];
    static byte[] commonByteArray_ADS_DATA_NO_GIT_OCI_Load_3_DataCenters = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(maiStruct other) {
	...
	currentComponent="tWriteJSONField_1_Out";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("mai" + iterateId, 0, 0);
...
maiStruct  rowStructOutput_tWriteJSONField_1_Out = new maiStruct();
...
maiStruct mai_tmp = new maiStruct();
// ###############################
...
+context.TEST_ROW_COUNT_LIMIT+" ";
		...
		try{
        	...
        	row1.dataCenter = routines.system.JDBCUtil.getString(rs_tMysqlInput_1, 1, false);
		                    }
							if(colQtyInRs_tMysqlInput_1 < 2) {
								row1.Region = null;
							} else {
	                         		
        	row1.Region = routines.system.JDBCUtil.getString(rs_tMysqlInput_1, 2, false);
		                    }
...
Var.var1 = String.valueOf(Numeric.sequence("sourceRowId",1,1)) ;// ###############################
        // ###############################
        // # Output tables
...
WriteToFile_tmp.datacenter = row1.dataCenter ;
WriteToFile_tmp.region = row1.Region ;
WriteToFile = WriteToFile_tmp;

// # Output table : 'mai'
mai_tmp.dataCenter = row1.dataCenter ;
mai_tmp.Region = row1.Region ;
mai_tmp.RowId = Var.var1 ;
mai = mai_tmp;
// ###############################
			...
			//WriteToFile
				...
				if(execStat){
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                            if(WriteToFile.datacenter != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToFile.datacenter
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToFile.region != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToFile.region
                        );
                            }
...
if(mai != null) { 
	...
	currentComponent="tWriteJSONField_1_Out";
			...
			//mai
				...
				if(execStat){
					runStat.updateStatOnConnection("mai"+iterateId,1, 1);
				} 
	...
	(
            mai.dataCenter.toString()
		));
	valueMap_tWriteJSONField_1_Out.put("Region",
	(
		mai.Region != null?
            mai.Region.toString():null
		));
	valueMap_tWriteJSONField_1_Out.put("RowId",
	(
            mai.RowId.toString()
		));
	...
	if (needRoot_tWriteJSONField_1_Out) {
		...
		org.dom4j.Element root_0_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("region");
		if(
		valueMap_tWriteJSONField_1_Out.get("Region")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_0_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("Region"));
		}
	...
	// build loop xml tree
		org.dom4j.Element loop_tWriteJSONField_1_Out = org.dom4j.DocumentHelper.createElement("dataCenterName");
...
resourceMap.put("finish_tWriteJSONField_1_Out", true);
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("mai"+iterateId,2, 0); 
			 	}
			}
...
System.out.println(context.REST_URL_DATA_CENTERS);
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = ADSStringUtils.getEndPointURL(context.REST_URL_BASE,context.REST_URL_DATA_CENTERS);;
 ...
 */
    ...
    public static void main(String[] args){
        final OCI_Load_3_DataCenters OCI_Load_3_DataCentersClass = new OCI_Load_3_DataCenters();

        int exitCode = OCI_Load_3_DataCentersClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = OCI_Load_3_DataCenters.class.getClassLoader().getResourceAsStream("ads_data_no_git/oci_load_3_datacenters_0_1/contexts/"+contextStr+".properties");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : OCI_Load_3_DataCenters");
        }
...
/************************************************************************************************
 *     178306 characters generated by Talend Open Studio for Data Integration 
 *     on the March 23, 2018 12:49:52 PM EDT
 ************************************************************************************************/