...
package ads_data_no_git.oci_load_4_controllers_0_1;
...
/**
 * Job: OCI_Load_4_Controllers Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 6.4.0.20170510_1410
 * @status 
 */
public class OCI_Load_4_Controllers implements TalendJob {
...
public String getDwh_inventory_AdditionalParams(){
	...
	private final String jobName = "OCI_Load_4_Controllers";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				OCI_Load_4_Controllers.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(OCI_Load_4_Controllers.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
			...
			public void tAdvancedHash_dataCenter_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_ADS_DATA_NO_GIT_OCI_Load_4_Controllers = new byte[0];
    static byte[] commonByteArray_ADS_DATA_NO_GIT_OCI_Load_4_Controllers = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADS_DATA_NO_GIT_OCI_Load_4_Controllers.length) {
				if(length < 1024 && commonByteArray_ADS_DATA_NO_GIT_OCI_Load_4_Controllers.length == 0) {
   					commonByteArray_ADS_DATA_NO_GIT_OCI_Load_4_Controllers = new byte[1024];
				} else {
   					commonByteArray_ADS_DATA_NO_GIT_OCI_Load_4_Controllers = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADS_DATA_NO_GIT_OCI_Load_4_Controllers, 0, length);
			strReturn = new String(commonByteArray_ADS_DATA_NO_GIT_OCI_Load_4_Controllers, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADS_DATA_NO_GIT_OCI_Load_4_Controllers) {
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		obj_tRunJob_4 = ADSStringUtils.getJobInstanceName((String)jobName, context.JOB_RUN_NAME);
		...
		paraList_tRunJob_4.add("--context_param JOB_START_TIME=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_4));
		
		parentContextMap_tRunJob_4.put("JOB_START_TIME", obj_tRunJob_4);
	
		obj_tRunJob_4 = context.JOB_SUBMITTED_BY;
		paraList_tRunJob_4.add("--context_param JOB_SUBMITTED_BY=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_4));
		
		parentContextMap_tRunJob_4.put("JOB_SUBMITTED_BY", obj_tRunJob_4);
	
		obj_tRunJob_4 = ADSConstants.LOG_JOB_STATUS_INPROGRESS;
		...
		obj_tRunJob_4 = "/root/_links/jobData/href";
		paraList_tRunJob_4.add("--context_param RESPONSE_RESOURCE_XPATH=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_4));
		
		parentContextMap_tRunJob_4.put("RESPONSE_RESOURCE_XPATH", obj_tRunJob_4);
		...
		ads_data_no_git.logjobdetails_0_1.logJobDetails childJob_tRunJob_4 = new ads_data_no_git.logjobdetails_0_1.logJobDetails();
	    // pass DataSources
			...
			for (String[] item_tRunJob_4 : childReturn_tRunJob_4) { 
				if(childJob_tRunJob_4.hastBufferOutputComponent() || true){
						...
						if(0 < item_tRunJob_4.length){				
				           		...
				           		row5.resourceId = item_tRunJob_4[0];
...
globalMap.put("dataCenterLookupFile", context.ADS_LOG_DIRECTORY+jobName+"_dataCenterLookupFile.xlsx");
globalMap.put("storageLookupFile", context.ADS_LOG_DIRECTORY+jobName+"_storageLookupFile.xlsx");
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		obj_tRunJob_3 = "/root/_embedded/dataCenters";
		paraList_tRunJob_3.add("--context_param REST_RESPONSE_XPATH=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_3));
		
		parentContextMap_tRunJob_3.put("REST_RESPONSE_XPATH", obj_tRunJob_3);
	
		obj_tRunJob_3 = "./dataCenterName";
		paraList_tRunJob_3.add("--context_param REST_RESPONSE_XPATH_NAME=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_3));
		
		parentContextMap_tRunJob_3.put("REST_RESPONSE_XPATH_NAME", obj_tRunJob_3);
	
		obj_tRunJob_3 = context.REST_RESPONSE_SELF_HREF_VALUE;
		paraList_tRunJob_3.add("--context_param REST_RESPONSE_XPATH_VALUE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_3));
		
		parentContextMap_tRunJob_3.put("REST_RESPONSE_XPATH_VALUE", obj_tRunJob_3);
	
		obj_tRunJob_3 = ((String)globalMap.get("dataCenterLookupFile"));
		paraList_tRunJob_3.add("--context_param REST_RESPONSE_RESULT_FILE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_3));
		
		parentContextMap_tRunJob_3.put("REST_RESPONSE_RESULT_FILE", obj_tRunJob_3);
	
		obj_tRunJob_3 = ADSStringUtils.getEndPointURL(context.REST_URL_BASE,context.REST_URL_DATA_CENTERS);;
		paraList_tRunJob_3.add("--context_param REST_URL_NAME_VALUE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_3));
		
		parentContextMap_tRunJob_3.put("REST_URL_NAME_VALUE", obj_tRunJob_3);
	
		obj_tRunJob_3 = "./region";
		paraList_tRunJob_3.add("--context_param REST_RESPONSE_XPATH_REGION=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_3));
		
		parentContextMap_tRunJob_3.put("REST_RESPONSE_XPATH_REGION", obj_tRunJob_3);
		...
		ads_data_no_git.getdatacenterlookupdata_0_1.GetDataCenterLookupData childJob_tRunJob_3 = new ads_data_no_git.getdatacenterlookupdata_0_1.GetDataCenterLookupData();
	    // pass DataSources
...
public static class FormattedRowStruct implements routines.system.IPersistableRow<FormattedRowStruct> {
    ...
    static byte[] commonByteArray_ADS_DATA_NO_GIT_OCI_Load_4_Controllers = new byte[0];
			    ...
			    public long volumeTally;

				public long getVolumeTally () {
		...
		synchronized(commonByteArrayLock_ADS_DATA_NO_GIT_OCI_Load_4_Controllers) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.controllerName = readString(dis);
					
					this.serialNumber = readString(dis);
					
					this.storage = readString(dis);
					
					this.dateAvailable = readString(dis);
					
			        this.volumeTally = dis.readLong();
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.controllerName,dos);
					...
					// String
						...
						writeString(this.storage,dos);
					
					// String
				
						writeString(this.dateAvailable,dos);
					
					// long
				
		            	dos.writeLong(this.volumeTally);
    ...
    public String toString() {
		...
		sb.append(",dateAvailable="+dateAvailable);
		sb.append(",volumeTally="+String.valueOf(volumeTally));
...
public static class WriteToSrcFileStruct implements routines.system.IPersistableRow<WriteToSrcFileStruct> {
    ...
    static byte[] commonByteArray_ADS_DATA_NO_GIT_OCI_Load_4_Controllers = new byte[0];
			    ...
			    public Long volTally;

				public Long getVolTally () {
					return this.volTally;
				}
		...
		synchronized(commonByteArrayLock_ADS_DATA_NO_GIT_OCI_Load_4_Controllers) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.storageNodeName = readString(dis);
					
					this.serialNumber = readString(dis);
					
						this.storageId = readInteger(dis);
					
					this.storageName = readString(dis);
					...
					this.todaysDate = readString(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.volTally = null;
           				} else {
           			    	this.volTally = dis.readLong();
           				}
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.storageNodeName,dos);
					...
					// Integer
						...
						writeInteger(this.storageId,dos);
					
					// String
				
						writeString(this.storageName,dos);
					...
					// String
						...
						writeString(this.todaysDate,dos);
					
					// Long
				
						if(this.volTally == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.volTally);
		            	}
    ...
    public String toString() {
		...
		sb.append("[");
		sb.append("id="+String.valueOf(id));
		sb.append(",storageNodeName="+storageNodeName);
		sb.append(",serialNumber="+serialNumber);
		sb.append(",storageId="+String.valueOf(storageId));
		sb.append(",storageName="+storageName);
		sb.append(",model="+model);
		sb.append(",dataCenter="+dataCenter);
		sb.append(",region="+region);
		sb.append(",todaysDate="+todaysDate);
		sb.append(",volTally="+String.valueOf(volTally));
	    sb.append("]");
                    ...
                    if(directory_tFileOutputDelimited_1 != null && directory_tFileOutputDelimited_1.trim().length() != 0) {
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_1, true),"US-ASCII"));
                                    if(filetFileOutputDelimited_1.length()==0){
                                        ...
                                        outtFileOutputDelimited_1.write("storageNodeName");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("serialNumber");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("storageId");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("storageName");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("model");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("dataCenter");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("region");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("todaysDate");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("volTally");
...
// # Lookup's keys initialization
		...
		org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<dataCenterStruct> tHash_Lookup_dataCenter = (org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<dataCenterStruct>) 
				((org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<dataCenterStruct>) 
					globalMap.get( "tHash_Lookup_dataCenter" ))
					;					
					
	

dataCenterStruct dataCenterHashKey = new dataCenterStruct();
dataCenterStruct dataCenterDefault = new dataCenterStruct();
// ###############################        
...
+context.TEST_ROW_COUNT_LIMIT+" ";
		...
		try{
                ...
                row1.id = rs_tMysqlInput_1.getInt(1);
                    ...
                    throw new RuntimeException("Null value in non-Nullable column");
							...
							if(colQtyInRs_tMysqlInput_1 < 2) {
								row1.storageNodeName = null;
							} else {
	                         		
        	row1.storageNodeName = routines.system.JDBCUtil.getString(rs_tMysqlInput_1, 2, false);
		                    }
							if(colQtyInRs_tMysqlInput_1 < 3) {
								row1.serialNumber = null;
							} else {
	                         		
        	row1.serialNumber = routines.system.JDBCUtil.getString(rs_tMysqlInput_1, 3, false);
		                    }
            ...
            if(rs_tMysqlInput_1.getObject(4) != null) {
                row1.storageId = rs_tMysqlInput_1.getInt(4);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tMysqlInput_1 < 5) {
								row1.storageName = null;
							} else {
	                         		
        	row1.storageName = routines.system.JDBCUtil.getString(rs_tMysqlInput_1, 5, false);
		                    }
							if(colQtyInRs_tMysqlInput_1 < 6) {
								row1.model = null;
							} else {
	                         		
        	row1.model = routines.system.JDBCUtil.getString(rs_tMysqlInput_1, 6, false);
		                    }
							if(colQtyInRs_tMysqlInput_1 < 7) {
								row1.dataCenter = null;
							} else {
	                         		
        	row1.dataCenter = routines.system.JDBCUtil.getString(rs_tMysqlInput_1, 7, false);
		                    }
							if(colQtyInRs_tMysqlInput_1 < 8) {
								row1.Region = null;
							} else {
	                         		
        	row1.Region = routines.system.JDBCUtil.getString(rs_tMysqlInput_1, 8, false);
		                    }
							if(colQtyInRs_tMysqlInput_1 < 9) {
								row1.todaysDate = null;
							} else {
	                         		
        	row1.todaysDate = routines.system.JDBCUtil.getString(rs_tMysqlInput_1, 9, false);
		                    }
            ...
            if(rs_tMysqlInput_1.getObject(10) != null) {
                row1.volTally = rs_tMysqlInput_1.getLong(10);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
	...
	currentComponent="tMap_1";
        ...
        // # Input tables (lookups)
		  ...
		  boolean mainRowRejected_tMap_1 = false;
				...
				///////////////////////////////////////////////
				// Starting Lookup Table "dataCenter" 
				///////////////////////////////////////////////
 					    ...
 					    boolean forceLoopdataCenter = false;
       		  	    	
       		  	    	
 							dataCenterStruct dataCenterObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		...
                        		    		dataCenterHashKey.name = row1.dataCenter ;
                        		    		
                        		    		dataCenterHashKey.region = row1.Region ;
                        		    		

								
		                        	dataCenterHashKey.hashCodeDirty = true;
		  							...
		  							tHash_Lookup_dataCenter.lookup( dataCenterHashKey );
				           		...
				           		if(tHash_Lookup_dataCenter != null && tHash_Lookup_dataCenter.getCount(dataCenterHashKey) > 1) { // G 071
			  							
			  						
									 		
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'dataCenter' and it contains more one result from keys :  dataCenter.name = '" + dataCenterHashKey.name + "', dataCenter.region = '" + dataCenterHashKey.region + "'");
								} // G 071
							

							dataCenterStruct dataCenter = null;
                    		  	 
							   
                    		  	 
	       		  	    	dataCenterStruct fromLookup_dataCenter = null;
							dataCenter = dataCenterDefault;
								...
								if (tHash_Lookup_dataCenter !=null && tHash_Lookup_dataCenter.hasNext()) { // G 099
								
							
								
								fromLookup_dataCenter = tHash_Lookup_dataCenter.next();
							...
							if(fromLookup_dataCenter != null) {
								dataCenter = fromLookup_dataCenter;
							}
...
Var.var1 = ADSStringUtils.getRestURLForId(context.REST_URL_BASE, ADSConstants.NODE_DATA_CENTERS,String.valueOf(dataCenter.value)) ;
Var.var2 = ADSStringUtils.getRestURLForId(context.REST_URL_BASE, ADSConstants.NODE_STORAGES,String.valueOf(row1.storageId)) ;// ###############################
        // ###############################
        // # Output tables
...
FormattedRow_tmp.id = row1.id ;
FormattedRow_tmp.controllerName = row1.storageNodeName ;
FormattedRow_tmp.serialNumber = row1.serialNumber ;
FormattedRow_tmp.storage = Var.var2 ;
FormattedRow_tmp.dateAvailable = row1.todaysDate ;
FormattedRow_tmp.volumeTally = row1.volTally ;
FormattedRow_tmp.dataCenter = Var.var1 ;
FormattedRow = FormattedRow_tmp;

// # Output table : 'WriteToSrcFile'
WriteToSrcFile_tmp.id = null;
WriteToSrcFile_tmp.storageNodeName = null;
WriteToSrcFile_tmp.serialNumber = null;
WriteToSrcFile_tmp.storageId = null;
WriteToSrcFile_tmp.storageName = null;
WriteToSrcFile_tmp.model = null;
WriteToSrcFile_tmp.dataCenter = null;
WriteToSrcFile_tmp.region = null;
WriteToSrcFile_tmp.todaysDate = null;
WriteToSrcFile_tmp.volTally = null;
...
if(FormattedRow != null) { 
	...
	valueMap_tWriteJSONField_1_Out.put("controllerName",
	(
            FormattedRow.controllerName.toString()
		));
	valueMap_tWriteJSONField_1_Out.put("serialNumber",
	(
		FormattedRow.serialNumber != null?
            FormattedRow.serialNumber.toString():null
		));
	valueMap_tWriteJSONField_1_Out.put("storage",
	(
            FormattedRow.storage.toString()
		));
	valueMap_tWriteJSONField_1_Out.put("dateAvailable",
	(
		FormattedRow.dateAvailable != null?
            FormattedRow.dateAvailable.toString():null
		));
	valueMap_tWriteJSONField_1_Out.put("volumeTally",
	(
            String.valueOf(FormattedRow.volumeTally)
		));
	valueMap_tWriteJSONField_1_Out.put("dataCenter",
	(
            FormattedRow.dataCenter.toString()
		));
	...
	if (needRoot_tWriteJSONField_1_Out) {
		...
		org.dom4j.Element root_0_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("controllerName");
		if(
		valueMap_tWriteJSONField_1_Out.get("controllerName")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_0_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("controllerName"));
		}
		org.dom4j.Element root_1_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("serialNumber");
		if(
		valueMap_tWriteJSONField_1_Out.get("serialNumber")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_1_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("serialNumber"));
		}
		org.dom4j.Element root_2_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("storage");
		if(
		valueMap_tWriteJSONField_1_Out.get("storage")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_2_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("storage"));
		}
		org.dom4j.Element root_3_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("dateAvailable");
		if(
		valueMap_tWriteJSONField_1_Out.get("dateAvailable")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_3_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("dateAvailable"));
		}
		org.dom4j.Element root_4_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("volumeTally");
		if(
		valueMap_tWriteJSONField_1_Out.get("volumeTally")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_4_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("volumeTally"));
		}
		org.dom4j.Element root_5_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("dataCenter");
		if(
		valueMap_tWriteJSONField_1_Out.get("dataCenter")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_5_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("dataCenter"));
		}
			...
			//WriteToSrcFile
				...
				if(execStat){
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                            if(WriteToSrcFile.id != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcFile.id
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcFile.storageNodeName != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcFile.storageNodeName
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcFile.serialNumber != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcFile.serialNumber
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcFile.storageId != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcFile.storageId
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcFile.storageName != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcFile.storageName
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcFile.model != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcFile.model
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcFile.dataCenter != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcFile.dataCenter
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcFile.region != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcFile.region
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcFile.todaysDate != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcFile.todaysDate
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcFile.volTally != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcFile.volTally
                        );
                            }
...
// # Lookup hashes releasing
					if(tHash_Lookup_dataCenter != null) {
						tHash_Lookup_dataCenter.endGet();
					}
					globalMap.remove( "tHash_Lookup_dataCenter" );
...
public static class dataCenterStruct implements routines.system.IPersistableComparableLookupRow<dataCenterStruct> {
    final static byte[] commonByteArrayLock_ADS_DATA_NO_GIT_OCI_Load_4_Controllers = new byte[0];
    static byte[] commonByteArray_ADS_DATA_NO_GIT_OCI_Load_4_Controllers = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final dataCenterStruct other = (dataCenterStruct) obj;
	...
	public void copyDataTo(dataCenterStruct other) {
	...
	public void copyKeysDataTo(dataCenterStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(dataCenterStruct other) {
...
public void tFileInputExcel_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try {
		...
		dataCenterStruct dataCenter = new dataCenterStruct();
	...
	/**
	 * [tAdvancedHash_dataCenter begin ] start
	 */
		...
		ok_Hash.put("tAdvancedHash_dataCenter", false);
		start_Hash.put("tAdvancedHash_dataCenter", System.currentTimeMillis());
		
	
	currentComponent="tAdvancedHash_dataCenter";

	
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
					
						runStat.updateStatOnConnection("dataCenter" + iterateId, 0, 0);
					
				}
			} 

		
		int tos_count_tAdvancedHash_dataCenter = 0;
		
    	class BytesLimit65535_tAdvancedHash_dataCenter{
    		public void limitLog4jByte() throws Exception{
    			
    		}
    	}
    	
        new BytesLimit65535_tAdvancedHash_dataCenter().limitLog4jByte();

			   		// connection name:dataCenter
			   		// source node:tFileInputExcel_1 - inputs:(after_tMysqlInput_1) outputs:(dataCenter,dataCenter) | target node:tAdvancedHash_dataCenter - inputs:(dataCenter) outputs:()
			   		// linked node: tMap_1 - inputs:(row1,dataCenter) outputs:(FormattedRow,WriteToSrcFile)
			   
			   		org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE matchingModeEnum_dataCenter = 
			   			org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE.UNIQUE_MATCH;
			   			
			   
	   			org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<dataCenterStruct> tHash_Lookup_dataCenter =org.talend.designer.components.lookup.memory.AdvancedMemoryLookup.
	   						<dataCenterStruct>getLookup(matchingModeEnum_dataCenter);
	   						   
		   	   	   globalMap.put("tHash_Lookup_dataCenter", tHash_Lookup_dataCenter);
...
/**
 * [tAdvancedHash_dataCenter begin ] stop
 */
	...
	currentComponent="tFileInputExcel_1";
		...
		Object source_tFileInputExcel_1 = ((String)globalMap.get("dataCenterLookupFile"));
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			dataCenter = new dataCenterStruct();
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				dataCenter.name = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				dataCenter.region = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				dataCenter.value = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				dataCenter.value = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
...
if(dataCenter != null) { 
	...
	/**
	 * [tAdvancedHash_dataCenter main ] start
	 */
	...
	currentComponent="tAdvancedHash_dataCenter";
			...
			//dataCenter
				...
				if(execStat){
					runStat.updateStatOnConnection("dataCenter"+iterateId,1, 1);
				} 
					...
					dataCenterStruct dataCenter_HashRow = new dataCenterStruct();
		   	   	   
				
				dataCenter_HashRow.name = dataCenter.name;
				
				dataCenter_HashRow.region = dataCenter.region;
				
				dataCenter_HashRow.value = dataCenter.value;
				
			tHash_Lookup_dataCenter.put(dataCenter_HashRow);
	...
	tos_count_tAdvancedHash_dataCenter++;

/**
 * [tAdvancedHash_dataCenter main ] stop
 */

} // End of branch "dataCenter"
 ...
 */
	...
	/**
	 * [tAdvancedHash_dataCenter end ] start
	 */
...
tHash_Lookup_dataCenter.endPut();

			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("dataCenter"+iterateId,2, 0); 
			 	}
			}
		
 

ok_Hash.put("tAdvancedHash_dataCenter", true);
end_Hash.put("tAdvancedHash_dataCenter", System.currentTimeMillis());




/**
 * [tAdvancedHash_dataCenter end ] stop
 */
 ...
 */
	...
	/**
	 * [tAdvancedHash_dataCenter finally ] start
	 */
...
/**
 * [tAdvancedHash_dataCenter finally ] stop
 */
...
context.REST_REQ_JSON=row2.root;
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = ADSStringUtils.getEndPointURL(context.REST_URL_BASE,context.REST_URL_CONTROLLERS);;
 ...
 */
    ...
    public static void main(String[] args){
        final OCI_Load_4_Controllers OCI_Load_4_ControllersClass = new OCI_Load_4_Controllers();

        int exitCode = OCI_Load_4_ControllersClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = OCI_Load_4_Controllers.class.getClassLoader().getResourceAsStream("ads_data_no_git/oci_load_4_controllers_0_1/contexts/"+contextStr+".properties");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : OCI_Load_4_Controllers");
        }
...
/************************************************************************************************
 *     239709 characters generated by Talend Open Studio for Data Integration 
 *     on the March 23, 2018 12:49:53 PM EDT
 ************************************************************************************************/