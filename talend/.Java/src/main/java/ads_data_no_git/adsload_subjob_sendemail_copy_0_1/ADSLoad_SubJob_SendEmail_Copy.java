...
package ads_data_no_git.adsload_subjob_sendemail_copy_0_1;
...
public static class mainStruct implements routines.system.IPersistableRow<mainStruct> {
    final static byte[] commonByteArrayLock_ADS_DATA_NO_GIT_ADSLoad_SubJob_SendEmail_Copy = new byte[0];
    static byte[] commonByteArray_ADS_DATA_NO_GIT_ADSLoad_SubJob_SendEmail_Copy = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADS_DATA_NO_GIT_ADSLoad_SubJob_SendEmail_Copy.length) {
				if(length < 1024 && commonByteArray_ADS_DATA_NO_GIT_ADSLoad_SubJob_SendEmail_Copy.length == 0) {
   					commonByteArray_ADS_DATA_NO_GIT_ADSLoad_SubJob_SendEmail_Copy = new byte[1024];
				} else {
   					commonByteArray_ADS_DATA_NO_GIT_ADSLoad_SubJob_SendEmail_Copy = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADS_DATA_NO_GIT_ADSLoad_SubJob_SendEmail_Copy, 0, length);
			strReturn = new String(commonByteArray_ADS_DATA_NO_GIT_ADSLoad_SubJob_SendEmail_Copy, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADS_DATA_NO_GIT_ADSLoad_SubJob_SendEmail_Copy) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ADSLoad_SubJob_SendEmail_Copy.class.getClassLoader().getResourceAsStream("ads_data_no_git/adsload_subjob_sendemail_copy_0_1/contexts/"+contextStr+".properties");
...
/************************************************************************************************
 *     153401 characters generated by Talend Open Studio for Data Integration 
 *     on the March 23, 2018 12:43:40 PM EDT
 ************************************************************************************************/