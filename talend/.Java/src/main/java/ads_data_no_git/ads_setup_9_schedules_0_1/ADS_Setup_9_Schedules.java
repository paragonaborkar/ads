...
package ads_data_no_git.ads_setup_9_schedules_0_1;
...
/**
 * Job: ADS_Setup_9_Schedules Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.0.20170510_1410
 * @status 
 */
public class ADS_Setup_9_Schedules implements TalendJob {
...
public String getDwh_inventory_AdditionalParams(){
	...
	private final String jobName = "ADS_Setup_9_Schedules";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ADS_Setup_9_Schedules.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ADS_Setup_9_Schedules.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_ADS_DATA_NO_GIT_ADS_Setup_9_Schedules = new byte[0];
    static byte[] commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_9_Schedules = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_9_Schedules.length) {
				if(length < 1024 && commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_9_Schedules.length == 0) {
   					commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_9_Schedules = new byte[1024];
				} else {
   					commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_9_Schedules = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_9_Schedules, 0, length);
			strReturn = new String(commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_9_Schedules, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADS_DATA_NO_GIT_ADS_Setup_9_Schedules) {
...
public static class FormattedRowStruct implements routines.system.IPersistableRow<FormattedRowStruct> {
    ...
    static byte[] commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_9_Schedules = new byte[0];
			    ...
			    public java.util.Date weekDate;
		...
		synchronized(commonByteArrayLock_ADS_DATA_NO_GIT_ADS_Setup_9_Schedules) {
        	...
        	try {
        		...
        		int length = 0;
						...
						this.hostConnectionBooked = readInteger(dis);
					
						this.hostConnectionLimit = readInteger(dis);
					
						this.hostConnectionPending = readInteger(dis);
					
						this.migrationBooked = readInteger(dis);
					
						this.migrationLimit = readInteger(dis);
					
						this.migrationPending = readInteger(dis);
					
					this.scheduleStatus = readString(dis);
					
					this.weekDate = readDate(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.hostConnectionBooked,dos);
					
					// Integer
				
						writeInteger(this.hostConnectionLimit,dos);
					
					// Integer
				
						writeInteger(this.hostConnectionPending,dos);
					
					// Integer
				
						writeInteger(this.migrationBooked,dos);
					
					// Integer
				
						writeInteger(this.migrationLimit,dos);
					
					// Integer
				
						writeInteger(this.migrationPending,dos);
					
					// String
				
						writeString(this.scheduleStatus,dos);
					
					// java.util.Date
				
						writeDate(this.weekDate,dos);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("hostConnectionBooked="+String.valueOf(hostConnectionBooked));
		sb.append(",hostConnectionLimit="+String.valueOf(hostConnectionLimit));
		sb.append(",hostConnectionPending="+String.valueOf(hostConnectionPending));
		sb.append(",migrationBooked="+String.valueOf(migrationBooked));
		sb.append(",migrationLimit="+String.valueOf(migrationLimit));
		sb.append(",migrationPending="+String.valueOf(migrationPending));
		sb.append(",scheduleStatus="+scheduleStatus);
		sb.append(",weekDate="+String.valueOf(weekDate));
	    sb.append("]");
...
public static class DataRowStruct implements routines.system.IPersistableRow<DataRowStruct> {
    ...
    static byte[] commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_9_Schedules = new byte[0];
			    ...
			    public java.util.Date weekDate_mm_dd_yyyy_;

				public java.util.Date getWeekDate_mm_dd_yyyy_ () {
					return this.weekDate_mm_dd_yyyy_;
				}
		...
		synchronized(commonByteArrayLock_ADS_DATA_NO_GIT_ADS_Setup_9_Schedules) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.weekDate_mm_dd_yyyy_ = readDate(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// java.util.Date
						...
						writeDate(this.weekDate_mm_dd_yyyy_,dos);
    ...
    public String toString() {
		...
		sb.append(",migrationPending="+String.valueOf(migrationPending));
		sb.append(",scheduleStatus="+scheduleStatus);
		sb.append(",weekDate_mm_dd_yyyy_="+String.valueOf(weekDate_mm_dd_yyyy_));
	    sb.append("]");
                    ...
                    if(directory_tFileOutputDelimited_1 != null && directory_tFileOutputDelimited_1.trim().length() != 0) {
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_1, true),"ISO-8859-15"));
                                    if(filetFileOutputDelimited_1.length()==0){
                                        outtFileOutputDelimited_1.write("hostConnectionBooked");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("hostConnectionLimit");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("hostConnectionPending");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("migrationBooked");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("migrationLimit");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("migrationPending");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("scheduleStatus");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("weekDate");
 ...
 */
	...
	currentComponent="tFileInputExcel_1";
		...
		Object source_tFileInputExcel_1 = context.LOAD_FILES_LOC+"/"+context.ADS_SETUP_LOADSHEET_SCHEDULE_XLSX;
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				curColName_tFileInputExcel_1 = "hostConnectionBooked";

				DataRow.hostConnectionBooked = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				DataRow.hostConnectionBooked = null;
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "hostConnectionLimit";

				DataRow.hostConnectionLimit = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				DataRow.hostConnectionLimit = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "hostConnectionPending";

				DataRow.hostConnectionPending = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				DataRow.hostConnectionPending = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "migrationBooked";

				DataRow.migrationBooked = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				DataRow.migrationBooked = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "migrationLimit";

				DataRow.migrationLimit = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				DataRow.migrationLimit = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "migrationPending";

				DataRow.migrationPending = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				DataRow.migrationPending = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "scheduleStatus";

				DataRow.scheduleStatus = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				DataRow.scheduleStatus = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "weekDate_mm_dd_yyyy_";
				...
				if(7<actual_end_column_tFileInputExcel_1){
					try{
						if(row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1).getCellType() == org.apache.poi.ss.usermodel.Cell.CELL_TYPE_NUMERIC && org.apache.poi.ss.usermodel.DateUtil.isCellDateFormatted(row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1))){
							DataRow.weekDate_mm_dd_yyyy_ = row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1).getDateCellValue();
						}
						else{
                            ...
                            if(tempDate_tFileInputExcel_1.after((new SimpleDateFormat("yyyy/MM/dd hh:mm:ss.SSS")).parse("9999/12/31 23:59:59.999"))||tempDate_tFileInputExcel_1.before((new SimpleDateFormat("yyyy/MM/dd")).parse("1900/01/01"))){
                                ...
                                DataRow.weekDate_mm_dd_yyyy_ = tempDate_tFileInputExcel_1;
                            }
						}
					}catch(java.lang.Exception e){
				...
				DataRow.weekDate_mm_dd_yyyy_ = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
...
FormattedRow_tmp.hostConnectionBooked = DataRow.hostConnectionBooked ;
FormattedRow_tmp.hostConnectionLimit = DataRow.hostConnectionLimit ;
FormattedRow_tmp.hostConnectionPending = DataRow.hostConnectionPending ;
FormattedRow_tmp.migrationBooked = DataRow.migrationBooked ;
FormattedRow_tmp.migrationLimit = DataRow.migrationLimit ;
FormattedRow_tmp.migrationPending = DataRow.migrationPending ;
FormattedRow_tmp.scheduleStatus = DataRow.scheduleStatus ;
FormattedRow_tmp.weekDate = DataRow.weekDate_mm_dd_yyyy_ ;
FormattedRow = FormattedRow_tmp;

// # Output table : 'WriteToSrcFile'
WriteToSrcFile_tmp.hostConnectionBooked = DataRow.hostConnectionBooked  ;
WriteToSrcFile_tmp.hostConnectionLimit = DataRow.hostConnectionLimit  ;
WriteToSrcFile_tmp.hostConnectionPending = DataRow.hostConnectionPending  ;
WriteToSrcFile_tmp.migrationBooked = DataRow.migrationBooked  ;
WriteToSrcFile_tmp.migrationLimit = DataRow.migrationLimit  ;
WriteToSrcFile_tmp.migrationPending = DataRow.migrationPending  ;
WriteToSrcFile_tmp.scheduleStatus = DataRow.scheduleStatus  ;
WriteToSrcFile_tmp.weekDate = DataRow.weekDate_mm_dd_yyyy_  ;
...
if(FormattedRow != null) { 
	...
	valueMap_tWriteJSONField_2_Out.put("hostConnectionBooked",
	(
		FormattedRow.hostConnectionBooked != null?
            FormattedRow.hostConnectionBooked.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("hostConnectionLimit",
	(
		FormattedRow.hostConnectionLimit != null?
            FormattedRow.hostConnectionLimit.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("hostConnectionPending",
	(
		FormattedRow.hostConnectionPending != null?
            FormattedRow.hostConnectionPending.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("migrationBooked",
	(
		FormattedRow.migrationBooked != null?
            FormattedRow.migrationBooked.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("migrationLimit",
	(
		FormattedRow.migrationLimit != null?
            FormattedRow.migrationLimit.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("migrationPending",
	(
		FormattedRow.migrationPending != null?
            FormattedRow.migrationPending.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("scheduleStatus",
	(
		FormattedRow.scheduleStatus != null?
            FormattedRow.scheduleStatus.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("weekDate",
	(
		FormattedRow.weekDate != null?
            FormatterUtils.format_Date(FormattedRow.weekDate,"yyyy-MM-dd"):null
		));
	...
	if (needRoot_tWriteJSONField_2_Out) {
		...
		org.dom4j.Element root_0_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("hostConnectionLimit");
		if(
		valueMap_tWriteJSONField_2_Out.get("hostConnectionLimit")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_0_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("hostConnectionLimit"));
		}
		org.dom4j.Element root_1_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("hostConnectionPending");
		if(
		valueMap_tWriteJSONField_2_Out.get("hostConnectionPending")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_1_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("hostConnectionPending"));
		}
		org.dom4j.Element root_2_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("migrationBooked");
		if(
		valueMap_tWriteJSONField_2_Out.get("migrationBooked")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_2_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("migrationBooked"));
		}
		org.dom4j.Element root_3_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("migrationLimit");
		if(
		valueMap_tWriteJSONField_2_Out.get("migrationLimit")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_3_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("migrationLimit"));
		}
		org.dom4j.Element root_4_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("migrationPending");
		if(
		valueMap_tWriteJSONField_2_Out.get("migrationPending")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_4_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("migrationPending"));
		}
		org.dom4j.Element root_5_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("scheduleStatus");
		if(
		valueMap_tWriteJSONField_2_Out.get("scheduleStatus")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_5_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("scheduleStatus"));
		}
		org.dom4j.Element root_6_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("weekDate");
		if(
		valueMap_tWriteJSONField_2_Out.get("weekDate")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_6_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("weekDate"));
		}
	...
	// build loop xml tree
		org.dom4j.Element loop_tWriteJSONField_2_Out = org.dom4j.DocumentHelper.createElement("hostConnectionBooked");
		...
		if(
		valueMap_tWriteJSONField_2_Out.get("hostConnectionBooked")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(loop_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("hostConnectionBooked"));
		}
			...
			//WriteToSrcFile
				...
				if(execStat){
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                            if(WriteToSrcFile.hostConnectionBooked != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcFile.hostConnectionBooked
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcFile.hostConnectionLimit != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcFile.hostConnectionLimit
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcFile.hostConnectionPending != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcFile.hostConnectionPending
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcFile.migrationBooked != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcFile.migrationBooked
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcFile.migrationLimit != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcFile.migrationLimit
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcFile.migrationPending != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcFile.migrationPending
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcFile.scheduleStatus != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcFile.scheduleStatus
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcFile.weekDate != null) {
                        sb_tFileOutputDelimited_1.append(
                            FormatterUtils.format_Date(WriteToSrcFile.weekDate, "yyyy-MM-dd")
                        );
                            }
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		obj_tRunJob_2 = ADSStringUtils.getEndPointURL(context.REST_URL_BASE,context.REST_URL_SCHEDULES);;
 ...
 */
    ...
    public static void main(String[] args){
        final ADS_Setup_9_Schedules ADS_Setup_9_SchedulesClass = new ADS_Setup_9_Schedules();

        int exitCode = ADS_Setup_9_SchedulesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ADS_Setup_9_Schedules.class.getClassLoader().getResourceAsStream("ads_data_no_git/ads_setup_9_schedules_0_1/contexts/"+contextStr+".properties");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ADS_Setup_9_Schedules");
        }
...
/************************************************************************************************
 *     209384 characters generated by Talend Open Studio for Data Integration 
