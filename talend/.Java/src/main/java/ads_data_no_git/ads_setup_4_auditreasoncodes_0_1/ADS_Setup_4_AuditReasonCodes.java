...
package ads_data_no_git.ads_setup_4_auditreasoncodes_0_1;
...
/**
 * Job: ADS_Setup_4_AuditReasonCodes Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.0.20170510_1410
 * @status 
 */
public class ADS_Setup_4_AuditReasonCodes implements TalendJob {
...
public String getDwh_inventory_AdditionalParams(){
	...
	private final String jobName = "ADS_Setup_4_AuditReasonCodes";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ADS_Setup_4_AuditReasonCodes.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ADS_Setup_4_AuditReasonCodes.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_ADS_DATA_NO_GIT_ADS_Setup_4_AuditReasonCodes = new byte[0];
    static byte[] commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_4_AuditReasonCodes = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_4_AuditReasonCodes.length) {
				if(length < 1024 && commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_4_AuditReasonCodes.length == 0) {
   					commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_4_AuditReasonCodes = new byte[1024];
				} else {
   					commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_4_AuditReasonCodes = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_4_AuditReasonCodes, 0, length);
			strReturn = new String(commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_4_AuditReasonCodes, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADS_DATA_NO_GIT_ADS_Setup_4_AuditReasonCodes) {
...
public static class FormattedRowStruct implements routines.system.IPersistableRow<FormattedRowStruct> {
		...
		synchronized(commonByteArrayLock_ADS_DATA_NO_GIT_ADS_Setup_4_AuditReasonCodes) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.auditEvent = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.auditEvent,dos);
    ...
    public String toString() {
		...
		sb.append(",auditEvent="+auditEvent);
	    sb.append("]");
                    ...
                    if(directory_tFileOutputDelimited_1 != null && directory_tFileOutputDelimited_1.trim().length() != 0) {
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_1, true),"ISO-8859-15"));
                                    if(filetFileOutputDelimited_1.length()==0){
                                        ...
                                        outtFileOutputDelimited_1.write("auditEvent");
 ...
 */
	...
	currentComponent="tFileInputExcel_1";
		...
		Object source_tFileInputExcel_1 = context.LOAD_FILES_LOC+"/"+context.ADS_SETUP_LOADSHEET_AUDIT_REASON_CODE_XLSX;
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				curColName_tFileInputExcel_1 = "reason";

				DataRow.reason = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				DataRow.reason = null;
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "auditEvent";

				DataRow.auditEvent = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				DataRow.auditEvent = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
...
FormattedRow_tmp.reason = DataRow.reason ;
FormattedRow_tmp.auditEvent = DataRow.auditEvent ;
FormattedRow = FormattedRow_tmp;

// # Output table : 'WriteToSrcFile'
WriteToSrcFile_tmp.reason = DataRow.reason  ;
WriteToSrcFile_tmp.auditEvent = DataRow.auditEvent  ;
...
if(FormattedRow != null) { 
	...
	valueMap_tWriteJSONField_2_Out.put("reason",
	(
		FormattedRow.reason != null?
            FormattedRow.reason.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("auditEvent",
	(
		FormattedRow.auditEvent != null?
            FormattedRow.auditEvent.toString():null
		));
	...
	if (needRoot_tWriteJSONField_2_Out) {
		...
		org.dom4j.Element root_0_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("auditEvent");
		if(
		valueMap_tWriteJSONField_2_Out.get("auditEvent")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_0_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("auditEvent"));
		}
	...
	// build loop xml tree
		org.dom4j.Element loop_tWriteJSONField_2_Out = org.dom4j.DocumentHelper.createElement("reason");
		...
		if(
		valueMap_tWriteJSONField_2_Out.get("reason")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(loop_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("reason"));
		}
			...
			//WriteToSrcFile
				...
				if(execStat){
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                            if(WriteToSrcFile.reason != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcFile.reason
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcFile.auditEvent != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcFile.auditEvent
                        );
                            }
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		obj_tRunJob_2 = ADSStringUtils.getEndPointURL(context.REST_URL_BASE,context.REST_URL_AUDIT_REASON_CODES);;
 ...
 */
    ...
    public static void main(String[] args){
        final ADS_Setup_4_AuditReasonCodes ADS_Setup_4_AuditReasonCodesClass = new ADS_Setup_4_AuditReasonCodes();

        int exitCode = ADS_Setup_4_AuditReasonCodesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ADS_Setup_4_AuditReasonCodes.class.getClassLoader().getResourceAsStream("ads_data_no_git/ads_setup_4_auditreasoncodes_0_1/contexts/"+contextStr+".properties");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ADS_Setup_4_AuditReasonCodes");
        }
...
/************************************************************************************************
 *     187535 characters generated by Talend Open Studio for Data Integration 
