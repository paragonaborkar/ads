...
package ads_data_no_git.logjobdetails_0_1;
...
public static class mainStruct implements routines.system.IPersistableRow<mainStruct> {
    final static byte[] commonByteArrayLock_ADS_DATA_NO_GIT_logJobDetails = new byte[0];
    static byte[] commonByteArray_ADS_DATA_NO_GIT_logJobDetails = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADS_DATA_NO_GIT_logJobDetails.length) {
				if(length < 1024 && commonByteArray_ADS_DATA_NO_GIT_logJobDetails.length == 0) {
   					commonByteArray_ADS_DATA_NO_GIT_logJobDetails = new byte[1024];
				} else {
   					commonByteArray_ADS_DATA_NO_GIT_logJobDetails = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADS_DATA_NO_GIT_logJobDetails, 0, length);
			strReturn = new String(commonByteArray_ADS_DATA_NO_GIT_logJobDetails, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADS_DATA_NO_GIT_logJobDetails) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = logJobDetails.class.getClassLoader().getResourceAsStream("ads_data_no_git/logjobdetails_0_1/contexts/"+contextStr+".properties");
...
/************************************************************************************************
 *     137237 characters generated by Talend Open Studio for Data Integration 
