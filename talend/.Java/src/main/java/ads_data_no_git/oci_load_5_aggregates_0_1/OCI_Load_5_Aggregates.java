...
package ads_data_no_git.oci_load_5_aggregates_0_1;
...
/**
 * Job: OCI_Load_5_Aggregates Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.0.20170510_1410
 * @status 
 */
public class OCI_Load_5_Aggregates implements TalendJob {
...
public String getDwh_inventory_AdditionalParams(){
	...
	private final String jobName = "OCI_Load_5_Aggregates";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				OCI_Load_5_Aggregates.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(OCI_Load_5_Aggregates.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_ADS_DATA_NO_GIT_OCI_Load_5_Aggregates = new byte[0];
    static byte[] commonByteArray_ADS_DATA_NO_GIT_OCI_Load_5_Aggregates = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADS_DATA_NO_GIT_OCI_Load_5_Aggregates.length) {
				if(length < 1024 && commonByteArray_ADS_DATA_NO_GIT_OCI_Load_5_Aggregates.length == 0) {
   					commonByteArray_ADS_DATA_NO_GIT_OCI_Load_5_Aggregates = new byte[1024];
				} else {
   					commonByteArray_ADS_DATA_NO_GIT_OCI_Load_5_Aggregates = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADS_DATA_NO_GIT_OCI_Load_5_Aggregates, 0, length);
			strReturn = new String(commonByteArray_ADS_DATA_NO_GIT_OCI_Load_5_Aggregates, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADS_DATA_NO_GIT_OCI_Load_5_Aggregates) {
...
globalMap.put("controllerLookupFile", context.ADS_LOG_DIRECTORY+"controllerLookup.xlsx");
...
public static class DataStruct implements routines.system.IPersistableRow<DataStruct> {
		...
		synchronized(commonByteArrayLock_ADS_DATA_NO_GIT_OCI_Load_5_Aggregates) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.aggregateName = readString(dis);
					
			        this.aggregateSizeGb = dis.readFloat();
					
			        this.isHybrid = dis.readBoolean();
					
					this.aggregateType = readString(dis);
					
					this.controller = readString(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.poolAllocatedCapacityGb = null;
           				} else {
           			    	this.poolAllocatedCapacityGb = dis.readFloat();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.poolUsedCapacityGb = null;
           				} else {
           			    	this.poolUsedCapacityGb = dis.readFloat();
           				}
					
						this.poolIopsCapability = readInteger(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.aggregateName,dos);
					
					// float
				
		            	dos.writeFloat(this.aggregateSizeGb);
					
					// boolean
				
		            	dos.writeBoolean(this.isHybrid);
					
					// String
				
						writeString(this.aggregateType,dos);
					...
					// Float
						...
						if(this.poolAllocatedCapacityGb == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeFloat(this.poolAllocatedCapacityGb);
		            	}
					
					// Float
				
						if(this.poolUsedCapacityGb == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeFloat(this.poolUsedCapacityGb);
		            	}
					
					// Integer
				
						writeInteger(this.poolIopsCapability,dos);
    ...
    public String toString() {
		...
		sb.append(",aggregateName="+aggregateName);
		sb.append(",aggregateSizeGb="+String.valueOf(aggregateSizeGb));
		sb.append(",isHybrid="+String.valueOf(isHybrid));
		sb.append(",aggregateType="+aggregateType);
		sb.append(",controller="+controller);
		sb.append(",poolAllocatedCapacityGb="+String.valueOf(poolAllocatedCapacityGb));
		sb.append(",poolUsedCapacityGb="+String.valueOf(poolUsedCapacityGb));
		sb.append(",poolIopsCapability="+String.valueOf(poolIopsCapability));
...
public static class writeToSrcFileStruct implements routines.system.IPersistableRow<writeToSrcFileStruct> {
    ...
    static byte[] commonByteArray_ADS_DATA_NO_GIT_OCI_Load_5_Aggregates = new byte[0];
			    ...
			    public Float poolAllocatedCapGb;

				public Float getPoolAllocatedCapGb () {
					return this.poolAllocatedCapGb;
				}
				
			    public Float poolUsedCapGb;

				public Float getPoolUsedCapGb () {
					return this.poolUsedCapGb;
				}
        	...
        	try {
        		...
        		int length = 0;
					...
					this.aggregateType = readString(dis);
						...
						this.controller = readInteger(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.poolAllocatedCapGb = null;
           				} else {
           			    	this.poolAllocatedCapGb = dis.readFloat();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.poolUsedCapGb = null;
           				} else {
           			    	this.poolUsedCapGb = dis.readFloat();
           				}
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.controller,dos);
					
					// Float
				
						if(this.poolAllocatedCapGb == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeFloat(this.poolAllocatedCapGb);
		            	}
					
					// Float
				
						if(this.poolUsedCapGb == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeFloat(this.poolUsedCapGb);
		            	}
    ...
    public String toString() {
		...
		sb.append(",isHybrid="+String.valueOf(isHybrid));
		sb.append(",aggregateType="+aggregateType);
		sb.append(",controller="+String.valueOf(controller));
		sb.append(",poolAllocatedCapGb="+String.valueOf(poolAllocatedCapGb));
		sb.append(",poolUsedCapGb="+String.valueOf(poolUsedCapGb));
		sb.append(",poolIopsCapability="+String.valueOf(poolIopsCapability));
		sb.append(",avgIOpS="+String.valueOf(avgIOpS));
		sb.append(",maxIOpS="+String.valueOf(maxIOpS));
	    sb.append("]");
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    ...
    static byte[] commonByteArray_ADS_DATA_NO_GIT_OCI_Load_5_Aggregates = new byte[0];
			    ...
			    public long totalAllocatedCapacityMB;

				public long getTotalAllocatedCapacityMB () {
					return this.totalAllocatedCapacityMB;
				}
				
			    public byte usesFlashPools;

				public byte getUsesFlashPools () {
					return this.usesFlashPools;
				}
			    ...
			    public Float poolAllocatedCapMB;

				public Float getPoolAllocatedCapMB () {
					return this.poolAllocatedCapMB;
				}
				
			    public Float poolUsedCapMB;

				public Float getPoolUsedCapMB () {
					return this.poolUsedCapMB;
				}
		...
		synchronized(commonByteArrayLock_ADS_DATA_NO_GIT_OCI_Load_5_Aggregates) {
        	...
        	try {
        		...
        		int length = 0;
			        ...
			        this.totalAllocatedCapacityMB = dis.readLong();
					
			        this.usesFlashPools = dis.readByte();
					
					this.type = readString(dis);
					
			        this.storageNodeId = dis.readInt();
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.poolAllocatedCapMB = null;
           				} else {
           			    	this.poolAllocatedCapMB = dis.readFloat();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.poolUsedCapMB = null;
           				} else {
           			    	this.poolUsedCapMB = dis.readFloat();
           				}
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// long
		            	...
		            	dos.writeLong(this.totalAllocatedCapacityMB);
					
					// byte
				
		            	dos.writeByte(this.usesFlashPools);
					...
					// int
		            	...
		            	dos.writeInt(this.storageNodeId);
					
					// Float
				
						if(this.poolAllocatedCapMB == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeFloat(this.poolAllocatedCapMB);
		            	}
					
					// Float
				
						if(this.poolUsedCapMB == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeFloat(this.poolUsedCapMB);
		            	}
    ...
    public String toString() {
		...
		sb.append(",totalAllocatedCapacityMB="+String.valueOf(totalAllocatedCapacityMB));
		sb.append(",usesFlashPools="+String.valueOf(usesFlashPools));
		sb.append(",type="+type);
		sb.append(",storageNodeId="+String.valueOf(storageNodeId));
		sb.append(",poolAllocatedCapMB="+String.valueOf(poolAllocatedCapMB));
		sb.append(",poolUsedCapMB="+String.valueOf(poolUsedCapMB));
		sb.append(",poolIopsCapability="+String.valueOf(poolIopsCapability));
		sb.append(",avgIOpS="+String.valueOf(avgIOpS));
		sb.append(",maxIOpS="+String.valueOf(maxIOpS));
	    sb.append("]");
...
DataStruct  rowStructOutput_tWriteJSONField_1_Out = new DataStruct();
                    ...
                    if(directory_tFileOutputDelimited_1 != null && directory_tFileOutputDelimited_1.trim().length() != 0) {
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_1, true),"US-ASCII"));
                                    if(filetFileOutputDelimited_1.length()==0){
                                        ...
                                        outtFileOutputDelimited_1.write("aggregateName");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("aggregateSizeGb");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("isHybrid");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("aggregateType");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("controller");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("poolAllocatedCapGb");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("poolUsedCapGb");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("poolIopsCapability");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("avgIOpS");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("maxIOpS");
...
+context.TEST_ROW_COUNT_LIMIT+" ";
		...
		try{
            ...
            if(rs_tMysqlInput_1.getObject(3) != null) {
                row1.storageId = rs_tMysqlInput_1.getInt(3);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tMysqlInput_1 < 4) {
								row1.totalAllocatedCapacityMB = 0;
							} else {
		                          
            if(rs_tMysqlInput_1.getObject(4) != null) {
                row1.totalAllocatedCapacityMB = rs_tMysqlInput_1.getLong(4);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tMysqlInput_1 < 5) {
								row1.usesFlashPools = 0;
							} else {
		                          
            if(rs_tMysqlInput_1.getObject(5) != null) {
                row1.usesFlashPools = rs_tMysqlInput_1.getByte(5);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.type = routines.system.JDBCUtil.getString(rs_tMysqlInput_1, 6, false);
		                    }
							if(colQtyInRs_tMysqlInput_1 < 7) {
								row1.storageNodeId = 0;
							} else {
		                          
            if(rs_tMysqlInput_1.getObject(7) != null) {
                row1.storageNodeId = rs_tMysqlInput_1.getInt(7);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tMysqlInput_1 < 8) {
								row1.poolAllocatedCapMB = null;
							} else {
		                          
            if(rs_tMysqlInput_1.getObject(8) != null) {
                row1.poolAllocatedCapMB = rs_tMysqlInput_1.getFloat(8);
            } else {
                    row1.poolAllocatedCapMB = null;
            }
		                    }
							if(colQtyInRs_tMysqlInput_1 < 9) {
								row1.poolUsedCapMB = null;
							} else {
		                          
            if(rs_tMysqlInput_1.getObject(9) != null) {
                row1.poolUsedCapMB = rs_tMysqlInput_1.getFloat(9);
            } else {
                    row1.poolUsedCapMB = null;
            }
		                    }
							if(colQtyInRs_tMysqlInput_1 < 10) {
								row1.poolIopsCapability = null;
							} else {
		                          
            if(rs_tMysqlInput_1.getObject(10) != null) {
                row1.poolIopsCapability = rs_tMysqlInput_1.getInt(10);
            } else {
                    row1.poolIopsCapability = null;
            }
		                    }
            ...
            if(rs_tMysqlInput_1.getObject(11) != null) {
                row1.avgIOpS = rs_tMysqlInput_1.getInt(11);
            } else {
                    row1.avgIOpS = null;
            }
		                    }
            ...
            if(rs_tMysqlInput_1.getObject(12) != null) {
                row1.maxIOpS = rs_tMysqlInput_1.getInt(12);
            } else {
                    row1.maxIOpS = null;
            }
		                    }
...
Var.var1 = row1.totalAllocatedCapacityMB /1024.0f;
Var.var2 = row1.poolAllocatedCapMB /1024.0f;
Var.var3 = row1.poolUsedCapMB /1024.0f;
Var.var4 = (row1.usesFlashPools ==1)?true:false ;
Var.var5 = ADSStringUtils.getRestURLForId(context.REST_URL_BASE, ADSConstants.NODE_CONTROLLERS,String.valueOf(row1.storageNodeId)) ;// ###############################
        // ###############################
        // # Output tables
...
// # Output table : 'Data'
Data_tmp.id = row1.id ;
Data_tmp.aggregateName = row1.name ;
Data_tmp.aggregateSizeGb = Var.var1 ;
Data_tmp.isHybrid = Var.var4 ;
Data_tmp.aggregateType = row1.type ;
Data_tmp.controller = Var.var5 ;
Data_tmp.poolAllocatedCapacityGb = Var.var2 ;
Data_tmp.poolUsedCapacityGb = Var.var3 ;
Data_tmp.poolIopsCapability = row1.poolIopsCapability ;
Data_tmp.avgIOpS = row1.avgIOpS ;
Data_tmp.peakIops = row1.maxIOpS ;
Data = Data_tmp;

// # Output table : 'writeToSrcFile'
writeToSrcFile_tmp.id = row1.id ;
writeToSrcFile_tmp.aggregateName = row1.name ;
writeToSrcFile_tmp.aggregateSizeGb = Var.var1 ;
writeToSrcFile_tmp.isHybrid = Var.var4 ;
writeToSrcFile_tmp.aggregateType = row1.type ;
writeToSrcFile_tmp.controller = row1.storageNodeId ;
writeToSrcFile_tmp.poolAllocatedCapGb = Var.var2 ;
writeToSrcFile_tmp.poolUsedCapGb = Var.var3 ;
writeToSrcFile_tmp.poolIopsCapability = row1.poolIopsCapability ;
writeToSrcFile_tmp.avgIOpS = row1.avgIOpS ;
writeToSrcFile_tmp.maxIOpS = row1.maxIOpS ;
...
if(Data != null) { 
	...
	valueMap_tWriteJSONField_1_Out.put("aggregateName",
	(
		Data.aggregateName != null?
            Data.aggregateName.toString():null
		));
	valueMap_tWriteJSONField_1_Out.put("aggregateSizeGb",
	(
            String.valueOf(Data.aggregateSizeGb)
		));
	valueMap_tWriteJSONField_1_Out.put("isHybrid",
	(
            String.valueOf(Data.isHybrid)
		));
	valueMap_tWriteJSONField_1_Out.put("aggregateType",
	(
            Data.aggregateType.toString()
		));
	valueMap_tWriteJSONField_1_Out.put("controller",
	(
            Data.controller.toString()
		));
	valueMap_tWriteJSONField_1_Out.put("poolAllocatedCapacityGb",
	(
		Data.poolAllocatedCapacityGb != null?
            Data.poolAllocatedCapacityGb.toString():null
		));
	valueMap_tWriteJSONField_1_Out.put("poolUsedCapacityGb",
	(
		Data.poolUsedCapacityGb != null?
            Data.poolUsedCapacityGb.toString():null
		));
	valueMap_tWriteJSONField_1_Out.put("poolIopsCapability",
	(
		Data.poolIopsCapability != null?
            Data.poolIopsCapability.toString():null
		));
	valueMap_tWriteJSONField_1_Out.put("avgIOpS",
	(
		Data.avgIOpS != null?
            Data.avgIOpS.toString():null
		));
	valueMap_tWriteJSONField_1_Out.put("peakIops",
	(
		Data.peakIops != null?
            Data.peakIops.toString():null
		));
	...
	if (needRoot_tWriteJSONField_1_Out) {
		...
		org.dom4j.Element root_0_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("aggregateName");
		if(
		valueMap_tWriteJSONField_1_Out.get("aggregateName")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_0_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("aggregateName"));
		}
		org.dom4j.Element root_1_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("aggregateSizeGb");
		if(
		valueMap_tWriteJSONField_1_Out.get("aggregateSizeGb")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_1_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("aggregateSizeGb"));
		}
		org.dom4j.Element root_2_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("aggregateType");
		if(
		valueMap_tWriteJSONField_1_Out.get("aggregateType")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_2_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("aggregateType"));
		}
		org.dom4j.Element root_3_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("isHybrid");
		if(
		valueMap_tWriteJSONField_1_Out.get("isHybrid")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_3_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("isHybrid"));
		}
		org.dom4j.Element root_4_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("controller");
		if(
		...
		org.dom4j.Element root_5_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("poolAllocatedCapacityGb");
		if(
		valueMap_tWriteJSONField_1_Out.get("poolAllocatedCapacityGb")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_5_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("poolAllocatedCapacityGb"));
		}
		org.dom4j.Element root_6_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("poolUsedCapacityGb");
		if(
		valueMap_tWriteJSONField_1_Out.get("poolUsedCapacityGb")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_6_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("poolUsedCapacityGb"));
		}
		org.dom4j.Element root_7_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("poolIopsCapability");
		if(
		valueMap_tWriteJSONField_1_Out.get("poolIopsCapability")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_7_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("poolIopsCapability"));
		}
		org.dom4j.Element root_8_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("avgIOpS");
		if(
		...
		org.dom4j.Element root_9_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("peakIops");
		if(
				...
				if(execStat){
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_1.append(
                            ...
                            if(writeToSrcFile.aggregateName != null) {
                        sb_tFileOutputDelimited_1.append(
                            writeToSrcFile.aggregateName
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(writeToSrcFile.aggregateSizeGb != null) {
                        sb_tFileOutputDelimited_1.append(
                            writeToSrcFile.aggregateSizeGb
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(writeToSrcFile.isHybrid != null) {
                        sb_tFileOutputDelimited_1.append(
                            writeToSrcFile.isHybrid
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(writeToSrcFile.aggregateType != null) {
                        sb_tFileOutputDelimited_1.append(
                            writeToSrcFile.aggregateType
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(writeToSrcFile.controller != null) {
                        sb_tFileOutputDelimited_1.append(
                            writeToSrcFile.controller
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(writeToSrcFile.poolAllocatedCapGb != null) {
                        sb_tFileOutputDelimited_1.append(
                            writeToSrcFile.poolAllocatedCapGb
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(writeToSrcFile.poolUsedCapGb != null) {
                        sb_tFileOutputDelimited_1.append(
                            writeToSrcFile.poolUsedCapGb
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(writeToSrcFile.poolIopsCapability != null) {
                        sb_tFileOutputDelimited_1.append(
                            writeToSrcFile.poolIopsCapability
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(writeToSrcFile.avgIOpS != null) {
                        sb_tFileOutputDelimited_1.append(
                            writeToSrcFile.avgIOpS
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(writeToSrcFile.maxIOpS != null) {
                        sb_tFileOutputDelimited_1.append(
                            writeToSrcFile.maxIOpS
                        );
                            }
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		ads_data_no_git.postprocess_0_1.PostProcess childJob_tRunJob_4 = new ads_data_no_git.postprocess_0_1.PostProcess();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = ADSStringUtils.getEndPointURL(context.REST_URL_BASE,context.REST_URL_AGGREGATES);;
 ...
 */
    ...
    public static void main(String[] args){
        final OCI_Load_5_Aggregates OCI_Load_5_AggregatesClass = new OCI_Load_5_Aggregates();

        int exitCode = OCI_Load_5_AggregatesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = OCI_Load_5_Aggregates.class.getClassLoader().getResourceAsStream("ads_data_no_git/oci_load_5_aggregates_0_1/contexts/"+contextStr+".properties");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : OCI_Load_5_Aggregates");
        }
...
/************************************************************************************************
 *     205254 characters generated by Talend Open Studio for Data Integration 
