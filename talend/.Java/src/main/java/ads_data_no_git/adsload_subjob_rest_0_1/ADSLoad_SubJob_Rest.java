...
package ads_data_no_git.adsload_subjob_rest_0_1;
...
public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
    final static byte[] commonByteArrayLock_ADS_DATA_NO_GIT_ADSLoad_SubJob_Rest = new byte[0];
    static byte[] commonByteArray_ADS_DATA_NO_GIT_ADSLoad_SubJob_Rest = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADS_DATA_NO_GIT_ADSLoad_SubJob_Rest.length) {
				if(length < 1024 && commonByteArray_ADS_DATA_NO_GIT_ADSLoad_SubJob_Rest.length == 0) {
   					commonByteArray_ADS_DATA_NO_GIT_ADSLoad_SubJob_Rest = new byte[1024];
				} else {
   					commonByteArray_ADS_DATA_NO_GIT_ADSLoad_SubJob_Rest = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADS_DATA_NO_GIT_ADSLoad_SubJob_Rest, 0, length);
			strReturn = new String(commonByteArray_ADS_DATA_NO_GIT_ADSLoad_SubJob_Rest, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADS_DATA_NO_GIT_ADSLoad_SubJob_Rest) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ADSLoad_SubJob_Rest.class.getClassLoader().getResourceAsStream("ads_data_no_git/adsload_subjob_rest_0_1/contexts/"+contextStr+".properties");
...
/************************************************************************************************
 *     116218 characters generated by Talend Open Studio for Data Integration 
 *     on the March 23, 2018 12:49:48 PM EDT
 ************************************************************************************************/