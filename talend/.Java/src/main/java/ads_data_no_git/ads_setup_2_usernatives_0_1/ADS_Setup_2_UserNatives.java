...
package ads_data_no_git.ads_setup_2_usernatives_0_1;
...
/**
 * Job: ADS_Setup_2_UserNatives Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.0.20170510_1410
 * @status 
 */
public class ADS_Setup_2_UserNatives implements TalendJob {
...
public String getDwh_inventory_AdditionalParams(){
	...
	private final String jobName = "ADS_Setup_2_UserNatives";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ADS_Setup_2_UserNatives.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ADS_Setup_2_UserNatives.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_ADS_DATA_NO_GIT_ADS_Setup_2_UserNatives = new byte[0];
    static byte[] commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_2_UserNatives = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_2_UserNatives.length) {
				if(length < 1024 && commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_2_UserNatives.length == 0) {
   					commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_2_UserNatives = new byte[1024];
				} else {
   					commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_2_UserNatives = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_2_UserNatives, 0, length);
			strReturn = new String(commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_2_UserNatives, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADS_DATA_NO_GIT_ADS_Setup_2_UserNatives) {
...
globalMap.put("roleLookupFile", context.ADS_LOG_DIRECTORY+jobName+"roleLookup.xlsx");
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		obj_tRunJob_4 = "/root/_embedded/userRoles";
		...
		obj_tRunJob_4 = ((String)globalMap.get("roleLookupFile"));
		...
		obj_tRunJob_4 = ADSStringUtils.getEndPointURL(context.REST_URL_BASE,context.REST_URL_USER_ROLES);;
...
public static class WriterToSrcFileStruct implements routines.system.IPersistableRow<WriterToSrcFileStruct> {
    final static byte[] commonByteArrayLock_ADS_DATA_NO_GIT_ADS_Setup_2_UserNatives = new byte[0];
    static byte[] commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_2_UserNatives = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(WriterToSrcFileStruct other) {
...
public static class UserNativeRowStruct implements routines.system.IPersistableRow<UserNativeRowStruct> {
    final static byte[] commonByteArrayLock_ADS_DATA_NO_GIT_ADS_Setup_2_UserNatives = new byte[0];
    static byte[] commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_2_UserNatives = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(UserNativeRowStruct other) {
...
public void tFileInputExcel_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try {
		...
		UserNativeRowStruct UserNativeRow = new UserNativeRowStruct();
FormattedRowStruct FormattedRow = new FormattedRowStruct();
WriterToSrcFileStruct WriterToSrcFile = new WriterToSrcFileStruct();
	...
	currentComponent="tFileOutputDelimited_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("WriterToSrcFile" + iterateId, 0, 0);
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_1, true),"ISO-8859-15"));
                                    if(filetFileOutputDelimited_1.length()==0){
                                        ...
                                        outtFileOutputDelimited_1.write("lastName");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("userName");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("email");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("password");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("enabled");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("userRole");
	...
	currentComponent="tMap_3";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("UserNativeRow" + iterateId, 0, 0);
...
WriterToSrcFileStruct WriterToSrcFile_tmp = new WriterToSrcFileStruct();
// ###############################
 ...
 */
	...
	currentComponent="tFileInputExcel_1";
		...
		Object source_tFileInputExcel_1 = context.LOAD_FILES_LOC+"/"+context.ADS_SETUP_LOADSHEET_USER_NATIVES_XLSX;
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			UserNativeRow = new UserNativeRowStruct();
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				UserNativeRow.firstName = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				UserNativeRow.firstName = null;
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				UserNativeRow.lastName = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				UserNativeRow.lastName = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "userName";

				UserNativeRow.userName = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				UserNativeRow.userName = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				UserNativeRow.email = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				UserNativeRow.email = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "password";

				UserNativeRow.password = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				UserNativeRow.password = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "enabled";

				UserNativeRow.enabled = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				UserNativeRow.enabled = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "userRoleId";

				UserNativeRow.userRoleId = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				UserNativeRow.userRoleId = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
 ...
 */
// Start of branch "UserNativeRow"
if(UserNativeRow != null) { 
	...
	currentComponent="tMap_3";
			...
			//UserNativeRow
				...
				if(execStat){
					runStat.updateStatOnConnection("UserNativeRow"+iterateId,1, 1);
				} 
 					    ...
 					    boolean forceLooprow1 = false;
 							...
 							row1Struct row1ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_3 = false;
                        		    		...
                        		    		row1HashKey.Name = UserNativeRow.userRoleId ;
...
Var.enabled = ADSStringUtils.getBooleanForString(UserNativeRow.enabled) ;
Var.var1 = ADSStringUtils.getRestURLForId(context.REST_URL_BASE, ADSConstants.NODE_ROLES,String.valueOf(row1.Value)) ;// ###############################
        // ###############################
        // # Output tables

FormattedRow = null;
WriterToSrcFile = null;


// # Output table : 'FormattedRow'
FormattedRow_tmp.firstName = UserNativeRow.firstName ;
FormattedRow_tmp.lastName = UserNativeRow.lastName ;
FormattedRow_tmp.userName = UserNativeRow.userName ;
FormattedRow_tmp.email = UserNativeRow.email ;
FormattedRow_tmp.password = UserNativeRow.password ;
FormattedRow_tmp.enabled = Var.enabled ;
FormattedRow_tmp.userRole = Var.var1 ;
FormattedRow = FormattedRow_tmp;

// # Output table : 'WriterToSrcFile'
WriterToSrcFile_tmp.firstName = UserNativeRow.firstName  ;
WriterToSrcFile_tmp.lastName = UserNativeRow.lastName  ;
WriterToSrcFile_tmp.userName = UserNativeRow.userName  ;
WriterToSrcFile_tmp.email = UserNativeRow.email  ;
WriterToSrcFile_tmp.password = UserNativeRow.password  ;
WriterToSrcFile_tmp.enabled = Var.enabled  ;
WriterToSrcFile_tmp.userRole = Var.var1 ;
WriterToSrcFile = WriterToSrcFile_tmp;
// ###############################
...
if(FormattedRow != null) { 
	...
	valueMap_tWriteJSONField_2_Out.put("firstName",
	(
		FormattedRow.firstName != null?
            FormattedRow.firstName.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("lastName",
	(
		FormattedRow.lastName != null?
            FormattedRow.lastName.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("userName",
	(
            FormattedRow.userName.toString()
		));
	valueMap_tWriteJSONField_2_Out.put("email",
	(
            FormattedRow.email.toString()
		));
	valueMap_tWriteJSONField_2_Out.put("password",
	(
		FormattedRow.password != null?
            FormattedRow.password.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("enabled",
	(
		FormattedRow.enabled != null?
            FormattedRow.enabled.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("userRole",
	(
		FormattedRow.userRole != null?
            FormattedRow.userRole.toString():null
		));
	...
	if (needRoot_tWriteJSONField_2_Out) {
		...
		org.dom4j.Element root_0_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("lastName");
		if(
		valueMap_tWriteJSONField_2_Out.get("lastName")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_0_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("lastName"));
		}
		org.dom4j.Element root_1_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("email");
		if(
		...
		org.dom4j.Element root_2_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("password");
		if(
		valueMap_tWriteJSONField_2_Out.get("password")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_2_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("password"));
		}
		org.dom4j.Element root_3_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("userName");
		if(
		valueMap_tWriteJSONField_2_Out.get("userName")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_3_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("userName"));
		}
		org.dom4j.Element root_4_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("enabled");
		if(
		valueMap_tWriteJSONField_2_Out.get("enabled")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_4_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("enabled"));
		}
		org.dom4j.Element root_5_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("userRole");
		if(
		valueMap_tWriteJSONField_2_Out.get("userRole")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_5_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("userRole"));
		}
	...
	// build loop xml tree
		org.dom4j.Element loop_tWriteJSONField_2_Out = org.dom4j.DocumentHelper.createElement("firstName");
		...
		if(
		valueMap_tWriteJSONField_2_Out.get("firstName")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(loop_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("firstName"));
		}
...
// Start of branch "WriterToSrcFile"
if(WriterToSrcFile != null) { 
	...
	currentComponent="tFileOutputDelimited_1";
			...
			//WriterToSrcFile
				...
				if(execStat){
					runStat.updateStatOnConnection("WriterToSrcFile"+iterateId,1, 1);
				} 
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                            if(WriterToSrcFile.firstName != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriterToSrcFile.firstName
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriterToSrcFile.lastName != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriterToSrcFile.lastName
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriterToSrcFile.userName != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriterToSrcFile.userName
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriterToSrcFile.email != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriterToSrcFile.email
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriterToSrcFile.password != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriterToSrcFile.password
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriterToSrcFile.enabled != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriterToSrcFile.enabled
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriterToSrcFile.userRole != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriterToSrcFile.userRole
                        );
                            }
...
} // End of branch "WriterToSrcFile"





} // End of branch "UserNativeRow"
...
// ###############################      
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("UserNativeRow"+iterateId,2, 0); 
			 	}
			}
 ...
 */
	...
	currentComponent="tFileOutputDelimited_1";
		...
		resourceMap.put("finish_tFileOutputDelimited_1", true);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("WriterToSrcFile"+iterateId,2, 0); 
			 	}
			}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row1";
        ...
        new BytesLimit65535_tAdvancedHash_row1().limitLog4jByte();
			   		...
			   		// linked node: tMap_3 - inputs:(UserNativeRow,row1) outputs:(FormattedRow,WriterToSrcFile)
 ...
 */
	...
	currentComponent="tFileInputExcel_2";
		...
		Object source_tFileInputExcel_2 = ((String)globalMap.get("roleLookupFile"));
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		obj_tRunJob_2 = ADSStringUtils.getEndPointURL(context.REST_URL_BASE,context.REST_URL_USER_NATIVES);;
 ...
 */
    ...
    public static void main(String[] args){
        final ADS_Setup_2_UserNatives ADS_Setup_2_UserNativesClass = new ADS_Setup_2_UserNatives();

        int exitCode = ADS_Setup_2_UserNativesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ADS_Setup_2_UserNatives.class.getClassLoader().getResourceAsStream("ads_data_no_git/ads_setup_2_usernatives_0_1/contexts/"+contextStr+".properties");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ADS_Setup_2_UserNatives");
        }
...
/************************************************************************************************
 *     240035 characters generated by Talend Open Studio for Data Integration 
 *     on the March 23, 2018 12:42:51 PM EDT
 ************************************************************************************************/