...
package ads_data_no_git.oci_load_6_nasvolumes_0_1;
...
/**
 * Job: OCI_Load_6_NasVolumes Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 6.4.0.20170510_1410
 * @status 
 */
public class OCI_Load_6_NasVolumes implements TalendJob {
...
public String getDwh_inventory_AdditionalParams(){
	...
	private final String jobName = "OCI_Load_6_NasVolumes";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				OCI_Load_6_NasVolumes.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(OCI_Load_6_NasVolumes.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_ADS_DATA_NO_GIT_OCI_Load_6_NasVolumes = new byte[0];
    static byte[] commonByteArray_ADS_DATA_NO_GIT_OCI_Load_6_NasVolumes = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADS_DATA_NO_GIT_OCI_Load_6_NasVolumes.length) {
				if(length < 1024 && commonByteArray_ADS_DATA_NO_GIT_OCI_Load_6_NasVolumes.length == 0) {
   					commonByteArray_ADS_DATA_NO_GIT_OCI_Load_6_NasVolumes = new byte[1024];
				} else {
   					commonByteArray_ADS_DATA_NO_GIT_OCI_Load_6_NasVolumes = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADS_DATA_NO_GIT_OCI_Load_6_NasVolumes, 0, length);
			strReturn = new String(commonByteArray_ADS_DATA_NO_GIT_OCI_Load_6_NasVolumes, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADS_DATA_NO_GIT_OCI_Load_6_NasVolumes) {
...
if(row4 != null) { 
  ...
  try{
        ...
        {
           context.new1=value_tContextLoad_1;
        }
...
globalMap.put("aggregatesLookupFile", context.ADS_LOG_DIRECTORY+jobName+"aggregatesLookupFile.xlsx");
globalMap.put("controllerLookupFile", context.ADS_LOG_DIRECTORY+jobName+"controllerLookupFile.xlsx");
...
public static class FormattedRowStruct implements routines.system.IPersistableRow<FormattedRowStruct> {
    ...
    static byte[] commonByteArray_ADS_DATA_NO_GIT_OCI_Load_6_NasVolumes = new byte[0];
			    ...
			    public Integer volumeLastAccessed;

				public Integer getVolumeLastAccessed () {
			    ...
			    public String qtreeTally;

				public String getQtreeTally () {
					return this.qtreeTally;
				}
				
			    public String snapDestinationVolume;
		...
		synchronized(commonByteArrayLock_ADS_DATA_NO_GIT_OCI_Load_6_NasVolumes) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.vserver = readString(dis);
					
					this.volumeName = readString(dis);
					
						this.allocatedCapacityGb = readInteger(dis);
					
						this.usedCapacityGb = readInteger(dis);
					
					this.snapType = readString(dis);
					
						this.snapSrcVolumeId = readInteger(dis);
					
						this.snapTgtVolumeId = readInteger(dis);
					
						this.snapTally = readInteger(dis);
					
					this.volumeStatus = readString(dis);
					
						this.volumeLastAccessed = readInteger(dis);
					
						this.avgIops = readInteger(dis);
					
						this.peakIops = readInteger(dis);
					
					this.controller = readString(dis);
					
					this.aggregate = readString(dis);
					
					this.qtreeTally = readString(dis);
					
					this.snapDestinationVolume = readString(dis);
					
					this.disposition = readString(dis);
					
					this.justification = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.vserver,dos);
					
					// String
				
						writeString(this.volumeName,dos);
					
					// Integer
				
						writeInteger(this.allocatedCapacityGb,dos);
					
					// Integer
				
						writeInteger(this.usedCapacityGb,dos);
					
					// String
				
						writeString(this.snapType,dos);
					
					// Integer
				
						writeInteger(this.snapSrcVolumeId,dos);
					
					// Integer
				
						writeInteger(this.snapTgtVolumeId,dos);
					
					// Integer
				
						writeInteger(this.snapTally,dos);
					
					// String
				
						writeString(this.volumeStatus,dos);
					
					// Integer
				
						writeInteger(this.volumeLastAccessed,dos);
					
					// Integer
				
						writeInteger(this.avgIops,dos);
					
					// Integer
				
						writeInteger(this.peakIops,dos);
					
					// String
				
						writeString(this.controller,dos);
					
					// String
				
						writeString(this.aggregate,dos);
					
					// String
				
						writeString(this.qtreeTally,dos);
					
					// String
				
						writeString(this.snapDestinationVolume,dos);
					...
					// String
						...
						writeString(this.justification,dos);
    ...
    public String toString() {
		...
		sb.append(",vserver="+vserver);
		sb.append(",volumeName="+volumeName);
		sb.append(",allocatedCapacityGb="+String.valueOf(allocatedCapacityGb));
		sb.append(",usedCapacityGb="+String.valueOf(usedCapacityGb));
		sb.append(",snapType="+snapType);
		sb.append(",snapSrcVolumeId="+String.valueOf(snapSrcVolumeId));
		sb.append(",snapTgtVolumeId="+String.valueOf(snapTgtVolumeId));
		sb.append(",snapTally="+String.valueOf(snapTally));
		sb.append(",volumeStatus="+volumeStatus);
		sb.append(",volumeLastAccessed="+String.valueOf(volumeLastAccessed));
		sb.append(",avgIops="+String.valueOf(avgIops));
		sb.append(",peakIops="+String.valueOf(peakIops));
		sb.append(",controller="+controller);
		sb.append(",aggregate="+aggregate);
		sb.append(",qtreeTally="+qtreeTally);
		sb.append(",snapDestinationVolume="+snapDestinationVolume);
...
public static class WriteToSrcDataStruct implements routines.system.IPersistableRow<WriteToSrcDataStruct> {
    final static byte[] commonByteArrayLock_ADS_DATA_NO_GIT_OCI_Load_6_NasVolumes = new byte[0];
    static byte[] commonByteArray_ADS_DATA_NO_GIT_OCI_Load_6_NasVolumes = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(WriteToSrcDataStruct other) {
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    ...
    static byte[] commonByteArray_ADS_DATA_NO_GIT_OCI_Load_6_NasVolumes = new byte[0];
			    ...
			    public BigDecimal allocCap;

				public BigDecimal getAllocCap () {
					return this.allocCap;
				}
				
			    public BigDecimal usedCap;
			    ...
			    public Integer snapSrcVolId;

				public Integer getSnapSrcVolId () {
					return this.snapSrcVolId;
				}
				
			    public Integer snapTgtVolId;

				public Integer getSnapTgtVolId () {
					return this.snapTgtVolId;
				}
				
			    public Integer snap_count;

				public Integer getSnap_count () {
		...
		synchronized(commonByteArrayLock_ADS_DATA_NO_GIT_OCI_Load_6_NasVolumes) {
        	...
        	try {
        		...
        		int length = 0;
			        ...
			        this.intVolId = dis.readInt();
					
			        this.contId = dis.readInt();
					
			        this.aggrId = dis.readInt();
					
					this.vServer = readString(dis);
					
					this.volName = readString(dis);
					
						this.allocCap = (BigDecimal) dis.readObject();
					
						this.usedCap = (BigDecimal) dis.readObject();
					
					this.snapType = readString(dis);
					
						this.snapSrcVolId = readInteger(dis);
					
						this.snapTgtVolId = readInteger(dis);
					
						this.snap_count = readInteger(dis);
					
					this.status = readString(dis);
					
						this.lastAccess = readInteger(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// int
		            	...
		            	dos.writeInt(this.intVolId);
					
					// int
				
		            	dos.writeInt(this.contId);
					
					// int
				
		            	dos.writeInt(this.aggrId);
					...
					// String
						...
						writeString(this.volName,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.allocCap);
					
					// BigDecimal
				
       			    	dos.writeObject(this.usedCap);
					...
					// Integer
						...
						writeInteger(this.snapSrcVolId,dos);
					
					// Integer
				
						writeInteger(this.snapTgtVolId,dos);
					
					// Integer
				
						writeInteger(this.snap_count,dos);
					...
					// Integer
						...
						writeInteger(this.lastAccess,dos);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("intVolId="+String.valueOf(intVolId));
		sb.append(",contId="+String.valueOf(contId));
		sb.append(",aggrId="+String.valueOf(aggrId));
		sb.append(",vServer="+vServer);
		sb.append(",volName="+volName);
		sb.append(",allocCap="+String.valueOf(allocCap));
		sb.append(",usedCap="+String.valueOf(usedCap));
		sb.append(",snapType="+snapType);
		sb.append(",snapSrcVolId="+String.valueOf(snapSrcVolId));
		sb.append(",snapTgtVolId="+String.valueOf(snapTgtVolId));
		sb.append(",snap_count="+String.valueOf(snap_count));
		sb.append(",status="+status);
		sb.append(",lastAccess="+String.valueOf(lastAccess));
		sb.append(",avgIOpS="+String.valueOf(avgIOpS));
		sb.append(",peakIOpS="+String.valueOf(peakIOpS));
	    sb.append("]");
...
WriteToSrcDataStruct WriteToSrcData = new WriteToSrcDataStruct();
...
FormattedRowStruct  rowStructOutput_tWriteJSONField_1_Out = new FormattedRowStruct();
	...
	currentComponent="tFileOutputDelimited_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("WriteToSrcData" + iterateId, 0, 0);
                    ...
                    if(directory_tFileOutputDelimited_1 != null && directory_tFileOutputDelimited_1.trim().length() != 0) {
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_1, true),"US-ASCII"));
                                    if(filetFileOutputDelimited_1.length()==0){
                                        ...
                                        outtFileOutputDelimited_1.write("vserver");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("volumeName");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("allocatedCapacityGb");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("usedCapacityGb");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("snapType");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("snapSrcVolumeId");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("snapTgtVolumeId");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("snapTally");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("volumeStatus");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("volumeLastAccessed");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("avgIops");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("peakIops");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("controller");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("aggregate");
...
WriteToSrcDataStruct WriteToSrcData_tmp = new WriteToSrcDataStruct();
// ###############################
...
+context.TEST_ROW_COUNT_LIMIT+" ";
		...
		try{
            ...
            if(rs_tMysqlInput_1.getObject(1) != null) {
                row1.intVolId = rs_tMysqlInput_1.getInt(1);
            } else {
            ...
            if(rs_tMysqlInput_1.getObject(2) != null) {
                row1.contId = rs_tMysqlInput_1.getInt(2);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            if(rs_tMysqlInput_1.getObject(3) != null) {
                row1.aggrId = rs_tMysqlInput_1.getInt(3);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.vServer = routines.system.JDBCUtil.getString(rs_tMysqlInput_1, 4, false);
		                    }
							if(colQtyInRs_tMysqlInput_1 < 5) {
								row1.volName = null;
							} else {
	                         		
        	row1.volName = routines.system.JDBCUtil.getString(rs_tMysqlInput_1, 5, false);
		                    }
            ...
            if(rs_tMysqlInput_1.getObject(6) != null) {
                row1.allocCap = rs_tMysqlInput_1.getBigDecimal(6);
            } else {
                    row1.allocCap = null;
            }
		                    }
            ...
            if(rs_tMysqlInput_1.getObject(7) != null) {
                row1.usedCap = rs_tMysqlInput_1.getBigDecimal(7);
            } else {
                    row1.usedCap = null;
            }
		                    }
        	...
        	row1.snapType = routines.system.JDBCUtil.getString(rs_tMysqlInput_1, 8, false);
		                    }
							if(colQtyInRs_tMysqlInput_1 < 9) {
								row1.snapSrcVolId = null;
							} else {
		                          
            if(rs_tMysqlInput_1.getObject(9) != null) {
                row1.snapSrcVolId = rs_tMysqlInput_1.getInt(9);
            } else {
                    row1.snapSrcVolId = null;
            }
		                    }
							if(colQtyInRs_tMysqlInput_1 < 10) {
								row1.snapTgtVolId = null;
							} else {
		                          
            if(rs_tMysqlInput_1.getObject(10) != null) {
                row1.snapTgtVolId = rs_tMysqlInput_1.getInt(10);
            } else {
                    row1.snapTgtVolId = null;
            }
		                    }
							if(colQtyInRs_tMysqlInput_1 < 11) {
								row1.snap_count = null;
							} else {
		                          
            if(rs_tMysqlInput_1.getObject(11) != null) {
                row1.snap_count = rs_tMysqlInput_1.getInt(11);
            } else {
                    row1.snap_count = null;
            }
		                    }
        	...
        	row1.status = routines.system.JDBCUtil.getString(rs_tMysqlInput_1, 12, false);
		                    }
							if(colQtyInRs_tMysqlInput_1 < 13) {
								row1.lastAccess = null;
							} else {
		                          
            if(rs_tMysqlInput_1.getObject(13) != null) {
                row1.lastAccess = rs_tMysqlInput_1.getInt(13);
            } else {
                    row1.lastAccess = null;
            }
		                    }
            ...
            if(rs_tMysqlInput_1.getObject(14) != null) {
                row1.avgIOpS = rs_tMysqlInput_1.getInt(14);
            } else {
                    row1.avgIOpS = null;
            }
		                    }
            ...
            if(rs_tMysqlInput_1.getObject(15) != null) {
                row1.peakIOpS = rs_tMysqlInput_1.getInt(15);
            } else {
                    row1.peakIOpS = null;
            }
		                    }
...
Var.var1 = ADSStringUtils.getRestURLForId(context.REST_URL_BASE, ADSConstants.NODE_CONTROLLERS,String.valueOf(row1.contId)) ;
Var.var2 = ADSStringUtils.getRestURLForId(context.REST_URL_BASE, ADSConstants.NODE_AGGREGATES,String.valueOf(row1.aggrId)) ;
Var.var3 = row1.allocCap.intValue() ;
Var.var4 = row1.usedCap.intValue() ;// ###############################
        // ###############################
        // # Output tables
...
FormattedRow_tmp.id = row1.intVolId ;
FormattedRow_tmp.vserver = row1.vServer ;
FormattedRow_tmp.volumeName = row1.volName ;
FormattedRow_tmp.allocatedCapacityGb = Var.var3 ;
FormattedRow_tmp.usedCapacityGb = Var.var4 ;
FormattedRow_tmp.snapType = row1.snapType ;
FormattedRow_tmp.snapSrcVolumeId = row1.snapSrcVolId ;
FormattedRow_tmp.snapTgtVolumeId = row1.snapTgtVolId ;
FormattedRow_tmp.snapTally = row1.snap_count ;
FormattedRow_tmp.volumeStatus = row1.status ;
FormattedRow_tmp.volumeLastAccessed = row1.lastAccess ;
FormattedRow_tmp.avgIops = row1.avgIOpS ;
FormattedRow_tmp.peakIops = row1.peakIOpS ;
FormattedRow_tmp.controller = Var.var1 ;
FormattedRow_tmp.aggregate = Var.var2 ;
FormattedRow_tmp.qtreeTally = null;
FormattedRow_tmp.snapDestinationVolume = null;
FormattedRow_tmp.disposition = null;
FormattedRow_tmp.justification = null;
FormattedRow = FormattedRow_tmp;

// # Output table : 'WriteToSrcData'
WriteToSrcData_tmp.id = row1.intVolId ;
WriteToSrcData_tmp.vserver = row1.vServer ;
WriteToSrcData_tmp.volumeName = row1.volName ;
WriteToSrcData_tmp.allocatedCapacityGb = Var.var3 ;
WriteToSrcData_tmp.usedCapacityGb = Var.var4 ;
WriteToSrcData_tmp.snapType = row1.snapType ;
WriteToSrcData_tmp.snapSrcVolumeId = row1.snapSrcVolId ;
WriteToSrcData_tmp.snapTgtVolumeId = row1.snapTgtVolId ;
WriteToSrcData_tmp.snapTally = row1.snap_count ;
WriteToSrcData_tmp.volumeStatus = row1.status ;
WriteToSrcData_tmp.volumeLastAccessed = row1.lastAccess ;
WriteToSrcData_tmp.avgIops = row1.avgIOpS ;
WriteToSrcData_tmp.peakIops = row1.peakIOpS ;
WriteToSrcData_tmp.controller = Var.var1 ;
WriteToSrcData_tmp.aggregate = Var.var2 ;
WriteToSrcData = WriteToSrcData_tmp;
// ###############################
...
if(FormattedRow != null) { 
	...
	(
		FormattedRow.id != null?
            FormattedRow.id.toString():null
		));
	valueMap_tWriteJSONField_1_Out.put("vserver",
	(
		FormattedRow.vserver != null?
            FormattedRow.vserver.toString():null
		));
	valueMap_tWriteJSONField_1_Out.put("volumeName",
	(
		FormattedRow.volumeName != null?
            FormattedRow.volumeName.toString():null
		));
	valueMap_tWriteJSONField_1_Out.put("allocatedCapacityGb",
	(
		FormattedRow.allocatedCapacityGb != null?
            FormattedRow.allocatedCapacityGb.toString():null
		));
	valueMap_tWriteJSONField_1_Out.put("usedCapacityGb",
	(
		FormattedRow.usedCapacityGb != null?
            FormattedRow.usedCapacityGb.toString():null
		));
	valueMap_tWriteJSONField_1_Out.put("snapType",
	(
		FormattedRow.snapType != null?
            FormattedRow.snapType.toString():null
		));
	valueMap_tWriteJSONField_1_Out.put("snapSrcVolumeId",
	(
		FormattedRow.snapSrcVolumeId != null?
            FormattedRow.snapSrcVolumeId.toString():null
		));
	valueMap_tWriteJSONField_1_Out.put("snapTgtVolumeId",
	(
		FormattedRow.snapTgtVolumeId != null?
            FormattedRow.snapTgtVolumeId.toString():null
		));
	valueMap_tWriteJSONField_1_Out.put("snapTally",
	(
		FormattedRow.snapTally != null?
            FormattedRow.snapTally.toString():null
		));
	valueMap_tWriteJSONField_1_Out.put("volumeStatus",
	(
		FormattedRow.volumeStatus != null?
            FormattedRow.volumeStatus.toString():null
		));
	valueMap_tWriteJSONField_1_Out.put("volumeLastAccessed",
	(
		FormattedRow.volumeLastAccessed != null?
            FormattedRow.volumeLastAccessed.toString():null
		));
	valueMap_tWriteJSONField_1_Out.put("avgIops",
	(
		FormattedRow.avgIops != null?
            FormattedRow.avgIops.toString():null
		));
	valueMap_tWriteJSONField_1_Out.put("peakIops",
	(
		FormattedRow.peakIops != null?
            FormattedRow.peakIops.toString():null
		));
	valueMap_tWriteJSONField_1_Out.put("controller",
	(
		FormattedRow.controller != null?
            FormattedRow.controller.toString():null
		));
	valueMap_tWriteJSONField_1_Out.put("aggregate",
	(
		FormattedRow.aggregate != null?
            FormattedRow.aggregate.toString():null
		));
	valueMap_tWriteJSONField_1_Out.put("qtreeTally",
	(
		FormattedRow.qtreeTally != null?
            FormattedRow.qtreeTally.toString():null
		));
	valueMap_tWriteJSONField_1_Out.put("snapDestinationVolume",
	(
		FormattedRow.snapDestinationVolume != null?
            FormattedRow.snapDestinationVolume.toString():null
		));
	valueMap_tWriteJSONField_1_Out.put("disposition",
	(
		FormattedRow.disposition != null?
            FormattedRow.disposition.toString():null
		));
	valueMap_tWriteJSONField_1_Out.put("justification",
	(
		FormattedRow.justification != null?
            FormattedRow.justification.toString():null
		));
	...
	if (needRoot_tWriteJSONField_1_Out) {
		...
		org.dom4j.Element root_0_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("vserver");
		if(
		valueMap_tWriteJSONField_1_Out.get("vserver")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_0_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("vserver"));
		}
		org.dom4j.Element root_1_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("volumeName");
		if(
		valueMap_tWriteJSONField_1_Out.get("volumeName")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_1_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("volumeName"));
		}
		org.dom4j.Element root_2_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("allocatedCapacityGb");
		if(
		valueMap_tWriteJSONField_1_Out.get("allocatedCapacityGb")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_2_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("allocatedCapacityGb"));
		}
		org.dom4j.Element root_3_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("usedCapacityGb");
		if(
		valueMap_tWriteJSONField_1_Out.get("usedCapacityGb")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_3_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("usedCapacityGb"));
		}
		org.dom4j.Element root_4_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("snapType");
		if(
		valueMap_tWriteJSONField_1_Out.get("snapType")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_4_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("snapType"));
		}
		org.dom4j.Element root_5_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("snapSrcVolumeId");
		if(
		valueMap_tWriteJSONField_1_Out.get("snapSrcVolumeId")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_5_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("snapSrcVolumeId"));
		}
		org.dom4j.Element root_6_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("snapTgtVolumeId");
		if(
		valueMap_tWriteJSONField_1_Out.get("snapTgtVolumeId")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_6_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("snapTgtVolumeId"));
		}
		org.dom4j.Element root_7_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("snapTally");
		if(
		valueMap_tWriteJSONField_1_Out.get("snapTally")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_7_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("snapTally"));
		}
		org.dom4j.Element root_8_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("volumeStatus");
		if(
		valueMap_tWriteJSONField_1_Out.get("volumeStatus")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_8_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("volumeStatus"));
		}
		org.dom4j.Element root_9_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("volumeLastAccessed");
		if(
		valueMap_tWriteJSONField_1_Out.get("volumeLastAccessed")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_9_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("volumeLastAccessed"));
		}
		org.dom4j.Element root_10_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("avgIops");
		if(
		valueMap_tWriteJSONField_1_Out.get("avgIops")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_10_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("avgIops"));
		}
		org.dom4j.Element root_11_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("peakIops");
		if(
		valueMap_tWriteJSONField_1_Out.get("peakIops")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_11_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("peakIops"));
		}
		org.dom4j.Element root_12_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("controller");
		if(
		valueMap_tWriteJSONField_1_Out.get("controller")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_12_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("controller"));
		}
		org.dom4j.Element root_13_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("aggregate");
		if(
		valueMap_tWriteJSONField_1_Out.get("aggregate")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_13_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("aggregate"));
		}
		org.dom4j.Element root_14_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("qtreeTally");
		if(
		valueMap_tWriteJSONField_1_Out.get("qtreeTally")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_14_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("qtreeTally"));
		}
		org.dom4j.Element root_15_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("snapDestinationVolume");
		if(
		valueMap_tWriteJSONField_1_Out.get("snapDestinationVolume")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_15_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("snapDestinationVolume"));
		}
		org.dom4j.Element root_16_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("disposition");
		if(
		valueMap_tWriteJSONField_1_Out.get("disposition")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_16_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("disposition"));
		}
		org.dom4j.Element root_17_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("justification");
		if(
		valueMap_tWriteJSONField_1_Out.get("justification")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_17_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("justification"));
		}
...
// Start of branch "WriteToSrcData"
if(WriteToSrcData != null) { 
	...
	currentComponent="tFileOutputDelimited_1";
			...
			//WriteToSrcData
				...
				if(execStat){
					runStat.updateStatOnConnection("WriteToSrcData"+iterateId,1, 1);
				} 
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                            if(WriteToSrcData.id != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcData.id
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcData.vserver != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcData.vserver
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcData.volumeName != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcData.volumeName
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcData.allocatedCapacityGb != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcData.allocatedCapacityGb
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcData.usedCapacityGb != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcData.usedCapacityGb
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcData.snapType != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcData.snapType
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcData.snapSrcVolumeId != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcData.snapSrcVolumeId
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcData.snapTgtVolumeId != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcData.snapTgtVolumeId
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcData.snapTally != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcData.snapTally
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcData.volumeStatus != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcData.volumeStatus
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcData.volumeLastAccessed != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcData.volumeLastAccessed
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcData.avgIops != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcData.avgIops
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcData.peakIops != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcData.peakIops
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcData.controller != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcData.controller
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcData.aggregate != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcData.aggregate
                        );
                            }
 ...
 */
	...
	currentComponent="tFileOutputDelimited_1";
		...
		resourceMap.put("finish_tFileOutputDelimited_1", true);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("WriteToSrcData"+iterateId,2, 0); 
			 	}
			}
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		obj_tRunJob_2 = ((String)globalMap.get("logEmail"));;
		paraList_tRunJob_2.add("--context_param logEmail=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
		
		parentContextMap_tRunJob_2.put("logEmail", obj_tRunJob_2);
		...
		obj_tRunJob_2 = ((String)globalMap.get("sourceLoadDoc"));;
		paraList_tRunJob_2.add("--context_param SRC_LOAD_SHEET=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
		
		parentContextMap_tRunJob_2.put("SRC_LOAD_SHEET", obj_tRunJob_2);
	
		obj_tRunJob_2 = context.ADS_LOG_DIRECTORY;
		...
		obj_tRunJob_2 = ADSStringUtils.getCurrentTimeInRestFormat();
		paraList_tRunJob_2.add("--context_param JOB_END_TIME=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
		
		parentContextMap_tRunJob_2.put("JOB_END_TIME", obj_tRunJob_2);
	
		obj_tRunJob_2 = ADSConstants.LOG_JOB_STATUS_FINISHED;
		...
		obj_tRunJob_2 = globalMap.get("jobId");
		...
		obj_tRunJob_2 = context.ADS_EMAIL_TO;
		paraList_tRunJob_2.add("--context_param ADS_EMAIL_TO=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
		
		parentContextMap_tRunJob_2.put("ADS_EMAIL_TO", obj_tRunJob_2);
	
		obj_tRunJob_2 = context.ADS_EMAIL_FROM;
		paraList_tRunJob_2.add("--context_param ADS_EMAIL_FROM=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
		
		parentContextMap_tRunJob_2.put("ADS_EMAIL_FROM", obj_tRunJob_2);
	
		obj_tRunJob_2 = context.ADS_EMAIL_SMTP_NAME;
		paraList_tRunJob_2.add("--context_param ADS_EMAIL_SMTP_NAME=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
		
		parentContextMap_tRunJob_2.put("ADS_EMAIL_SMTP_NAME", obj_tRunJob_2);
	
		obj_tRunJob_2 = context.ADS_EMAIL_SMTP_PORT;
		paraList_tRunJob_2.add("--context_param ADS_EMAIL_SMTP_PORT=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
		
		parentContextMap_tRunJob_2.put("ADS_EMAIL_SMTP_PORT", obj_tRunJob_2);
	
		obj_tRunJob_2 = context.ADS_EMAIL_AUTHENTICATION_USER;
		paraList_tRunJob_2.add("--context_param ADS_EMAIL_AUTHENTICATION_USER=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
		
		parentContextMap_tRunJob_2.put("ADS_EMAIL_AUTHENTICATION_USER", obj_tRunJob_2);
	
		obj_tRunJob_2 = context.ADS_EMAIL_AUTHENTICATION_PASSWORD;
		paraList_tRunJob_2.add("--context_param ADS_EMAIL_AUTHENTICATION_PASSWORD=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
		
		parentContextMap_tRunJob_2.put("ADS_EMAIL_AUTHENTICATION_PASSWORD", obj_tRunJob_2);
	
		obj_tRunJob_2 = context.REST_URL_BASE;
		paraList_tRunJob_2.add("--context_param REST_URL_BASE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
		
		parentContextMap_tRunJob_2.put("REST_URL_BASE", obj_tRunJob_2);
	
	
		ads_data_no_git.postprocess_0_1.PostProcess childJob_tRunJob_2 = new ads_data_no_git.postprocess_0_1.PostProcess();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = ADSStringUtils.getEndPointURL(context.REST_URL_BASE,context.REST_URL_NAS_VOLUMES);;
		...
		ads_data_no_git.adsload_subjob_rest_0_1.ADSLoad_SubJob_Rest childJob_tRunJob_1 = new ads_data_no_git.adsload_subjob_rest_0_1.ADSLoad_SubJob_Rest();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final OCI_Load_6_NasVolumes OCI_Load_6_NasVolumesClass = new OCI_Load_6_NasVolumes();

        int exitCode = OCI_Load_6_NasVolumesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = OCI_Load_6_NasVolumes.class.getClassLoader().getResourceAsStream("ads_data_no_git/oci_load_6_nasvolumes_0_1/contexts/"+contextStr+".properties");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : OCI_Load_6_NasVolumes");
        }
...
/************************************************************************************************
 *     216480 characters generated by Talend Open Studio for Data Integration 
 *     on the March 23, 2018 12:49:54 PM EDT
 ************************************************************************************************/