...
package ads_data_no_git.ads_setup_master_0_1;
...
/**
 * Job: ADS_Setup_Master Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.0.20170510_1410
 * @status 
 */
public class ADS_Setup_Master implements TalendJob {
...
public String getTEST_ROW_COUNT_LIMIT(){
	...
	private final String jobName = "ADS_Setup_Master";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ADS_Setup_Master.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ADS_Setup_Master.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		ads_data_no_git.ads_setup_1_userroles_0_1.ADS_Setup_1_UserRoles childJob_tRunJob_1 = new ads_data_no_git.ads_setup_1_userroles_0_1.ADS_Setup_1_UserRoles();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		ads_data_no_git.ads_setup_2_usernatives_0_1.ADS_Setup_2_UserNatives childJob_tRunJob_2 = new ads_data_no_git.ads_setup_2_usernatives_0_1.ADS_Setup_2_UserNatives();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		ads_data_no_git.ads_setup_3_auditevents_0_1.ADS_Setup_3_AuditEvents childJob_tRunJob_3 = new ads_data_no_git.ads_setup_3_auditevents_0_1.ADS_Setup_3_AuditEvents();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		ads_data_no_git.ads_setup_4_auditreasoncodes_0_1.ADS_Setup_4_AuditReasonCodes childJob_tRunJob_4 = new ads_data_no_git.ads_setup_4_auditreasoncodes_0_1.ADS_Setup_4_AuditReasonCodes();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		ads_data_no_git.ads_setup_5_applications_0_1.ADS_Setup_5_Applications childJob_tRunJob_5 = new ads_data_no_git.ads_setup_5_applications_0_1.ADS_Setup_5_Applications();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_6 = null;
		...
		ads_data_no_git.ads_setup_6_sysconfigpropertytypes_0_1.ADS_Setup_6_SysConfigPropertyTypes childJob_tRunJob_6 = new ads_data_no_git.ads_setup_6_sysconfigpropertytypes_0_1.ADS_Setup_6_SysConfigPropertyTypes();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_7 = null;
		...
		ads_data_no_git.ads_setup_7_migrationtimes_0_1.ADS_Setup_7_MigrationTimes childJob_tRunJob_7 = new ads_data_no_git.ads_setup_7_migrationtimes_0_1.ADS_Setup_7_MigrationTimes();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_8 = null;
		...
		ads_data_no_git.ads_setup_8_mstemailtype_0_1.ADS_Setup_8_MstEmailType childJob_tRunJob_8 = new ads_data_no_git.ads_setup_8_mstemailtype_0_1.ADS_Setup_8_MstEmailType();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_9 = null;
		...
		obj_tRunJob_9 = context.ENV_CONTEXT_FILE;
		paraList_tRunJob_9.add("--context_param ENV_CONTEXT_FILE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_9));
		
		parentContextMap_tRunJob_9.put("ENV_CONTEXT_FILE", obj_tRunJob_9);
	
	
		ads_data_no_git.ads_setup_9_schedules_0_1.ADS_Setup_9_Schedules childJob_tRunJob_9 = new ads_data_no_git.ads_setup_9_schedules_0_1.ADS_Setup_9_Schedules();
	    // pass DataSources
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_ADS_DATA_NO_GIT_ADS_Setup_Master = new byte[0];
    static byte[] commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_Master = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_Master.length) {
				if(length < 1024 && commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_Master.length == 0) {
   					commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_Master = new byte[1024];
				} else {
   					commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_Master = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_Master, 0, length);
			strReturn = new String(commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_Master, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADS_DATA_NO_GIT_ADS_Setup_Master) {
 ...
 */
    ...
    public static void main(String[] args){
        final ADS_Setup_Master ADS_Setup_MasterClass = new ADS_Setup_Master();

        int exitCode = ADS_Setup_MasterClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ADS_Setup_Master.class.getClassLoader().getResourceAsStream("ads_data_no_git/ads_setup_master_0_1/contexts/"+contextStr+".properties");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ADS_Setup_Master");
        }
...
/************************************************************************************************
 *     141885 characters generated by Talend Open Studio for Data Integration 
 *     on the March 23, 2018 12:42:56 PM EDT
 ************************************************************************************************/