...
package ads_data_no_git.ads_setup_5_applications_0_1;
...
/**
 * Job: ADS_Setup_5_Applications Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.0.20170510_1410
 * @status 
 */
public class ADS_Setup_5_Applications implements TalendJob {
...
public String getDwh_inventory_AdditionalParams(){
	...
	private final String jobName = "ADS_Setup_5_Applications";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ADS_Setup_5_Applications.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ADS_Setup_5_Applications.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_ADS_DATA_NO_GIT_ADS_Setup_5_Applications = new byte[0];
    static byte[] commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_5_Applications = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_5_Applications.length) {
				if(length < 1024 && commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_5_Applications.length == 0) {
   					commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_5_Applications = new byte[1024];
				} else {
   					commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_5_Applications = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_5_Applications, 0, length);
			strReturn = new String(commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_5_Applications, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADS_DATA_NO_GIT_ADS_Setup_5_Applications) {
			...
			for (String[] item_tRunJob_3 : childReturn_tRunJob_3) { 
				if(childJob_tRunJob_3.hastBufferOutputComponent() || true){
						...
						if(0 < item_tRunJob_3.length){				
				           		...
				           		row2.resourceId = item_tRunJob_3[0];
			           		
		           		}else{
			           		row2.resourceId = null;
		           		}
 ...
 */
    ...
    globalMap.put("jobId", row2.resourceId);
...
globalMap.put("userCorporateLookupFile", context.ADS_LOG_DIRECTORY+jobName+"_userCorporateLookup.xlsx");
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		obj_tRunJob_4 = "/root/_embedded/userCorporates";
		paraList_tRunJob_4.add("--context_param REST_RESPONSE_XPATH=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_4));
		
		parentContextMap_tRunJob_4.put("REST_RESPONSE_XPATH", obj_tRunJob_4);
	
		obj_tRunJob_4 = "./userName";
		paraList_tRunJob_4.add("--context_param REST_RESPONSE_XPATH_NAME=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_4));
		
		parentContextMap_tRunJob_4.put("REST_RESPONSE_XPATH_NAME", obj_tRunJob_4);
	
		obj_tRunJob_4 = "./_links/self/href";
		paraList_tRunJob_4.add("--context_param REST_RESPONSE_XPATH_VALUE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_4));
		
		parentContextMap_tRunJob_4.put("REST_RESPONSE_XPATH_VALUE", obj_tRunJob_4);
	
		obj_tRunJob_4 = ((String)globalMap.get("userCorporateLookupFile"));
		paraList_tRunJob_4.add("--context_param REST_RESPONSE_RESULT_FILE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_4));
		
		parentContextMap_tRunJob_4.put("REST_RESPONSE_RESULT_FILE", obj_tRunJob_4);
	
		obj_tRunJob_4 = ADSStringUtils.getEndPointURL(context.REST_URL_BASE,context.REST_URL_USER_CORPORATE);;
		paraList_tRunJob_4.add("--context_param REST_URL_NAME_VALUE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_4));
		
		parentContextMap_tRunJob_4.put("REST_URL_NAME_VALUE", obj_tRunJob_4);
		...
		ads_data_no_git.getadslookupdata_nameid_0_1.GetADSLookupData_NameId childJob_tRunJob_4 = new ads_data_no_git.getadslookupdata_nameid_0_1.GetADSLookupData_NameId();
	    // pass DataSources
...
public static class FormattedRowStruct implements routines.system.IPersistableRow<FormattedRowStruct> {
    ...
    static byte[] commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_5_Applications = new byte[0];
			    ...
			    public String ownerUserCorporateId;

				public String getOwnerUserCorporateId () {
		...
		synchronized(commonByteArrayLock_ADS_DATA_NO_GIT_ADS_Setup_5_Applications) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.applicationCode = readString(dis);
					
					this.applicationName = readString(dis);
					
					this.archtype = readString(dis);
					
					this.informationOwner = readString(dis);
					
					this.ownerUserCorporateId = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.applicationCode,dos);
					
					// String
				
						writeString(this.applicationName,dos);
					
					// String
				
						writeString(this.archtype,dos);
					
					// String
				
						writeString(this.informationOwner,dos);
					
					// String
				
						writeString(this.ownerUserCorporateId,dos);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("applicationCode="+applicationCode);
		sb.append(",applicationName="+applicationName);
		sb.append(",archtype="+archtype);
		sb.append(",informationOwner="+informationOwner);
		sb.append(",ownerUserCorporateId="+ownerUserCorporateId);
	    sb.append("]");
...
public static class DataRowStruct implements routines.system.IPersistableRow<DataRowStruct> {
    ...
    static byte[] commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_5_Applications = new byte[0];
			    ...
			    public String userCorporates;

				public String getUserCorporates () {
		...
		synchronized(commonByteArrayLock_ADS_DATA_NO_GIT_ADS_Setup_5_Applications) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.userCorporates = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.userCorporates,dos);
    ...
    public String toString() {
		...
		sb.append(",applicationName="+applicationName);
		sb.append(",archtype="+archtype);
		sb.append(",userCorporates="+userCorporates);
		sb.append(",informationOwner="+informationOwner);
	    sb.append("]");
                    ...
                    if(directory_tFileOutputDelimited_1 != null && directory_tFileOutputDelimited_1.trim().length() != 0) {
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_1, true),"ISO-8859-15"));
                                    if(filetFileOutputDelimited_1.length()==0){
                                        outtFileOutputDelimited_1.write("applicationCode");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("applicationName");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("archtype");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("informationOwner");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("ownerUserCorporateId");
 ...
 */
	...
	currentComponent="tFileInputExcel_1";
		...
		Object source_tFileInputExcel_1 = context.LOAD_FILES_LOC+"/"+context.ADS_SETUP_LOADSHEET_APPLICATION_XLSX;
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				curColName_tFileInputExcel_1 = "applicationCode";

				DataRow.applicationCode = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				DataRow.applicationCode = null;
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "applicationName";

				DataRow.applicationName = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				DataRow.applicationName = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "archtype";

				DataRow.archtype = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				DataRow.archtype = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "userCorporates";

				DataRow.userCorporates = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				DataRow.userCorporates = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "informationOwner";

				DataRow.informationOwner = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				DataRow.informationOwner = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
 					    ...
 					    boolean forceLooprow1 = false;
 							...
 							row1Struct row1ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_3 = false;
                        		    		...
                        		    		row1HashKey.Name = DataRow.userCorporates ;
...
FormattedRow_tmp.applicationCode = DataRow.applicationCode ;
FormattedRow_tmp.applicationName = DataRow.applicationName ;
FormattedRow_tmp.archtype = DataRow.archtype ;
FormattedRow_tmp.informationOwner = DataRow.informationOwner ;
FormattedRow_tmp.ownerUserCorporateId = row1.Value ;
FormattedRow = FormattedRow_tmp;

// # Output table : 'WriteToSrcData'
WriteToSrcData_tmp.applicationCode = DataRow.applicationCode ;
WriteToSrcData_tmp.applicationName = DataRow.applicationName ;
WriteToSrcData_tmp.archtype = DataRow.archtype ;
WriteToSrcData_tmp.informationOwner = DataRow.informationOwner ;
WriteToSrcData_tmp.ownerUserCorporateId = row1.Value  ;
...
if(FormattedRow != null) { 
	...
	valueMap_tWriteJSONField_2_Out.put("applicationCode",
	(
		FormattedRow.applicationCode != null?
            FormattedRow.applicationCode.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("applicationName",
	(
		FormattedRow.applicationName != null?
            FormattedRow.applicationName.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("archtype",
	(
		FormattedRow.archtype != null?
            FormattedRow.archtype.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("informationOwner",
	(
		FormattedRow.informationOwner != null?
            FormattedRow.informationOwner.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("ownerUserCorporateId",
	(
		FormattedRow.ownerUserCorporateId != null?
            FormattedRow.ownerUserCorporateId.toString():null
		));
	...
	if (needRoot_tWriteJSONField_2_Out) {
		...
		org.dom4j.Element root_0_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("applicationName");
		if(
		valueMap_tWriteJSONField_2_Out.get("applicationName")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_0_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("applicationName"));
		}
		org.dom4j.Element root_1_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("archtype");
		if(
		valueMap_tWriteJSONField_2_Out.get("archtype")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_1_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("archtype"));
		}
		org.dom4j.Element root_2_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("informationOwner");
		if(
		valueMap_tWriteJSONField_2_Out.get("informationOwner")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_2_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("informationOwner"));
		}
		org.dom4j.Element root_3_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("ownerUserCorporateId");
		if(
		valueMap_tWriteJSONField_2_Out.get("ownerUserCorporateId")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_3_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("ownerUserCorporateId"));
		}
	...
	// build loop xml tree
		org.dom4j.Element loop_tWriteJSONField_2_Out = org.dom4j.DocumentHelper.createElement("applicationCode");
		...
		if(
		valueMap_tWriteJSONField_2_Out.get("applicationCode")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(loop_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("applicationCode"));
		}
			...
			//WriteToSrcData
				...
				if(execStat){
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                            if(WriteToSrcData.applicationCode != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcData.applicationCode
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcData.applicationName != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcData.applicationName
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcData.archtype != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcData.archtype
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcData.informationOwner != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcData.informationOwner
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcData.ownerUserCorporateId != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcData.ownerUserCorporateId
                        );
                            }
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row1";
        ...
        new BytesLimit65535_tAdvancedHash_row1().limitLog4jByte();
			   		...
			   		// source node:tFileInputExcel_2 - inputs:(after_tFileInputExcel_1) outputs:(row1,row1) | target node:tAdvancedHash_row1 - inputs:(row1) outputs:()
			   		// linked node: tMap_3 - inputs:(DataRow,row1) outputs:(FormattedRow,WriteToSrcData)
 ...
 */
	...
	currentComponent="tFileInputExcel_2";
		...
		Object source_tFileInputExcel_2 = ((String)globalMap.get("userCorporateLookupFile"));
	...
	if(sheetList_tFileInputExcel_2.size()>0){
        ...
        for(int i_tFileInputExcel_2 = begin_line_tFileInputExcel_2; i_tFileInputExcel_2 < end_line_tFileInputExcel_2; i_tFileInputExcel_2++){
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				...
				row1.Name = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row1.Name = null;
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				...
				row1.Value = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row1.Value = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		obj_tRunJob_2 = ADSStringUtils.getEndPointURL(context.REST_URL_BASE,context.REST_URL_APPLICATIONS);;
 ...
 */
    ...
    public static void main(String[] args){
        final ADS_Setup_5_Applications ADS_Setup_5_ApplicationsClass = new ADS_Setup_5_Applications();

        int exitCode = ADS_Setup_5_ApplicationsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ADS_Setup_5_Applications.class.getClassLoader().getResourceAsStream("ads_data_no_git/ads_setup_5_applications_0_1/contexts/"+contextStr+".properties");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ADS_Setup_5_Applications");
        }
...
/************************************************************************************************
 *     235322 characters generated by Talend Open Studio for Data Integration 
 *     on the March 23, 2018 12:42:53 PM EDT
 ************************************************************************************************/