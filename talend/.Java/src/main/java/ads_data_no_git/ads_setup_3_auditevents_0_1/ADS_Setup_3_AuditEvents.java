...
package ads_data_no_git.ads_setup_3_auditevents_0_1;
...
/**
 * Job: ADS_Setup_3_AuditEvents Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.0.20170510_1410
 * @status 
 */
public class ADS_Setup_3_AuditEvents implements TalendJob {
...
public String getDwh_inventory_AdditionalParams(){
	...
	private final String jobName = "ADS_Setup_3_AuditEvents";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ADS_Setup_3_AuditEvents.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ADS_Setup_3_AuditEvents.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_ADS_DATA_NO_GIT_ADS_Setup_3_AuditEvents = new byte[0];
    static byte[] commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_3_AuditEvents = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_3_AuditEvents.length) {
				if(length < 1024 && commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_3_AuditEvents.length == 0) {
   					commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_3_AuditEvents = new byte[1024];
				} else {
   					commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_3_AuditEvents = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_3_AuditEvents, 0, length);
			strReturn = new String(commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_3_AuditEvents, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADS_DATA_NO_GIT_ADS_Setup_3_AuditEvents) {
...
public static class FormattedRowStruct implements routines.system.IPersistableRow<FormattedRowStruct> {
		...
		synchronized(commonByteArrayLock_ADS_DATA_NO_GIT_ADS_Setup_3_AuditEvents) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.eventName = readString(dis);
					
					this.httpMethod = readString(dis);
					
					this.resourcePattern = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.eventName,dos);
					
					// String
				
						writeString(this.httpMethod,dos);
					
					// String
				
						writeString(this.resourcePattern,dos);
    ...
    public String toString() {
		...
		sb.append(",resourcePattern="+resourcePattern);
	    sb.append("]");
                    ...
                    if(directory_tFileOutputDelimited_1 != null && directory_tFileOutputDelimited_1.trim().length() != 0) {
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_1, true),"ISO-8859-15"));
                                    if(filetFileOutputDelimited_1.length()==0){
                                        outtFileOutputDelimited_1.write("eventName");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("httpMethod");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("resourcePattern");
 ...
 */
	...
	currentComponent="tFileInputExcel_1";
		...
		Object source_tFileInputExcel_1 = context.LOAD_FILES_LOC+"/"+context.ADS_SETUP_LOADSHEET_AUDIT_EVENT_XLSX;
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				curColName_tFileInputExcel_1 = "eventName";

				UserNativeRow.eventName = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				UserNativeRow.eventName = null;
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "httpMethod";

				UserNativeRow.httpMethod = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				UserNativeRow.httpMethod = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "resourcePattern";

				UserNativeRow.resourcePattern = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				UserNativeRow.resourcePattern = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
...
FormattedRow_tmp.eventName = UserNativeRow.eventName ;
FormattedRow_tmp.httpMethod = UserNativeRow.httpMethod ;
FormattedRow_tmp.resourcePattern = UserNativeRow.resourcePattern ;
FormattedRow = FormattedRow_tmp;

// # Output table : 'WriteToSrcFile'
WriteToSrcFile_tmp.eventName = UserNativeRow.eventName  ;
WriteToSrcFile_tmp.httpMethod = UserNativeRow.httpMethod  ;
WriteToSrcFile_tmp.resourcePattern = UserNativeRow.resourcePattern  ;
...
if(FormattedRow != null) { 
	...
	valueMap_tWriteJSONField_2_Out.put("eventName",
	(
		FormattedRow.eventName != null?
            FormattedRow.eventName.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("httpMethod",
	(
		FormattedRow.httpMethod != null?
            FormattedRow.httpMethod.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("resourcePattern",
	(
		FormattedRow.resourcePattern != null?
            FormattedRow.resourcePattern.toString():null
		));
	...
	if (needRoot_tWriteJSONField_2_Out) {
		...
		org.dom4j.Element root_0_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("httpMethod");
		if(
		valueMap_tWriteJSONField_2_Out.get("httpMethod")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_0_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("httpMethod"));
		}
		org.dom4j.Element root_1_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("resourcePattern");
		if(
		valueMap_tWriteJSONField_2_Out.get("resourcePattern")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_1_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("resourcePattern"));
		}
	...
	// build loop xml tree
		org.dom4j.Element loop_tWriteJSONField_2_Out = org.dom4j.DocumentHelper.createElement("eventName");
		...
		if(
		valueMap_tWriteJSONField_2_Out.get("eventName")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(loop_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("eventName"));
		}
			...
			//WriteToSrcFile
				...
				if(execStat){
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                            if(WriteToSrcFile.eventName != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcFile.eventName
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcFile.httpMethod != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcFile.httpMethod
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcFile.resourcePattern != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcFile.resourcePattern
                        );
                            }
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		obj_tRunJob_2 = ADSStringUtils.getEndPointURL(context.REST_URL_BASE,context.REST_URL_AUDIT_EVENTS);;
 ...
 */
    ...
    public static void main(String[] args){
        final ADS_Setup_3_AuditEvents ADS_Setup_3_AuditEventsClass = new ADS_Setup_3_AuditEvents();

        int exitCode = ADS_Setup_3_AuditEventsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ADS_Setup_3_AuditEvents.class.getClassLoader().getResourceAsStream("ads_data_no_git/ads_setup_3_auditevents_0_1/contexts/"+contextStr+".properties");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ADS_Setup_3_AuditEvents");
        }
...
/************************************************************************************************
 *     190013 characters generated by Talend Open Studio for Data Integration 
 *     on the March 23, 2018 12:42:52 PM EDT
 ************************************************************************************************/