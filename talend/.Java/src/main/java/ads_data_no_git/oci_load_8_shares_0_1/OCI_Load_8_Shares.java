...
package ads_data_no_git.oci_load_8_shares_0_1;
...
/**
 * Job: OCI_Load_8_Shares Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.0.20170510_1410
 * @status 
 */
public class OCI_Load_8_Shares implements TalendJob {
...
public String getDwh_inventory_AdditionalParams(){
	...
	private final String jobName = "OCI_Load_8_Shares";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				OCI_Load_8_Shares.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(OCI_Load_8_Shares.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_ADS_DATA_NO_GIT_OCI_Load_8_Shares = new byte[0];
    static byte[] commonByteArray_ADS_DATA_NO_GIT_OCI_Load_8_Shares = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADS_DATA_NO_GIT_OCI_Load_8_Shares.length) {
				if(length < 1024 && commonByteArray_ADS_DATA_NO_GIT_OCI_Load_8_Shares.length == 0) {
   					commonByteArray_ADS_DATA_NO_GIT_OCI_Load_8_Shares = new byte[1024];
				} else {
   					commonByteArray_ADS_DATA_NO_GIT_OCI_Load_8_Shares = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADS_DATA_NO_GIT_OCI_Load_8_Shares, 0, length);
			strReturn = new String(commonByteArray_ADS_DATA_NO_GIT_OCI_Load_8_Shares, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADS_DATA_NO_GIT_OCI_Load_8_Shares) {
...
globalMap.put("hostsLookupFile", context.ADS_LOG_DIRECTORY+jobName+"hostsLookupFile.xlsx");
globalMap.put("qtreesLookupFile", context.ADS_LOG_DIRECTORY+jobName+"qtreesLookupFile.xlsx");
...
public static class FormattedRowStruct implements routines.system.IPersistableRow<FormattedRowStruct> {
		...
		synchronized(commonByteArrayLock_ADS_DATA_NO_GIT_OCI_Load_8_Shares) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.shareName = readString(dis);
					
					this.shareType = readString(dis);
					
					this.qtree = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.shareName,dos);
					
					// String
				
						writeString(this.shareType,dos);
					
					// String
				
						writeString(this.qtree,dos);
    ...
    public String toString() {
		...
		sb.append(",shareName="+shareName);
		sb.append(",shareType="+shareType);
		sb.append(",qtree="+qtree);
		sb.append(",host="+host);
	    sb.append("]");
...
public static class WriteToFileStruct implements routines.system.IPersistableRow<WriteToFileStruct> {
    final static byte[] commonByteArrayLock_ADS_DATA_NO_GIT_OCI_Load_8_Shares = new byte[0];
    static byte[] commonByteArray_ADS_DATA_NO_GIT_OCI_Load_8_Shares = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(WriteToFileStruct other) {
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    ...
    public String toString() {
		...
		sb.append(",qtreeId="+String.valueOf(qtreeId));
	    sb.append("]");
...
WriteToFileStruct WriteToFile = new WriteToFileStruct();
	...
	currentComponent="tFileOutputDelimited_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("WriteToFile" + iterateId, 0, 0);
            ...
            csvSettings_tFileOutputDelimited_1.setEscapeAndTextEnclosure("\"","\"");
                    ...
                    if(!csvSettings_tFileOutputDelimited_1.isUseCRLFRecordDelimiter() && csvSettings_tFileOutputDelimited_1.getRowDelim()!='\r' && csvSettings_tFileOutputDelimited_1.getRowDelim()!='\n') {
                        ...
                        if(filetFileOutputDelimited_1.length()==0){
                                    ...
                                    headColutFileOutputDelimited_1[1]="ownerUserCorporateId";
                                    headColutFileOutputDelimited_1[2]="shareName";
                                    headColutFileOutputDelimited_1[3]="shareType";
                                    headColutFileOutputDelimited_1[4]="qtree";
                                    headColutFileOutputDelimited_1[5]="host";
...
WriteToFileStruct WriteToFile_tmp = new WriteToFileStruct();
// ###############################
...
+context.TEST_ROW_COUNT_LIMIT+" ";
		...
		try{
            ...
            if(rs_tMysqlInput_1.getObject(3) != null) {
                row1.internalVolumeId = rs_tMysqlInput_1.getInt(3);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.protocol = routines.system.JDBCUtil.getString(rs_tMysqlInput_1, 4, false);
		                    }
            ...
            if(rs_tMysqlInput_1.getObject(5) != null) {
                row1.Host_ID = rs_tMysqlInput_1.getInt(5);
            } else {
                    row1.Host_ID = null;
            }
		                    }
            ...
            if(rs_tMysqlInput_1.getObject(6) != null) {
                row1.qtreeId = rs_tMysqlInput_1.getInt(6);
            } else {
                    row1.qtreeId = null;
            }
		                    }
...
Var.hostId = ADSStringUtils.getRestURLForId(context.REST_URL_BASE, ADSConstants.NODE_HOSTS,String.valueOf(row1.Host_ID)) ;
Var.qtreeId = ADSStringUtils.getRestURLForId(context.REST_URL_BASE, ADSConstants.NODE_QTREES,String.valueOf(row1.qtreeId )) ;// ###############################
        // ###############################
        // # Output tables
...
FormattedRow_tmp.ownerUserCorporateId = null;
FormattedRow_tmp.shareName = row1.name ;
FormattedRow_tmp.shareType = row1.protocol ;
FormattedRow_tmp.qtree = Var.qtreeId ;
FormattedRow_tmp.host = Var.hostId ;
FormattedRow = FormattedRow_tmp;

// # Output table : 'WriteToFile'
WriteToFile_tmp.id = row1.id ;
WriteToFile_tmp.ownerUserCorporateId = null;
WriteToFile_tmp.shareName = row1.name ;
WriteToFile_tmp.shareType = row1.protocol ;
WriteToFile_tmp.qtree = Var.qtreeId ;
WriteToFile_tmp.host = Var.hostId ;
WriteToFile = WriteToFile_tmp;
// ###############################
...
if(FormattedRow != null) { 
	...
	valueMap_tWriteJSONField_1_Out.put("ownerUserCorporateId",
	(
		FormattedRow.ownerUserCorporateId != null?
            FormattedRow.ownerUserCorporateId.toString():null
		));
	valueMap_tWriteJSONField_1_Out.put("shareName",
	(
		FormattedRow.shareName != null?
            FormattedRow.shareName.toString():null
		));
	valueMap_tWriteJSONField_1_Out.put("shareType",
	(
		FormattedRow.shareType != null?
            FormattedRow.shareType.toString():null
		));
	valueMap_tWriteJSONField_1_Out.put("qtree",
	(
		FormattedRow.qtree != null?
            FormattedRow.qtree.toString():null
		));
	valueMap_tWriteJSONField_1_Out.put("host",
	(
		FormattedRow.host != null?
            FormattedRow.host.toString():null
		));
	...
	if (needRoot_tWriteJSONField_1_Out) {
		...
		org.dom4j.Element root_0_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("ownerUserCorporateId");
		if(
		valueMap_tWriteJSONField_1_Out.get("ownerUserCorporateId")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_0_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("ownerUserCorporateId"));
		}
		org.dom4j.Element root_1_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("shareName");
		if(
		valueMap_tWriteJSONField_1_Out.get("shareName")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_1_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("shareName"));
		}
		org.dom4j.Element root_2_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("shareType");
		if(
		valueMap_tWriteJSONField_1_Out.get("shareType")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_2_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("shareType"));
		}
		org.dom4j.Element root_3_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("qtree");
		if(
		valueMap_tWriteJSONField_1_Out.get("qtree")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_3_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("qtree"));
		}
		org.dom4j.Element root_4_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("host");
		if(
		valueMap_tWriteJSONField_1_Out.get("host")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_4_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("host"));
		}
...
if(WriteToFile != null) { 
	...
	currentComponent="tFileOutputDelimited_1";
			...
			//WriteToFile
				...
				if(execStat){
					runStat.updateStatOnConnection("WriteToFile"+iterateId,1, 1);
				} 
                        ...
                        String[] rowtFileOutputDelimited_1=new String[6];
                            rowtFileOutputDelimited_1[0]=WriteToFile.id == null ? null : String.valueOf(WriteToFile.id);
                            rowtFileOutputDelimited_1[1]=WriteToFile.ownerUserCorporateId == null ? null : WriteToFile.ownerUserCorporateId;
                            rowtFileOutputDelimited_1[2]=WriteToFile.shareName == null ? null : WriteToFile.shareName;
                            rowtFileOutputDelimited_1[3]=WriteToFile.shareType == null ? null : WriteToFile.shareType;
                            rowtFileOutputDelimited_1[4]=WriteToFile.qtree == null ? null : WriteToFile.qtree;
                            rowtFileOutputDelimited_1[5]=WriteToFile.host == null ? null : WriteToFile.host;
 ...
 */
	...
	currentComponent="tFileOutputDelimited_1";
		...
		resourceMap.put("finish_tFileOutputDelimited_1", true);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("WriteToFile"+iterateId,2, 0); 
			 	}
			}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = ADSStringUtils.getEndPointURL(context.REST_URL_BASE,context.REST_URL_SHARES);;
 ...
 */
    ...
    public static void main(String[] args){
        final OCI_Load_8_Shares OCI_Load_8_SharesClass = new OCI_Load_8_Shares();

        int exitCode = OCI_Load_8_SharesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = OCI_Load_8_Shares.class.getClassLoader().getResourceAsStream("ads_data_no_git/oci_load_8_shares_0_1/contexts/"+contextStr+".properties");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : OCI_Load_8_Shares");
        }
...
/************************************************************************************************
 *     191783 characters generated by Talend Open Studio for Data Integration 
