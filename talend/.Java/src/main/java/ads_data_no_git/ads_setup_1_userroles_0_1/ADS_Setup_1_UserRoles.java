...
package ads_data_no_git.ads_setup_1_userroles_0_1;
...
/**
 * Job: ADS_Setup_1_UserRoles Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.0.20170510_1410
 * @status 
 */
public class ADS_Setup_1_UserRoles implements TalendJob {
...
public String getDwh_inventory_AdditionalParams(){
	...
	private final String jobName = "ADS_Setup_1_UserRoles";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ADS_Setup_1_UserRoles.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ADS_Setup_1_UserRoles.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_ADS_DATA_NO_GIT_ADS_Setup_1_UserRoles = new byte[0];
    static byte[] commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_1_UserRoles = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_1_UserRoles.length) {
				if(length < 1024 && commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_1_UserRoles.length == 0) {
   					commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_1_UserRoles = new byte[1024];
				} else {
   					commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_1_UserRoles = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_1_UserRoles, 0, length);
			strReturn = new String(commonByteArray_ADS_DATA_NO_GIT_ADS_Setup_1_UserRoles, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADS_DATA_NO_GIT_ADS_Setup_1_UserRoles) {
			...
			for (String[] item_tRunJob_4 : childReturn_tRunJob_4) { 
				if(childJob_tRunJob_4.hastBufferOutputComponent() || true){
						...
						if(0 < item_tRunJob_4.length){				
				           		...
				           		row2.resourceId = item_tRunJob_4[0];
 ...
 */
	...
	currentComponent="tFileInputExcel_1";
		...
		Object source_tFileInputExcel_1 = context.LOAD_FILES_LOC+"/"+context.ADS_SETUP_LOADSHEET_USER_ROLES_XLSX;
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				curColName_tFileInputExcel_1 = "userRole";

				DataRow.userRole = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				DataRow.userRole = null;
...
FormattedRow_tmp.userRole = DataRow.userRole ;
FormattedRow = FormattedRow_tmp;

// # Output table : 'WriteToSrcFile'
WriteToSrcFile_tmp.userRole = DataRow.userRole  ;
...
if(FormattedRow != null) { 
	...
	// build loop xml tree
		org.dom4j.Element loop_tWriteJSONField_2_Out = org.dom4j.DocumentHelper.createElement("userRole");
			...
			//WriteToSrcFile
				...
				if(execStat){
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                            if(WriteToSrcFile.userRole != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcFile.userRole
                        );
                            }
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		obj_tRunJob_2 = ADSStringUtils.getEndPointURL(context.REST_URL_BASE,context.REST_URL_USER_ROLES);;
 ...
 */
    ...
    public static void main(String[] args){
        final ADS_Setup_1_UserRoles ADS_Setup_1_UserRolesClass = new ADS_Setup_1_UserRoles();

        int exitCode = ADS_Setup_1_UserRolesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ADS_Setup_1_UserRoles.class.getClassLoader().getResourceAsStream("ads_data_no_git/ads_setup_1_userroles_0_1/contexts/"+contextStr+".properties");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ADS_Setup_1_UserRoles");
        }
...
/************************************************************************************************
 *     184668 characters generated by Talend Open Studio for Data Integration 
 *     on the March 23, 2018 12:42:50 PM EDT
 ************************************************************************************************/