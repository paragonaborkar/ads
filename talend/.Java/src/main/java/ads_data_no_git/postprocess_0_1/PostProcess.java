...
package ads_data_no_git.postprocess_0_1;
...
/**
 * Job: PostProcess Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.0.20170510_1410
 * @status 
 */
public class PostProcess implements TalendJob {
...
public String getREST_URL_BASE(){
	...
	private final String jobName = "PostProcess";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(PostProcess.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		ads_data_no_git.adsload_subjob_sendemail_0_1.ADSLoad_SubJob_SendEmail childJob_tRunJob_1 = new ads_data_no_git.adsload_subjob_sendemail_0_1.ADSLoad_SubJob_SendEmail();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final PostProcess PostProcessClass = new PostProcess();

        int exitCode = PostProcessClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = PostProcess.class.getClassLoader().getResourceAsStream("ads_data_no_git/postprocess_0_1/contexts/"+contextStr+".properties");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : PostProcess");
        }
...
/************************************************************************************************
 *     46254 characters generated by Talend Open Studio for Data Integration 
 *     on the March 23, 2018 12:49:49 PM EDT
 ************************************************************************************************/