...
package ads_data_no_git.oci_load_7_qtrees_0_1;
...
/**
 * Job: OCI_Load_7_QTrees Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 6.4.0.20170510_1410
 * @status 
 */
public class OCI_Load_7_QTrees implements TalendJob {
...
public String getDwh_inventory_AdditionalParams(){
	...
	private final String jobName = "OCI_Load_7_QTrees";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				OCI_Load_7_QTrees.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(OCI_Load_7_QTrees.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_ADS_DATA_NO_GIT_OCI_Load_7_QTrees = new byte[0];
    static byte[] commonByteArray_ADS_DATA_NO_GIT_OCI_Load_7_QTrees = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADS_DATA_NO_GIT_OCI_Load_7_QTrees.length) {
				if(length < 1024 && commonByteArray_ADS_DATA_NO_GIT_OCI_Load_7_QTrees.length == 0) {
   					commonByteArray_ADS_DATA_NO_GIT_OCI_Load_7_QTrees = new byte[1024];
				} else {
   					commonByteArray_ADS_DATA_NO_GIT_OCI_Load_7_QTrees = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADS_DATA_NO_GIT_OCI_Load_7_QTrees, 0, length);
			strReturn = new String(commonByteArray_ADS_DATA_NO_GIT_OCI_Load_7_QTrees, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADS_DATA_NO_GIT_OCI_Load_7_QTrees) {
...
public static class formattedOutputStruct implements routines.system.IPersistableRow<formattedOutputStruct> {
    final static byte[] commonByteArrayLock_ADS_DATA_NO_GIT_OCI_Load_7_QTrees = new byte[0];
    static byte[] commonByteArray_ADS_DATA_NO_GIT_OCI_Load_7_QTrees = new byte[0];
			    ...
			    public String nasVolume;

				public String getNasVolume () {
		...
		synchronized(commonByteArrayLock_ADS_DATA_NO_GIT_OCI_Load_7_QTrees) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.qtreeName = readString(dis);
					
					this.qtreeStatus = readString(dis);
					
					this.qtreeType = readString(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.quotaHardCapacityLimitMb = null;
           				} else {
           			    	this.quotaHardCapacityLimitMb = dis.readLong();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.quotaSoftCapacityLimitMb = null;
           				} else {
           			    	this.quotaSoftCapacityLimitMb = dis.readLong();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.quotaUsedCapacityLimitMb = null;
           				} else {
           			    	this.quotaUsedCapacityLimitMb = dis.readLong();
           				}
					
					this.securityStyle = readString(dis);
					
					this.nasVolume = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.qtreeName,dos);
					
					// String
				
						writeString(this.qtreeStatus,dos);
					
					// String
				
						writeString(this.qtreeType,dos);
					
					// Long
				
						if(this.quotaHardCapacityLimitMb == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.quotaHardCapacityLimitMb);
		            	}
					
					// Long
				
						if(this.quotaSoftCapacityLimitMb == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.quotaSoftCapacityLimitMb);
		            	}
					
					// Long
				
						if(this.quotaUsedCapacityLimitMb == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.quotaUsedCapacityLimitMb);
		            	}
					
					// String
				
						writeString(this.securityStyle,dos);
					
					// String
				
						writeString(this.nasVolume,dos);
    ...
    public String toString() {
		...
		sb.append(",qtreeName="+qtreeName);
		sb.append(",qtreeStatus="+qtreeStatus);
		sb.append(",qtreeType="+qtreeType);
		sb.append(",quotaHardCapacityLimitMb="+String.valueOf(quotaHardCapacityLimitMb));
		sb.append(",quotaSoftCapacityLimitMb="+String.valueOf(quotaSoftCapacityLimitMb));
		sb.append(",quotaUsedCapacityLimitMb="+String.valueOf(quotaUsedCapacityLimitMb));
		sb.append(",securityStyle="+securityStyle);
		sb.append(",nasVolume="+nasVolume);
	    sb.append("]");
     ...
     * Compare keys
     */
    public int compareTo(formattedOutputStruct other) {
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    ...
    static byte[] commonByteArray_ADS_DATA_NO_GIT_OCI_Load_7_QTrees = new byte[0];
			    ...
			    public int internalVolumeId;

				public int getInternalVolumeId () {
					return this.internalVolumeId;
				}
			    ...
			    public Long quotaUsedCapacityMB;

				public Long getQuotaUsedCapacityMB () {
					return this.quotaUsedCapacityMB;
				}
		...
		synchronized(commonByteArrayLock_ADS_DATA_NO_GIT_OCI_Load_7_QTrees) {
        	...
        	try {
        		...
        		int length = 0;
			        ...
			        this.internalVolumeId = dis.readInt();
					...
					this.name = readString(dis);
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.quotaUsedCapacityMB = null;
           				} else {
           			    	this.quotaUsedCapacityMB = dis.readLong();
           				}
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// int
		            	...
		            	dos.writeInt(this.internalVolumeId);
					...
					// Long
						...
						if(this.quotaUsedCapacityMB == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.quotaUsedCapacityMB);
		            	}
    ...
    public String toString() {
		...
		sb.append("[");
		sb.append("id="+String.valueOf(id));
		sb.append(",internalVolumeId="+String.valueOf(internalVolumeId));
		sb.append(",name="+name);
		sb.append(",quotaHardCapacityLimitMB="+String.valueOf(quotaHardCapacityLimitMB));
		sb.append(",quotaSoftCapacityLimitMB="+String.valueOf(quotaSoftCapacityLimitMB));
		sb.append(",quotaUsedCapacityMB="+String.valueOf(quotaUsedCapacityMB));
		sb.append(",type="+type);
		sb.append(",securityStyle="+securityStyle);
...
formattedOutputStruct formattedOutput = new formattedOutputStruct();
	...
	currentComponent="tWriteJSONField_1_Out";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("formattedOutput" + iterateId, 0, 0);
...
formattedOutputStruct  rowStructOutput_tWriteJSONField_1_Out = new formattedOutputStruct();
                    ...
                    if(directory_tFileOutputDelimited_1 != null && directory_tFileOutputDelimited_1.trim().length() != 0) {
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_1, true),"US-ASCII"));
                                    if(filetFileOutputDelimited_1.length()==0){
                                        ...
                                        outtFileOutputDelimited_1.write("qtreeName");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("qtreeStatus");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("qtreeType");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("quotaHardCapacityLimitMb");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("quotaSoftCapacityLimitMb");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("quotaUsedCapacityLimitMb");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("securityStyle");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("nasVolume");
...
formattedOutputStruct formattedOutput_tmp = new formattedOutputStruct();
...
+context.TEST_ROW_COUNT_LIMIT+" ";
		...
		try{
                ...
                row1.id = rs_tMysqlInput_1.getInt(1);
                    ...
                    throw new RuntimeException("Null value in non-Nullable column");
							...
							if(colQtyInRs_tMysqlInput_1 < 2) {
								row1.internalVolumeId = 0;
							} else {
		                          
            if(rs_tMysqlInput_1.getObject(2) != null) {
                row1.internalVolumeId = rs_tMysqlInput_1.getInt(2);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.name = routines.system.JDBCUtil.getString(rs_tMysqlInput_1, 3, false);
		                    }
							if(colQtyInRs_tMysqlInput_1 < 4) {
								row1.quotaHardCapacityLimitMB = null;
							} else {
		                          
            if(rs_tMysqlInput_1.getObject(4) != null) {
                row1.quotaHardCapacityLimitMB = rs_tMysqlInput_1.getLong(4);
            } else {
                    row1.quotaHardCapacityLimitMB = null;
            }
		                    }
							if(colQtyInRs_tMysqlInput_1 < 5) {
								row1.quotaSoftCapacityLimitMB = null;
							} else {
		                          
            if(rs_tMysqlInput_1.getObject(5) != null) {
                row1.quotaSoftCapacityLimitMB = rs_tMysqlInput_1.getLong(5);
            } else {
                    row1.quotaSoftCapacityLimitMB = null;
            }
		                    }
							if(colQtyInRs_tMysqlInput_1 < 6) {
								row1.quotaUsedCapacityMB = null;
							} else {
		                          
            if(rs_tMysqlInput_1.getObject(6) != null) {
                row1.quotaUsedCapacityMB = rs_tMysqlInput_1.getLong(6);
            } else {
                    row1.quotaUsedCapacityMB = null;
            }
		                    }
        	...
        	row1.type = routines.system.JDBCUtil.getString(rs_tMysqlInput_1, 7, false);
		                    }
							if(colQtyInRs_tMysqlInput_1 < 8) {
								row1.securityStyle = null;
							} else {
	                         		
        	row1.securityStyle = routines.system.JDBCUtil.getString(rs_tMysqlInput_1, 8, false);
		                    }
							if(colQtyInRs_tMysqlInput_1 < 9) {
								row1.status = null;
							} else {
	                         		
        	row1.status = routines.system.JDBCUtil.getString(rs_tMysqlInput_1, 9, false);
		                    }
...
Var.var1 = ADSStringUtils.getRestURLForId(context.REST_URL_BASE, ADSConstants.NODE_NASVOLUMES,String.valueOf(row1.internalVolumeId)) ;// ###############################
        // ###############################
        // # Output tables
...
// # Output table : 'formattedOutput'
formattedOutput_tmp.id = row1.id ;
formattedOutput_tmp.qtreeName = row1.name ;
formattedOutput_tmp.qtreeStatus = row1.status ;
formattedOutput_tmp.qtreeType = row1.type ;
formattedOutput_tmp.quotaHardCapacityLimitMb = row1.quotaHardCapacityLimitMB ;
formattedOutput_tmp.quotaSoftCapacityLimitMb = row1.quotaSoftCapacityLimitMB ;
formattedOutput_tmp.quotaUsedCapacityLimitMb = row1.quotaUsedCapacityMB ;
formattedOutput_tmp.securityStyle = row1.securityStyle ;
formattedOutput_tmp.nasVolume = Var.var1 ;
formattedOutput = formattedOutput_tmp;

// # Output table : 'WriteToSrcData'
WriteToSrcData_tmp.id = row1.id ;
WriteToSrcData_tmp.qtreeName = row1.name ;
WriteToSrcData_tmp.qtreeStatus = row1.status ;
WriteToSrcData_tmp.qtreeType = row1.type ;
WriteToSrcData_tmp.quotaHardCapacityLimitMb = row1.quotaHardCapacityLimitMB ;
WriteToSrcData_tmp.quotaSoftCapacityLimitMb = row1.quotaSoftCapacityLimitMB ;
WriteToSrcData_tmp.quotaUsedCapacityLimitMb = row1.quotaUsedCapacityMB ;
WriteToSrcData_tmp.securityStyle = row1.securityStyle ;
WriteToSrcData_tmp.nasVolume = Var.var1 ;
 ...
 * [tMap_2 main ] stop
 */
// Start of branch "formattedOutput"
if(formattedOutput != null) { 
	...
	currentComponent="tWriteJSONField_1_Out";
			...
			//formattedOutput
				...
				if(execStat){
					runStat.updateStatOnConnection("formattedOutput"+iterateId,1, 1);
				} 
	...
	(
		formattedOutput.id != null?
            formattedOutput.id.toString():null
		));
	valueMap_tWriteJSONField_1_Out.put("qtreeName",
	(
		formattedOutput.qtreeName != null?
            formattedOutput.qtreeName.toString():null
		));
	valueMap_tWriteJSONField_1_Out.put("qtreeStatus",
	(
		formattedOutput.qtreeStatus != null?
            formattedOutput.qtreeStatus.toString():null
		));
	valueMap_tWriteJSONField_1_Out.put("qtreeType",
	(
		formattedOutput.qtreeType != null?
            formattedOutput.qtreeType.toString():null
		));
	valueMap_tWriteJSONField_1_Out.put("quotaHardCapacityLimitMb",
	(
		formattedOutput.quotaHardCapacityLimitMb != null?
            formattedOutput.quotaHardCapacityLimitMb.toString():null
		));
	valueMap_tWriteJSONField_1_Out.put("quotaSoftCapacityLimitMb",
	(
		formattedOutput.quotaSoftCapacityLimitMb != null?
            formattedOutput.quotaSoftCapacityLimitMb.toString():null
		));
	valueMap_tWriteJSONField_1_Out.put("quotaUsedCapacityLimitMb",
	(
		formattedOutput.quotaUsedCapacityLimitMb != null?
            formattedOutput.quotaUsedCapacityLimitMb.toString():null
		));
	valueMap_tWriteJSONField_1_Out.put("securityStyle",
	(
		formattedOutput.securityStyle != null?
            formattedOutput.securityStyle.toString():null
		));
	valueMap_tWriteJSONField_1_Out.put("nasVolume",
	(
		formattedOutput.nasVolume != null?
            formattedOutput.nasVolume.toString():null
		));
	...
	if (needRoot_tWriteJSONField_1_Out) {
		...
		org.dom4j.Element root_0_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("qtreeName");
		if(
		valueMap_tWriteJSONField_1_Out.get("qtreeName")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_0_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("qtreeName"));
		}
		org.dom4j.Element root_1_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("qtreeStatus");
		if(
		valueMap_tWriteJSONField_1_Out.get("qtreeStatus")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_1_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("qtreeStatus"));
		}
		org.dom4j.Element root_2_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("qtreeType");
		if(
		valueMap_tWriteJSONField_1_Out.get("qtreeType")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_2_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("qtreeType"));
		}
		org.dom4j.Element root_3_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("quotaHardCapacityLimitMb");
		if(
		valueMap_tWriteJSONField_1_Out.get("quotaHardCapacityLimitMb")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_3_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("quotaHardCapacityLimitMb"));
		}
		org.dom4j.Element root_4_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("quotaSoftCapacityLimitMb");
		if(
		valueMap_tWriteJSONField_1_Out.get("quotaSoftCapacityLimitMb")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_4_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("quotaSoftCapacityLimitMb"));
		}
		org.dom4j.Element root_5_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("quotaUsedCapacityLimitMb");
		if(
		valueMap_tWriteJSONField_1_Out.get("quotaUsedCapacityLimitMb")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_5_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("quotaUsedCapacityLimitMb"));
		}
		org.dom4j.Element root_6_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("securityStyle");
		if(
		valueMap_tWriteJSONField_1_Out.get("securityStyle")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_6_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("securityStyle"));
		}
		org.dom4j.Element root_7_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("nasVolume");
		if(
		valueMap_tWriteJSONField_1_Out.get("nasVolume")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_7_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("nasVolume"));
		}
				...
				if(execStat){
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_1.append(
                            ...
                            if(WriteToSrcData.qtreeName != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcData.qtreeName
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcData.qtreeStatus != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcData.qtreeStatus
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcData.qtreeType != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcData.qtreeType
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcData.quotaHardCapacityLimitMb != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcData.quotaHardCapacityLimitMb
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcData.quotaSoftCapacityLimitMb != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcData.quotaSoftCapacityLimitMb
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcData.quotaUsedCapacityLimitMb != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcData.quotaUsedCapacityLimitMb
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcData.securityStyle != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcData.securityStyle
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcData.nasVolume != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcData.nasVolume
                        );
                            }
...
resourceMap.put("finish_tWriteJSONField_1_Out", true);
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("formattedOutput"+iterateId,2, 0); 
			 	}
			}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = ADSStringUtils.getEndPointURL(context.REST_URL_BASE,context.REST_URL_QTREES);;
 ...
 */
    ...
    public static void main(String[] args){
        final OCI_Load_7_QTrees OCI_Load_7_QTreesClass = new OCI_Load_7_QTrees();

        int exitCode = OCI_Load_7_QTreesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = OCI_Load_7_QTrees.class.getClassLoader().getResourceAsStream("ads_data_no_git/oci_load_7_qtrees_0_1/contexts/"+contextStr+".properties");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : OCI_Load_7_QTrees");
        }
...
/************************************************************************************************
 *     199462 characters generated by Talend Open Studio for Data Integration 
 *     on the March 23, 2018 12:49:55 PM EDT
 ************************************************************************************************/