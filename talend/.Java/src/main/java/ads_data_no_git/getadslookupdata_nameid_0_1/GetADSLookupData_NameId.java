...
package ads_data_no_git.getadslookupdata_nameid_0_1;
...
/**
 * Job: GetADSLookupData_NameId Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.0.20170510_1410
 * @status 
 */
public class GetADSLookupData_NameId implements TalendJob {
...
public String getOAUTH_BEARER_TOKEN(){
	...
	private final String jobName = "GetADSLookupData_NameId";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				GetADSLookupData_NameId.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(GetADSLookupData_NameId.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class outStruct implements routines.system.IPersistableRow<outStruct> {
    final static byte[] commonByteArrayLock_ADS_DATA_NO_GIT_GetADSLookupData_NameId = new byte[0];
    static byte[] commonByteArray_ADS_DATA_NO_GIT_GetADSLookupData_NameId = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADS_DATA_NO_GIT_GetADSLookupData_NameId.length) {
				if(length < 1024 && commonByteArray_ADS_DATA_NO_GIT_GetADSLookupData_NameId.length == 0) {
   					commonByteArray_ADS_DATA_NO_GIT_GetADSLookupData_NameId = new byte[1024];
				} else {
   					commonByteArray_ADS_DATA_NO_GIT_GetADSLookupData_NameId = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADS_DATA_NO_GIT_GetADSLookupData_NameId, 0, length);
			strReturn = new String(commonByteArray_ADS_DATA_NO_GIT_GetADSLookupData_NameId, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADS_DATA_NO_GIT_GetADSLookupData_NameId) {
    ...
    for(int i_tExtractXMLField_1=0; isStructError_tExtractXMLField_1 || (nodeList_tExtractXMLField_1!=null && i_tExtractXMLField_1 < nodeList_tExtractXMLField_1.size());i_tExtractXMLField_1++){
    	...
    	if(!isStructError_tExtractXMLField_1){
			...
			try{
				...
				org.dom4j.XPath xTmp1_tExtractXMLField_1 = temp_tExtractXMLField_1.createXPath(nsTool_tExtractXMLField_1.addDefaultNSPrefix(context.REST_RESPONSE_XPATH_VALUE+"/text()",loopQuery_tExtractXMLField_1));
 ...
 */
    ...
    public static void main(String[] args){
        final GetADSLookupData_NameId GetADSLookupData_NameIdClass = new GetADSLookupData_NameId();

        int exitCode = GetADSLookupData_NameIdClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = GetADSLookupData_NameId.class.getClassLoader().getResourceAsStream("ads_data_no_git/getadslookupdata_nameid_0_1/contexts/"+contextStr+".properties");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : GetADSLookupData_NameId");
        }
...
/************************************************************************************************
 *     84575 characters generated by Talend Open Studio for Data Integration 
 *     on the March 23, 2018 12:44:44 PM EDT
 ************************************************************************************************/