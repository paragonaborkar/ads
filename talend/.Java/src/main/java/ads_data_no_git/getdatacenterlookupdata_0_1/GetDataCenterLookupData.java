...
package ads_data_no_git.getdatacenterlookupdata_0_1;
...
public static class outStruct implements routines.system.IPersistableRow<outStruct> {
    final static byte[] commonByteArrayLock_ADS_DATA_NO_GIT_GetDataCenterLookupData = new byte[0];
    static byte[] commonByteArray_ADS_DATA_NO_GIT_GetDataCenterLookupData = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADS_DATA_NO_GIT_GetDataCenterLookupData.length) {
				if(length < 1024 && commonByteArray_ADS_DATA_NO_GIT_GetDataCenterLookupData.length == 0) {
   					commonByteArray_ADS_DATA_NO_GIT_GetDataCenterLookupData = new byte[1024];
				} else {
   					commonByteArray_ADS_DATA_NO_GIT_GetDataCenterLookupData = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADS_DATA_NO_GIT_GetDataCenterLookupData, 0, length);
			strReturn = new String(commonByteArray_ADS_DATA_NO_GIT_GetDataCenterLookupData, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADS_DATA_NO_GIT_GetDataCenterLookupData) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = GetDataCenterLookupData.class.getClassLoader().getResourceAsStream("ads_data_no_git/getdatacenterlookupdata_0_1/contexts/"+contextStr+".properties");
...
/************************************************************************************************
 *     87484 characters generated by Talend Open Studio for Data Integration 
