...
package ads_data_no_git.oci_load_1_hosts_0_1;
...
/**
 * Job: OCI_Load_1_Hosts Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.0.20170510_1410
 * @status 
 */
public class OCI_Load_1_Hosts implements TalendJob {
...
public String getDwh_inventory_AdditionalParams(){
	...
	private final String jobName = "OCI_Load_1_Hosts";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				OCI_Load_1_Hosts.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(OCI_Load_1_Hosts.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_ADS_DATA_NO_GIT_OCI_Load_1_Hosts = new byte[0];
    static byte[] commonByteArray_ADS_DATA_NO_GIT_OCI_Load_1_Hosts = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADS_DATA_NO_GIT_OCI_Load_1_Hosts.length) {
				if(length < 1024 && commonByteArray_ADS_DATA_NO_GIT_OCI_Load_1_Hosts.length == 0) {
   					commonByteArray_ADS_DATA_NO_GIT_OCI_Load_1_Hosts = new byte[1024];
				} else {
   					commonByteArray_ADS_DATA_NO_GIT_OCI_Load_1_Hosts = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADS_DATA_NO_GIT_OCI_Load_1_Hosts, 0, length);
			strReturn = new String(commonByteArray_ADS_DATA_NO_GIT_OCI_Load_1_Hosts, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADS_DATA_NO_GIT_OCI_Load_1_Hosts) {
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_1, true),"ISO-8859-15"));
                                    if(filetFileOutputDelimited_1.length()==0){
                                        ...
                                        outtFileOutputDelimited_1.write("name");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("ip");
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_1 = context.DWH_DATABASE_USER_PASSWORD; 
		    ...
		    String dbquery_tMysqlInput_1 = "SELECT id as Host_ID, name as Hostname, ip as IP from dwh_inventory.host"
+context.TEST_ROW_COUNT_LIMIT+" ";
		...
		try{
            ...
            if(rs_tMysqlInput_1.getObject(1) != null) {
                row1.Host_ID = rs_tMysqlInput_1.getInt(1);
            } else {
        	...
        	row1.Hostname = routines.system.JDBCUtil.getString(rs_tMysqlInput_1, 2, false);
		                    }
							if(colQtyInRs_tMysqlInput_1 < 3) {
								row1.IP = null;
							} else {
	                         		
        	row1.IP = routines.system.JDBCUtil.getString(rs_tMysqlInput_1, 3, false);
		                    }
...
// # Output table : 'main'
main_tmp.id = row1.Host_ID ;
main_tmp.name = row1.Hostname ;
main_tmp.ip = row1.IP ;
main = main_tmp;

// # Output table : 'WriteToSrcFile'
WriteToSrcFile_tmp.id = row1.Host_ID ;
WriteToSrcFile_tmp.name = row1.Hostname ;
WriteToSrcFile_tmp.ip = row1.IP ;
...
if(main != null) { 
	...
	valueMap_tWriteJSONField_1_Out.put("ip",
	(
            main.ip.toString()
		));
	...
	if (needRoot_tWriteJSONField_1_Out) {
		...
		org.dom4j.Element root_0_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("hostName");
		if(
		...
		org.dom4j.Element root_1_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out.addElement("ipAddr");
		if(
		valueMap_tWriteJSONField_1_Out.get("ip")!=null){
			nestXMLTool_tWriteJSONField_1_Out .setText(root_1_tWriteJSONField_1_Out,
		valueMap_tWriteJSONField_1_Out.get("ip"));
		}
				...
				if(execStat){
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_1.append(
                            ...
                            if(WriteToSrcFile.name != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcFile.name
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(WriteToSrcFile.ip != null) {
                        sb_tFileOutputDelimited_1.append(
                            WriteToSrcFile.ip
                        );
                            }
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = ADSStringUtils.getEndPointURL(context.REST_URL_BASE,context.REST_URL_HOSTS);;
 ...
 */
    ...
    public static void main(String[] args){
        final OCI_Load_1_Hosts OCI_Load_1_HostsClass = new OCI_Load_1_Hosts();

        int exitCode = OCI_Load_1_HostsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = OCI_Load_1_Hosts.class.getClassLoader().getResourceAsStream("ads_data_no_git/oci_load_1_hosts_0_1/contexts/"+contextStr+".properties");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : OCI_Load_1_Hosts");
        }
...
/************************************************************************************************
 *     179108 characters generated by Talend Open Studio for Data Integration 
 *     on the March 23, 2018 12:49:50 PM EDT
 ************************************************************************************************/