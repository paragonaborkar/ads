...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_ADS_Authorization = new byte[0];
    static byte[] commonByteArray_ADS_Authorization = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADS_Authorization.length) {
				if(length < 1024 && commonByteArray_ADS_Authorization.length == 0) {
   					commonByteArray_ADS_Authorization = new byte[1024];
				} else {
   					commonByteArray_ADS_Authorization = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADS_Authorization, 0, length);
			strReturn = new String(commonByteArray_ADS_Authorization, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADS_Authorization) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Authorization.class.getClassLoader().getResourceAsStream("ads/authorization_0_1/contexts/"+contextStr+".properties");
...
/************************************************************************************************
 *     49561 characters generated by Talend Open Studio for Data Integration 
 *     on the March 24, 2018 12:27:57 PM EDT
 ************************************************************************************************/