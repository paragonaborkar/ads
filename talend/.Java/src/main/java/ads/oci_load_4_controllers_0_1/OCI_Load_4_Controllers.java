...
package ads.oci_load_4_controllers_0_1;
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_ADS_OCI_Load_4_Controllers = new byte[0];
    static byte[] commonByteArray_ADS_OCI_Load_4_Controllers = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADS_OCI_Load_4_Controllers.length) {
				if(length < 1024 && commonByteArray_ADS_OCI_Load_4_Controllers.length == 0) {
   					commonByteArray_ADS_OCI_Load_4_Controllers = new byte[1024];
				} else {
   					commonByteArray_ADS_OCI_Load_4_Controllers = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADS_OCI_Load_4_Controllers, 0, length);
			strReturn = new String(commonByteArray_ADS_OCI_Load_4_Controllers, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADS_OCI_Load_4_Controllers) {
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		obj_tRunJob_4 = ADSStringUtils.getJobInstanceName((String)jobName, context.JOB_NAME);
		...
		ads.logjobdetails_0_1.logJobDetails childJob_tRunJob_4 = new ads.logjobdetails_0_1.logJobDetails();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		ads.getdatacenterlookupdata_0_1.GetDataCenterLookupData childJob_tRunJob_3 = new ads.getdatacenterlookupdata_0_1.GetDataCenterLookupData();
	    // pass DataSources
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = OCI_Load_4_Controllers.class.getClassLoader().getResourceAsStream("ads/oci_load_4_controllers_0_1/contexts/"+contextStr+".properties");
...
/************************************************************************************************
 *     238616 characters generated by Talend Open Studio for Data Integration 
