...
package ads.ads_setup_9_schedules_0_1;
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_ADS_ADS_Setup_9_Schedules = new byte[0];
    static byte[] commonByteArray_ADS_ADS_Setup_9_Schedules = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADS_ADS_Setup_9_Schedules.length) {
				if(length < 1024 && commonByteArray_ADS_ADS_Setup_9_Schedules.length == 0) {
   					commonByteArray_ADS_ADS_Setup_9_Schedules = new byte[1024];
				} else {
   					commonByteArray_ADS_ADS_Setup_9_Schedules = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADS_ADS_Setup_9_Schedules, 0, length);
			strReturn = new String(commonByteArray_ADS_ADS_Setup_9_Schedules, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADS_ADS_Setup_9_Schedules) {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		ads.postprocess_0_1.PostProcess childJob_tRunJob_1 = new ads.postprocess_0_1.PostProcess();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		ads.adsload_subjob_rest_0_1.ADSLoad_SubJob_Rest childJob_tRunJob_2 = new ads.adsload_subjob_rest_0_1.ADSLoad_SubJob_Rest();
	    // pass DataSources
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ADS_Setup_9_Schedules.class.getClassLoader().getResourceAsStream("ads/ads_setup_9_schedules_0_1/contexts/"+contextStr+".properties");
...
/************************************************************************************************
 *     208516 characters generated by Talend Open Studio for Data Integration 
 *     on the March 24, 2018 12:26:51 PM EDT
 ************************************************************************************************/