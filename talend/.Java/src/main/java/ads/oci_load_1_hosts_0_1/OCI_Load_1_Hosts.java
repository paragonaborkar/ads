...
package ads.oci_load_1_hosts_0_1;
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_ADS_OCI_Load_1_Hosts = new byte[0];
    static byte[] commonByteArray_ADS_OCI_Load_1_Hosts = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADS_OCI_Load_1_Hosts.length) {
				if(length < 1024 && commonByteArray_ADS_OCI_Load_1_Hosts.length == 0) {
   					commonByteArray_ADS_OCI_Load_1_Hosts = new byte[1024];
				} else {
   					commonByteArray_ADS_OCI_Load_1_Hosts = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADS_OCI_Load_1_Hosts, 0, length);
			strReturn = new String(commonByteArray_ADS_OCI_Load_1_Hosts, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADS_OCI_Load_1_Hosts) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = OCI_Load_1_Hosts.class.getClassLoader().getResourceAsStream("ads/oci_load_1_hosts_0_1/contexts/"+contextStr+".properties");
...
/************************************************************************************************
 *     178239 characters generated by Talend Open Studio for Data Integration 
 *     on the March 24, 2018 12:32:41 PM EDT
 ************************************************************************************************/