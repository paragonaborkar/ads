...
package ads.adsload_subjob_sendemail_0_1;
...
public static class mainStruct implements routines.system.IPersistableRow<mainStruct> {
    final static byte[] commonByteArrayLock_ADS_ADSLoad_SubJob_SendEmail = new byte[0];
    static byte[] commonByteArray_ADS_ADSLoad_SubJob_SendEmail = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADS_ADSLoad_SubJob_SendEmail.length) {
				if(length < 1024 && commonByteArray_ADS_ADSLoad_SubJob_SendEmail.length == 0) {
   					commonByteArray_ADS_ADSLoad_SubJob_SendEmail = new byte[1024];
				} else {
   					commonByteArray_ADS_ADSLoad_SubJob_SendEmail = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADS_ADSLoad_SubJob_SendEmail, 0, length);
			strReturn = new String(commonByteArray_ADS_ADSLoad_SubJob_SendEmail, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADS_ADSLoad_SubJob_SendEmail) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ADSLoad_SubJob_SendEmail.class.getClassLoader().getResourceAsStream("ads/adsload_subjob_sendemail_0_1/contexts/"+contextStr+".properties");
...
/************************************************************************************************
 *     95995 characters generated by Talend Open Studio for Data Integration 
