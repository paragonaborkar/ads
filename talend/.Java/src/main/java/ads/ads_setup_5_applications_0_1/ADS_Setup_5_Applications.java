...
package ads.ads_setup_5_applications_0_1;
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_ADS_ADS_Setup_5_Applications = new byte[0];
    static byte[] commonByteArray_ADS_ADS_Setup_5_Applications = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADS_ADS_Setup_5_Applications.length) {
				if(length < 1024 && commonByteArray_ADS_ADS_Setup_5_Applications.length == 0) {
   					commonByteArray_ADS_ADS_Setup_5_Applications = new byte[1024];
				} else {
   					commonByteArray_ADS_ADS_Setup_5_Applications = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADS_ADS_Setup_5_Applications, 0, length);
			strReturn = new String(commonByteArray_ADS_ADS_Setup_5_Applications, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADS_ADS_Setup_5_Applications) {
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		ads.getadslookupdata_nameid_0_1.GetADSLookupData_NameId childJob_tRunJob_4 = new ads.getadslookupdata_nameid_0_1.GetADSLookupData_NameId();
	    // pass DataSources
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ADS_Setup_5_Applications.class.getClassLoader().getResourceAsStream("ads/ads_setup_5_applications_0_1/contexts/"+contextStr+".properties");
...
/************************************************************************************************
 *     234214 characters generated by Talend Open Studio for Data Integration 
 *     on the March 24, 2018 12:26:49 PM EDT
 ************************************************************************************************/