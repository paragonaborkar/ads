...
package ads.getadslookupdata_nameid_0_1;
...
public static class outStruct implements routines.system.IPersistableRow<outStruct> {
    final static byte[] commonByteArrayLock_ADS_GetADSLookupData_NameId = new byte[0];
    static byte[] commonByteArray_ADS_GetADSLookupData_NameId = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADS_GetADSLookupData_NameId.length) {
				if(length < 1024 && commonByteArray_ADS_GetADSLookupData_NameId.length == 0) {
   					commonByteArray_ADS_GetADSLookupData_NameId = new byte[1024];
				} else {
   					commonByteArray_ADS_GetADSLookupData_NameId = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADS_GetADSLookupData_NameId, 0, length);
			strReturn = new String(commonByteArray_ADS_GetADSLookupData_NameId, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADS_GetADSLookupData_NameId) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = GetADSLookupData_NameId.class.getClassLoader().getResourceAsStream("ads/getadslookupdata_nameid_0_1/contexts/"+contextStr+".properties");
...
/************************************************************************************************
 *     83999 characters generated by Talend Open Studio for Data Integration 
 *     on the March 24, 2018 12:28:32 PM EDT
 ************************************************************************************************/