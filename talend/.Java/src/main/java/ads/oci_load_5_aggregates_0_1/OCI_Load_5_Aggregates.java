...
package ads.oci_load_5_aggregates_0_1;
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_ADS_OCI_Load_5_Aggregates = new byte[0];
    static byte[] commonByteArray_ADS_OCI_Load_5_Aggregates = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADS_OCI_Load_5_Aggregates.length) {
				if(length < 1024 && commonByteArray_ADS_OCI_Load_5_Aggregates.length == 0) {
   					commonByteArray_ADS_OCI_Load_5_Aggregates = new byte[1024];
				} else {
   					commonByteArray_ADS_OCI_Load_5_Aggregates = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADS_OCI_Load_5_Aggregates, 0, length);
			strReturn = new String(commonByteArray_ADS_OCI_Load_5_Aggregates, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADS_OCI_Load_5_Aggregates) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = OCI_Load_5_Aggregates.class.getClassLoader().getResourceAsStream("ads/oci_load_5_aggregates_0_1/contexts/"+contextStr+".properties");
...
/************************************************************************************************
 *     204386 characters generated by Talend Open Studio for Data Integration 
