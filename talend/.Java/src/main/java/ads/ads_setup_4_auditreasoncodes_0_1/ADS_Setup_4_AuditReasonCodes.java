...
package ads.ads_setup_4_auditreasoncodes_0_1;
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_ADS_ADS_Setup_4_AuditReasonCodes = new byte[0];
    static byte[] commonByteArray_ADS_ADS_Setup_4_AuditReasonCodes = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADS_ADS_Setup_4_AuditReasonCodes.length) {
				if(length < 1024 && commonByteArray_ADS_ADS_Setup_4_AuditReasonCodes.length == 0) {
   					commonByteArray_ADS_ADS_Setup_4_AuditReasonCodes = new byte[1024];
				} else {
   					commonByteArray_ADS_ADS_Setup_4_AuditReasonCodes = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADS_ADS_Setup_4_AuditReasonCodes, 0, length);
			strReturn = new String(commonByteArray_ADS_ADS_Setup_4_AuditReasonCodes, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADS_ADS_Setup_4_AuditReasonCodes) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ADS_Setup_4_AuditReasonCodes.class.getClassLoader().getResourceAsStream("ads/ads_setup_4_auditreasoncodes_0_1/contexts/"+contextStr+".properties");
...
/************************************************************************************************
 *     186667 characters generated by Talend Open Studio for Data Integration 
