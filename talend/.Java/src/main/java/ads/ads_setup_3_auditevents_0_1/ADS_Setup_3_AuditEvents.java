...
package ads.ads_setup_3_auditevents_0_1;
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_ADS_ADS_Setup_3_AuditEvents = new byte[0];
    static byte[] commonByteArray_ADS_ADS_Setup_3_AuditEvents = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADS_ADS_Setup_3_AuditEvents.length) {
				if(length < 1024 && commonByteArray_ADS_ADS_Setup_3_AuditEvents.length == 0) {
   					commonByteArray_ADS_ADS_Setup_3_AuditEvents = new byte[1024];
				} else {
   					commonByteArray_ADS_ADS_Setup_3_AuditEvents = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADS_ADS_Setup_3_AuditEvents, 0, length);
			strReturn = new String(commonByteArray_ADS_ADS_Setup_3_AuditEvents, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADS_ADS_Setup_3_AuditEvents) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ADS_Setup_3_AuditEvents.class.getClassLoader().getResourceAsStream("ads/ads_setup_3_auditevents_0_1/contexts/"+contextStr+".properties");
...
/************************************************************************************************
 *     189145 characters generated by Talend Open Studio for Data Integration 
 *     on the March 24, 2018 12:26:48 PM EDT
 ************************************************************************************************/