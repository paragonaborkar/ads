...
package ads.oci_load_3_datacenters_0_1;
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_ADS_OCI_Load_3_DataCenters = new byte[0];
    static byte[] commonByteArray_ADS_OCI_Load_3_DataCenters = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADS_OCI_Load_3_DataCenters.length) {
				if(length < 1024 && commonByteArray_ADS_OCI_Load_3_DataCenters.length == 0) {
   					commonByteArray_ADS_OCI_Load_3_DataCenters = new byte[1024];
				} else {
   					commonByteArray_ADS_OCI_Load_3_DataCenters = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADS_OCI_Load_3_DataCenters, 0, length);
			strReturn = new String(commonByteArray_ADS_OCI_Load_3_DataCenters, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADS_OCI_Load_3_DataCenters) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = OCI_Load_3_DataCenters.class.getClassLoader().getResourceAsStream("ads/oci_load_3_datacenters_0_1/contexts/"+contextStr+".properties");
...
/************************************************************************************************
 *     177438 characters generated by Talend Open Studio for Data Integration 
