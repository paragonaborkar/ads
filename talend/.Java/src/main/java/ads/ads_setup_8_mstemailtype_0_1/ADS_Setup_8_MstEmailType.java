...
package ads.ads_setup_8_mstemailtype_0_1;
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_ADS_ADS_Setup_8_MstEmailType = new byte[0];
    static byte[] commonByteArray_ADS_ADS_Setup_8_MstEmailType = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADS_ADS_Setup_8_MstEmailType.length) {
				if(length < 1024 && commonByteArray_ADS_ADS_Setup_8_MstEmailType.length == 0) {
   					commonByteArray_ADS_ADS_Setup_8_MstEmailType = new byte[1024];
				} else {
   					commonByteArray_ADS_ADS_Setup_8_MstEmailType = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADS_ADS_Setup_8_MstEmailType, 0, length);
			strReturn = new String(commonByteArray_ADS_ADS_Setup_8_MstEmailType, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADS_ADS_Setup_8_MstEmailType) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ADS_Setup_8_MstEmailType.class.getClassLoader().getResourceAsStream("ads/ads_setup_8_mstemailtype_0_1/contexts/"+contextStr+".properties");
...
/************************************************************************************************
 *     184073 characters generated by Talend Open Studio for Data Integration 
