...
public class TJMSOutputMainJava
{
  ...
  protected final String TEXT_46 = ".send((javax.jms.Message)";
  protected final String TEXT_47 = ".message);" + NL + "nbline_";
  protected final String TEXT_48 = "++;";
  protected final String TEXT_49 = NL + "javax.jms.ObjectMessage message_";
  protected final String TEXT_50 = " = session_";
  protected final String TEXT_51 = ".createObjectMessage();" + NL + "message_";
  protected final String TEXT_52 = ".setObject(";
  protected final String TEXT_53 = ".messageContent);";
  protected final String TEXT_54 = NL + "javax.jms.TextMessage message_";
  protected final String TEXT_55 = " = session_";
  protected final String TEXT_56 = ".createTextMessage();" + NL + "message_";
  protected final String TEXT_57 = ".setText(";
  protected final String TEXT_58 = ".messageContent);";
  protected final String TEXT_59 = NL + "producer_";
  protected final String TEXT_60 = ".send(message_";
  protected final String TEXT_61 = ");" + NL + "" + NL + "nbline_";
