...
public class TEXACommitMainJava
{
  protected static String nl;
  public static synchronized TEXACommitMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TEXACommitMainJava result = new TEXACommitMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_7 = ".commit();";
