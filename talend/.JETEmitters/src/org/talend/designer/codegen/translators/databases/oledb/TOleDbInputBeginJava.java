...
public class TOleDbInputBeginJava
{
  ...
  protected final String TEXT_45 = NL + "org.talend.net.Object conn_";
  protected final String TEXT_46 = " = org.talend.net.Object.createInstance(";
  protected final String TEXT_47 = ",";
  protected final String TEXT_48 = ", " + NL + "new java.lang.Object[] { ";
  protected final String TEXT_49 = NL;
  protected final String TEXT_50 = " " + NL + "});" + NL;
  protected final String TEXT_51 = NL + "conn_";
  protected final String TEXT_52 = ".invokeGeneric(\"Open\");";
  protected final String TEXT_53 = NL + NL + "org.talend.net.Object cmd_";
  protected final String TEXT_54 = " = org.talend.net.Object.createInstance(";
  protected final String TEXT_55 = ",\"System.Data.OleDb.OleDbCommand\"," + NL + "new java.lang.Object[] { ";
  protected final String TEXT_56 = NL;
  protected final String TEXT_57 = NL + ", " + NL + "conn_";
  protected final String TEXT_58 = " " + NL + "});" + NL + "" + NL + "org.talend.net.Object reader_";
  protected final String TEXT_59 = " = cmd_";
  protected final String TEXT_60 = ".invoke(\"ExecuteReader\");";
  protected final String TEXT_61 = NL + "               //";
  protected final String TEXT_62 = NL + "               Integer id";
  protected final String TEXT_63 = "_";
  protected final String TEXT_64 = " = (Integer)reader_";
  protected final String TEXT_65 = ".invokeGeneric(\"GetOrdinal\"," + NL + "               new java.lang.Object[] { \"";
  protected final String TEXT_66 = "\" });" + NL + "                ";
  protected final String TEXT_67 = NL + "class TypeConverter_";
  protected final String TEXT_68 = " {" + NL + "    void doConversion(Object val, Object targetStruct, String colName) {" + NL + "            try {" + NL + "            java.lang.reflect.Field f = targetStruct.getClass().getField(colName);" + NL + "            f.setAccessible(true);" + NL + "            f.set(targetStruct,val);" + NL + "          } catch (java.lang.Exception ex) {" + NL + "            throw new RuntimeException(\"Can not convert value of type: \"+val.getClass().getName()+\" to target column\");" + NL + "          }" + NL + "    }" + NL + "}" + NL + "Boolean oBool_";
  protected final String TEXT_69 = " = (Boolean)reader_";
  protected final String TEXT_70 = ".invokeGeneric(\"Read\");" + NL + "boolean bool_";
  protected final String TEXT_71 = " = oBool_";
  protected final String TEXT_72 = " != null && oBool_";
  protected final String TEXT_73 = ".booleanValue();" + NL + "java.lang.Object val_";
  protected final String TEXT_74 = ";" + NL + "int nb_line_";
  protected final String TEXT_75 = " = 0;" + NL + "while (bool_";
