...
public class TELTMysqlMapMainJava
{
  protected static String nl;
  public static synchronized TELTMysqlMapMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TELTMysqlMapMainJava result = new TELTMysqlMapMainJava();
    nl = null;
    return result;
  }
