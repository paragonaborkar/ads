...
public class TMysqlOutputBulkBeginJava
{
  ...
  protected final String TEXT_48 = ";" + NL + "\t\tString fieldSeparator_";
  protected final String TEXT_49 = " = ";
  protected final String TEXT_50 = ";" + NL + "\t\tchar escapeChar_";
  protected final String TEXT_51 = " = ";
  protected final String TEXT_52 = ";" + NL + "\t\tchar textEnclosure_";
  protected final String TEXT_53 = " = ";
  protected final String TEXT_54 = ";" + NL + "\t\t";
  protected final String TEXT_55 = NL + "\t\t\tescapeChar_";
  protected final String TEXT_56 = " = '\\\\';";
  protected final String TEXT_57 = NL + "\t\tint escape_mode_";
  protected final String TEXT_58 = " = 0;  // 0: double quotes; 1: backslash" + NL + "\t\tif(escapeChar_";
  protected final String TEXT_59 = "=='\\\\'){" + NL + "\t\t\tescape_mode_";
  protected final String TEXT_60 = " = 1;" + NL + "\t\t}else if(escapeChar_";
  protected final String TEXT_61 = " == textEnclosure_";
  protected final String TEXT_62 = "){" + NL + "\t\t\tescape_mode_";
  protected final String TEXT_63 = " = 0;" + NL + "\t\t}else {" + NL + "\t\t\tthrow new RuntimeException(\"The escape mode only support the '\\\\' or double text enclosure.\");" + NL + "\t\t}" + NL + "\t\t\t\t" + NL + "\t\tjava.io.File file_";
  protected final String TEXT_64 = " = new java.io.File(";
  protected final String TEXT_65 = ");\t\t" + NL + "" + NL + "\t\t";
  protected final String TEXT_66 = NL + "        java.io.File parentFile_";
  protected final String TEXT_67 = " = file_";
  protected final String TEXT_68 = ".getParentFile();" + NL + "        if(parentFile_";
  protected final String TEXT_69 = " != null && !parentFile_";
  protected final String TEXT_70 = ".exists()){" + NL + "            String absolutePath_";
  protected final String TEXT_71 = " = parentFile_";
  protected final String TEXT_72 = ".getAbsolutePath();";
  protected final String TEXT_73 = NL + "            if(parentFile_";
  protected final String TEXT_74 = ".mkdirs()){";
  protected final String TEXT_75 = NL + "                System.out.println(\"The directory '\"+absolutePath_";
  protected final String TEXT_76 = "+\"' has been created successfully.\");" + NL + "            }else{";
  protected final String TEXT_77 = NL + "                System.err.println(\"Fail to create directory '\"+absolutePath_";
  protected final String TEXT_78 = "+\"'.\");" + NL + "            }" + NL + "        }" + NL + "\t\t";
  protected final String TEXT_79 = NL + "\t\t\t\t" + NL + "\t\tjava.io.BufferedWriter csvWriter_";
  protected final String TEXT_80 = " = new java.io.BufferedWriter(new java.io.OutputStreamWriter(" + NL + "        new java.io.FileOutputStream(file_";
  protected final String TEXT_81 = ", ";
  protected final String TEXT_82 = "), ";
  protected final String TEXT_83 = "));" + NL + "        resourceMap.put(\"csvWriter_";
  protected final String TEXT_84 = "\", csvWriter_";
  protected final String TEXT_85 = "); ";
  protected final String TEXT_86 = NL + "      \tlong diskSpace_";
