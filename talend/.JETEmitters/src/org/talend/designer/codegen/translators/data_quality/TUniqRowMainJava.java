...
public class TUniqRowMainJava
{
  ...
  protected final String TEXT_54 = " - Writing the unique record \" + (nb_uniques_";
  protected final String TEXT_55 = "+1) + \" into ";
  ...
  protected final String TEXT_64 = "\t\t" + NL + "\t\tnb_uniques_";
  protected final String TEXT_65 = "++;" + NL + "\t} else {";
  protected final String TEXT_66 = NL + "if (!keysForDuplicated";
  protected final String TEXT_67 = ".contains(finder_";
  protected final String TEXT_68 = ")) {" + NL + "\t\tKeyStruct_";
  protected final String TEXT_69 = " new_";
  protected final String TEXT_70 = " = new KeyStruct_";
  protected final String TEXT_71 = "();" + NL + "" + NL + "\t\t";
  protected final String TEXT_72 = NL + "new_";
  ...
  protected final String TEXT_79 = " == null){" + NL + "\tnew_";
  protected final String TEXT_80 = ".";
  protected final String TEXT_81 = " = null;" + NL + "}else{" + NL + "\tnew_";
  protected final String TEXT_82 = ".";
  protected final String TEXT_83 = " = ";
  protected final String TEXT_84 = ".";
  protected final String TEXT_85 = ".toLowerCase();" + NL + "}";
  protected final String TEXT_86 = NL + "new_";
  protected final String TEXT_87 = ".";
  protected final String TEXT_88 = " = ";
  protected final String TEXT_89 = ".";
  protected final String TEXT_90 = ";";
  protected final String TEXT_91 = NL + "\tkeysForDuplicated";
  protected final String TEXT_92 = ".add(new_";
  ...
  protected final String TEXT_97 = " - Writing the duplicate record \" + (nb_duplicates_";
  protected final String TEXT_98 = "+1) + \" into ";
  ...
  protected final String TEXT_108 = NL + "\t  nb_duplicates_";
