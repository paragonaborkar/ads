...
public class TJavaDBOutputFinallyJava
{
  ...
  protected final String TEXT_47 = NL + "\tif(resourceMap.get(\"finish_";
  protected final String TEXT_48 = "\")==null){" + NL + "\t\tif(resourceMap.get(\"conn_";
  protected final String TEXT_49 = "\")!=null){" + NL + "\t\t\ttry" + NL + "\t    \t{" + NL + "\t    \t\t";
  protected final String TEXT_50 = NL + "\t\t\t\t((java.sql.Connection)resourceMap.get(\"conn_";
  protected final String TEXT_51 = "\")).close();" + NL + "\t\t\t\t";
  protected final String TEXT_52 = NL + "\t\t\t";
  protected final String TEXT_53 = NL + "\t    \t\tjava.sql.DriverManager.getConnection(\"jdbc:derby:;shutdown=true\");" + NL + "\t\t\t";
  protected final String TEXT_54 = NL + "\t    \t}" + NL + "\t    \tcatch(java.sql.SQLException sqlEx_";
  protected final String TEXT_55 = ")" + NL + "\t    \t{" + NL + "\t    \t\tString errorMessage_";
  protected final String TEXT_56 = " = \"failed to close the connection in ";
  protected final String TEXT_57 = " :\" + sqlEx_";
