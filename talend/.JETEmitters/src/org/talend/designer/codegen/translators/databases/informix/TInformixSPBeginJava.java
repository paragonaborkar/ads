...
public class TInformixSPBeginJava
{
  ...
  protected final String TEXT_50 = NL + "\tjava.lang.Class.forName(\"com.informix.jdbc.IfxDriver\");" + NL + "\t";
  protected final String TEXT_51 = NL + "    \tString url_";
  protected final String TEXT_52 = " = \"jdbc:informix-sqli://\" + ";
  protected final String TEXT_53 = " + \":\" + ";
  protected final String TEXT_54 = " + \"/\" + ";
  protected final String TEXT_55 = " + \":informixserver=\" + ";
  protected final String TEXT_56 = ";";
  protected final String TEXT_57 = NL + "\t\tString url_";
  protected final String TEXT_58 = " = \"jdbc:informix-sqli://\" + ";
  protected final String TEXT_59 = " + \":\" + ";
  protected final String TEXT_60 = " + \"/\" + ";
  protected final String TEXT_61 = " + \":informixserver=\" + ";
  ...
  protected final String TEXT_73 = NL + "\tjava.sql.Connection connection_";
  ...
  protected final String TEXT_79 = NL + "\tif(connection_";
  protected final String TEXT_80 = ".getAutoCommit()) {" + NL + "\t    connection_";
  protected final String TEXT_81 = ".setAutoCommit(false);" + NL + "\t}";
  protected final String TEXT_82 = NL + "java.sql.CallableStatement statement_";
  protected final String TEXT_83 = " = connection_";
  protected final String TEXT_84 = ".prepareCall(\"{";
  protected final String TEXT_85 = "call \" + ";
  protected final String TEXT_86 = " + \"(";
  protected final String TEXT_87 = "?";
  protected final String TEXT_88 = ",?";
  protected final String TEXT_89 = ")}\");" + NL + "" + NL + "java.sql.Timestamp tmpDate_";
  protected final String TEXT_90 = ";" + NL + "String tmpString_";
