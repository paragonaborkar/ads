...
public class TSQLTemplateMergeMainJava {
  ...
  protected final String TEXT_8 = "_NB_LINE\",stmt_";
  protected final String TEXT_9 = ".getUpdateCount());" + NL + "globalMap.put(\"";
  protected final String TEXT_10 = "_NB_LINE_MERGED\",stmt_";
  protected final String TEXT_11 = ".getUpdateCount());" + NL + "" + NL + "//System.out.println(\"number of rows: \" + String.valueOf(stmt_";
  protected final String TEXT_12 = ".getUpdateCount()));" + NL + "stmt_";
