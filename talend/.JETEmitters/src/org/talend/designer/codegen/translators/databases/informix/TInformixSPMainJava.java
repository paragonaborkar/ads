...
public class TInformixSPMainJava
{
  ...
  protected final String TEXT_91 = NL + "\t\t\t\t\t\t\t\tjava.sql.ResultSet tmpResult_";
  protected final String TEXT_92 = " = statement_";
  protected final String TEXT_93 = ".getResultSet();" + NL + "\t\t\t\t\t\t\t\tif (tmpResult_";
  protected final String TEXT_94 = ".next()) {";
  protected final String TEXT_95 = NL + "\t\t\t\t\t\t\t\t \t\ttmpString_";
  protected final String TEXT_96 = " = tmpResult_";
  protected final String TEXT_97 = ".getString(";
  protected final String TEXT_98 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\tif (tmpString_";
  protected final String TEXT_99 = " != null && tmpString_";
  protected final String TEXT_100 = ".length() > 0) {" + NL + "\t\t\t\t\t\t\t  \t\t\t\t";
  protected final String TEXT_101 = ".";
  protected final String TEXT_102 = " = tmpString_";
  protected final String TEXT_103 = ".charAt(0);" + NL + "\t\t\t\t\t\t\t\t  \t\t}" + NL + "\t\t\t\t\t\t\t\t  \t\t";
  protected final String TEXT_104 = NL + "\t\t\t\t\t\t\t\t\t\ttmpDate_";
  protected final String TEXT_105 = " = tmpResult_";
  protected final String TEXT_106 = ".getTimestamp(";
  protected final String TEXT_107 = ");" + NL + "\t\t\t\t\t\t\t\t\t\tif (tmpDate_";
  protected final String TEXT_108 = " != null)" + NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_109 = ".";
  protected final String TEXT_110 = " = new java.util.Date(tmpDate_";
  protected final String TEXT_111 = ".getTime());" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_112 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_113 = ".";
  protected final String TEXT_114 = " = tmpResult_";
  protected final String TEXT_115 = ".get";
  protected final String TEXT_116 = "(";
  protected final String TEXT_117 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_118 = NL + "\t\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t}";
  protected final String TEXT_119 = NL + "\t\t\t\t\t\t\t \t\ttmpString_";
  protected final String TEXT_120 = " = statement_";
  protected final String TEXT_121 = ".getString(";
  protected final String TEXT_122 = ");" + NL + "\t\t\t\t\t\t  \t\t\tif (tmpString_";
  protected final String TEXT_123 = " != null && tmpString_";
  protected final String TEXT_124 = ".length() > 0) {" + NL + "\t\t\t\t\t\t  \t\t\t\t";
  protected final String TEXT_125 = ".";
  protected final String TEXT_126 = " = tmpString_";
  protected final String TEXT_127 = ".charAt(0);" + NL + "\t\t\t\t\t\t\t  \t\t}" + NL + "\t\t\t\t\t\t\t  \t\t";
  protected final String TEXT_128 = NL + "\t\t\t\t\t\t\t\t\ttmpDate_";
  protected final String TEXT_129 = " = statement_";
  protected final String TEXT_130 = ".getTimestamp(";
  protected final String TEXT_131 = ");" + NL + "\t\t\t\t\t\t\t\t\tif (tmpDate_";
  protected final String TEXT_132 = " != null)" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_133 = ".";
  protected final String TEXT_134 = " = new java.util.Date(tmpDate_";
  protected final String TEXT_135 = ".getTime());" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_136 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_137 = ".";
  protected final String TEXT_138 = " = statement_";
  protected final String TEXT_139 = ".get";
  protected final String TEXT_140 = "(";
  protected final String TEXT_141 = ");" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_142 = NL + "\t\t\t\t\t\t\t\t\tif (statement_";
  protected final String TEXT_143 = ".wasNull()) {" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_144 = ".";
  protected final String TEXT_145 = " = null;" + NL + "\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_156 = NL + "\t\t// No code generated: define a schema for ";
