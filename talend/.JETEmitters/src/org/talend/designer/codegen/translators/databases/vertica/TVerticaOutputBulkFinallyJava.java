...
public class TVerticaOutputBulkFinallyJava
{
  protected static String nl;
  public static synchronized TVerticaOutputBulkFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TVerticaOutputBulkFinallyJava result = new TVerticaOutputBulkFinallyJava();
    nl = null;
    return result;
  }
