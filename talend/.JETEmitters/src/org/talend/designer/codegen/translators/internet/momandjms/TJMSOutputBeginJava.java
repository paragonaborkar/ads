...
public class TJMSOutputBeginJava
{
  ...
  protected final String TEXT_73 = ".start();" + NL + "" + NL + "\tjavax.jms.Session session_";
  protected final String TEXT_74 = " = connection_";
  protected final String TEXT_75 = ".createSession(false, javax.jms.Session.AUTO_ACKNOWLEDGE);" + NL + "\tjavax.jms.Destination dest_";
  protected final String TEXT_76 = " = session_";
  protected final String TEXT_77 = ".create";
  protected final String TEXT_78 = "(";
  protected final String TEXT_79 = ");" + NL + "" + NL + "\tjavax.jms.MessageProducer producer_";
  protected final String TEXT_80 = " = session_";
  protected final String TEXT_81 = ".createProducer(dest_";
  protected final String TEXT_82 = ");" + NL + "" + NL + "\tproducer_";
  protected final String TEXT_83 = ".setDeliveryMode(javax.jms.DeliveryMode.";
  protected final String TEXT_84 = ");" + NL + "" + NL + "\tint nbline_";
  protected final String TEXT_85 = " = 0;" + NL + "" + NL + "" + NL + "" + NL + "\t\t";
