...
public class TEXistXUpdateBeginJava
{
  ...
  protected final String TEXT_74 = NL + "\torg.xmldb.api.modules.XUpdateQueryService service_";
  protected final String TEXT_75 = " = (org.xmldb.api.modules.XUpdateQueryService) col_";
  protected final String TEXT_76 = ".getService(\"XUpdateQueryService\", \"1.0\");" + NL + "\tjava.io.File file_";
  protected final String TEXT_77 = " = new java.io.File(";
  protected final String TEXT_78 = ");" + NL + "\tjava.io.BufferedReader br_";
  protected final String TEXT_79 = " = new java.io.BufferedReader(new java.io.FileReader(file_";
  protected final String TEXT_80 = "));" + NL + "\tchar[] characters_";
  protected final String TEXT_81 = " = new char[new Long(file_";
  protected final String TEXT_82 = ".length()).intValue()];" + NL + "\tbr_";
  protected final String TEXT_83 = ".read(characters_";
  protected final String TEXT_84 = ", 0, new Long(file_";
  protected final String TEXT_85 = ".length()).intValue());" + NL + "\tbr_";
  protected final String TEXT_86 = ".close();" + NL + "\tString xUpdateModifications_";
  protected final String TEXT_87 = " = new String(characters_";
  protected final String TEXT_88 = ");" + NL + "\t";
  protected final String TEXT_89 = NL + "\t";
  protected final String TEXT_90 = NL + "\tservice_";
  protected final String TEXT_91 = ".update(xUpdateModifications_";
