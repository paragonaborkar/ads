...
public class TXSLTMainJava
{
  ...
  protected final String TEXT_2 = NL + "\tjava.io.File xsltFile";
  ...
  protected final String TEXT_7 = " = javax.xml.transform.TransformerFactory.newInstance(net.sf.saxon.TransformerFactoryImpl.class.getName(), null).newTransformer(styleSource";
