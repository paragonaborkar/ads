...
public class TELTMSSqlMapMainJava
{
  protected static String nl;
  public static synchronized TELTMSSqlMapMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TELTMSSqlMapMainJava result = new TELTMSSqlMapMainJava();
    nl = null;
    return result;
  }
