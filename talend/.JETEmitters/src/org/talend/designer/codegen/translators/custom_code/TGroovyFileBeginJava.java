...
public class TGroovyFileBeginJava
{
  ...
  protected final String TEXT_8 = NL + NL + NL + "groovy.lang.GroovyShell shell";
  protected final String TEXT_9 = " = new groovy.lang.GroovyShell(binding";
  protected final String TEXT_10 = ");" + NL + "shell";
  protected final String TEXT_11 = ".evaluate(new java.io.File(";
