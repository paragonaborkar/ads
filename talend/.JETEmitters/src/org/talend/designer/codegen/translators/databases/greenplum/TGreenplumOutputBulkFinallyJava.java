...
public class TGreenplumOutputBulkFinallyJava
{
  protected static String nl;
  public static synchronized TGreenplumOutputBulkFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TGreenplumOutputBulkFinallyJava result = new TGreenplumOutputBulkFinallyJava();
    nl = null;
    return result;
  }
