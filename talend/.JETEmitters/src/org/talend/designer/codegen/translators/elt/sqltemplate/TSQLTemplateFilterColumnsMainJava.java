...
public class TSQLTemplateFilterColumnsMainJava {

  protected static String nl;
  public static synchronized TSQLTemplateFilterColumnsMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSQLTemplateFilterColumnsMainJava result = new TSQLTemplateFilterColumnsMainJava();
    nl = null;
    return result;
  }
