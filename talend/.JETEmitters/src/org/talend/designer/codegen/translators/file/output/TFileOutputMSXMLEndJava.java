...
public class TFileOutputMSXMLEndJava {
  ...
  protected final String TEXT_492 = NL + "\tjava.io.FileOutputStream stream_";
  protected final String TEXT_493 = " = new java.io.FileOutputStream(fileName_";
  protected final String TEXT_494 = ");" + NL + " \t" + NL + "\torg.dom4j.io.XMLWriter output_";
  protected final String TEXT_495 = " = null;";
  protected final String TEXT_496 = NL + "\tif(talendWrapTool_";
  protected final String TEXT_497 = ".isXML10Char_";
  protected final String TEXT_498 = ") {";
  protected final String TEXT_499 = NL + "\tif(isXML10Char_";
  protected final String TEXT_500 = ") {";
  protected final String TEXT_501 = NL + "\t\toutput_";
  protected final String TEXT_502 = " = new org.dom4j.io.XMLWriter(stream_";
  protected final String TEXT_503 = ", format_";
  protected final String TEXT_504 = ");" + NL + "\t} else {" + NL + "\t\toutput_";
  protected final String TEXT_505 = " = new org.dom4j.io.XMLWriter(" + NL + "\t\t\t\t\t\t\tstream_";
  protected final String TEXT_506 = ", format_";
  protected final String TEXT_507 = ") {" + NL + "\t\t\t\t\t\t" + NL + "\t\t\tprivate org.dom4j.io.OutputFormat format = null;" + NL + "\t\t\t" + NL + "\t\t\t{" + NL + "\t\t\t\tformat = format_";
  protected final String TEXT_508 = ";" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\tpublic void writeDeclaration() throws IOException {" + NL + "\t\t        String encoding = format.getEncoding();" + NL + "" + NL + "\t\t        // Only print of declaration is not suppressed" + NL + "\t\t        if (!format.isSuppressDeclaration()) {" + NL + "\t\t            // Assume 1.0 version" + NL + "\t\t            if (encoding.equals(\"UTF8\")) {" + NL + "\t\t                writer.write(\"<?xml version=\\\"1.1\\\"\");" + NL + "" + NL + "\t\t                if (!format.isOmitEncoding()) {" + NL + "\t\t                    writer.write(\" encoding=\\\"UTF-8\\\"\");" + NL + "\t\t                }" + NL + "" + NL + "\t\t                writer.write(\"?>\");" + NL + "\t\t            } else {" + NL + "\t\t                writer.write(\"<?xml version=\\\"1.1\\\"\");" + NL + "" + NL + "\t\t                if (!format.isOmitEncoding()) {" + NL + "\t\t                    writer.write(\" encoding=\\\"\" + encoding + \"\\\"\");" + NL + "\t\t                }" + NL + "" + NL + "\t\t                writer.write(\"?>\");" + NL + "\t\t            }" + NL + "" + NL + "\t\t            if (format.isNewLineAfterDeclaration()) {" + NL + "\t\t                println();" + NL + "\t\t            }" + NL + "\t\t        }" + NL + "\t\t    }" + NL + "\t\t};" + NL + "\t}" + NL + "\t" + NL + "    nestXMLTool_";
  protected final String TEXT_509 = ".replaceDefaultNameSpace(doc_";
  protected final String TEXT_510 = ".getRootElement());";
  protected final String TEXT_511 = NL + "    nestXMLTool_";
  protected final String TEXT_512 = ".removeEmptyElement(doc_";
  protected final String TEXT_513 = ".getRootElement());";
  protected final String TEXT_514 = NL + "\toutput_";
  protected final String TEXT_515 = ".setEscapeText(";
  protected final String TEXT_516 = ");" + NL + "    output_";
  protected final String TEXT_517 = ".write(doc_";
  protected final String TEXT_518 = ");" + NL + "    output_";
  protected final String TEXT_519 = ".close();" + NL + "    " + NL + "\tnameToElement_";
  protected final String TEXT_520 = ".clear();" + NL + "\t" + NL + "    globalMap.put(\"";
  protected final String TEXT_521 = "_NB_LINE\",nb_line_";
  protected final String TEXT_522 = ");" + NL;
  protected final String TEXT_523 = NL + "\tif(nb_line_";
  protected final String TEXT_524 = " == 0){" + NL + "\t\tcreateFile";
