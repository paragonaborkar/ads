...
public class TParAccelOutputBulkBeginJava
{
  protected static String nl;
  public static synchronized TParAccelOutputBulkBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TParAccelOutputBulkBeginJava result = new TParAccelOutputBulkBeginJava();
    nl = null;
    return result;
  }
