...
public class TS3BucketDeleteBeginJava
{
  ...
  protected final String TEXT_180 = " - Deleting a bucket with name:\" + ";
  protected final String TEXT_181 = ");" + NL + "\t\t";
  protected final String TEXT_182 = NL + "\t\tconn_";
  protected final String TEXT_183 = ".deleteBucket(";
  protected final String TEXT_184 = ");" + NL + "\t\t";
  protected final String TEXT_185 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_186 = " - Delete the bucket successfully.\");" + NL + "\t\t";
