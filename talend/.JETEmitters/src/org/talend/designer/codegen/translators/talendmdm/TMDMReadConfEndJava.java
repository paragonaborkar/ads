...
public class TMDMReadConfEndJava
{
  ...
  protected final String TEXT_47 = NL + "                    try {";
  protected final String TEXT_48 = NL + "                        service_";
  protected final String TEXT_49 = ".logout(new org.talend.mdm.webservice.WSLogout());" + NL + "                    } catch(java.lang.Exception e) {";
  protected final String TEXT_50 = NL + "                              throw e;";
  protected final String TEXT_51 = NL + "                              System.err.println(e.getMessage());";
