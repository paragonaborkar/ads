...
public class TELTJDBCOutputMainJava {
  ...
  protected final String TEXT_119 = NL + "\tString select_query = null;\t" + NL + "\tString tableName_";
  protected final String TEXT_120 = " = null;" + NL + "\tString selectQueryColumnsName = null;" + NL + "\t";
  protected final String TEXT_121 = NL + "\t\tselect_query = (String) globalMap.get(\"";
  protected final String TEXT_122 = "\"+\"QUERY\"+\"";
  protected final String TEXT_123 = "\");" + NL + "\t\tselectQueryColumnsName = (String) globalMap.get(\"";
  protected final String TEXT_124 = "\"+\"QUERY_COLUMNS_NAME\"+\"";
  protected final String TEXT_125 = "\");" + NL + "\t\t";
  protected final String TEXT_126 = NL + "\tString dbschema_";
  protected final String TEXT_127 = " = ";
  protected final String TEXT_128 = ";" + NL + "\tif(dbschema_";
  protected final String TEXT_129 = " != null && dbschema_";
  protected final String TEXT_130 = ".trim().length() > 0) {" + NL + "\t\ttableName_";
  protected final String TEXT_131 = " = ";
  protected final String TEXT_132 = " + \".\" + ";
  protected final String TEXT_133 = ";" + NL + "\t}else {" + NL + "\t\ttableName_";
  ...
  protected final String TEXT_140 = "\");" + NL + "        dbUser_";
  protected final String TEXT_141 = " = (String)globalMap.get(\"";
  protected final String TEXT_142 = "\");";
  protected final String TEXT_143 = NL + "        String driverClass_";
  protected final String TEXT_144 = " = ";
  protected final String TEXT_145 = ";" + NL + "        java.lang.Class.forName(driverClass_";
  protected final String TEXT_146 = ");" + NL + "        String url_";
  protected final String TEXT_147 = " = ";
  protected final String TEXT_148 = "; " + NL + "        dbUser_";
  protected final String TEXT_149 = " = ";
  protected final String TEXT_150 = ";\t        " + NL + "    \t";
  protected final String TEXT_151 = NL + "    \t" + NL + "    \t";
  protected final String TEXT_152 = "String decryptedPassword_";
  protected final String TEXT_153 = " = null;";
  protected final String TEXT_154 = " " + NL + "\tdecryptedPassword_";
  protected final String TEXT_155 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_156 = ");";
  protected final String TEXT_157 = NL + "\tdecryptedPassword_";
  protected final String TEXT_158 = " = ";
  protected final String TEXT_159 = "; ";
  protected final String TEXT_160 = NL + "       \tString dbPwd_";
  protected final String TEXT_161 = " = decryptedPassword_";
  protected final String TEXT_162 = ";" + NL + "        java.sql.Connection conn_";
  protected final String TEXT_163 = " = null;";
  protected final String TEXT_164 = "\t" + NL + "        \tString insertQuery = \"INSERT INTO \"+tableName_";
  protected final String TEXT_165 = "+\"(";
  protected final String TEXT_166 = ")  (\"+select_query+\")\";";
  protected final String TEXT_167 = NL + "        \tString updateQuery = \"UPDATE \"+tableName_";
  protected final String TEXT_168 = "+\" SET ";
  protected final String TEXT_169 = " \"";
  protected final String TEXT_170 = NL + "        \t\t+\"  WHERE \" + ";
  protected final String TEXT_171 = NL + "        \t;";
  protected final String TEXT_172 = NL + "        \tString deleteQuery = \"DELETE  FROM \"+ tableName_";
  protected final String TEXT_173 = "+\" WHERE EXISTS (\"+select_query+\") \" " + NL + "        \t";
  protected final String TEXT_174 = NL + "        \t+\"  AND \" + ";
  protected final String TEXT_175 = NL + "        \t";
  protected final String TEXT_176 = NL + "        \t;" + NL + "    \t";
  protected final String TEXT_177 = NL + "    \t" + NL + "        int nb_line_";
  protected final String TEXT_178 = " = 0;" + NL + "        int nb_line_updated_";
  protected final String TEXT_179 = " = 0;" + NL + "        int nb_line_inserted_";
  protected final String TEXT_180 = " = 0;" + NL + "        int nb_line_deleted_";
  protected final String TEXT_181 = " = 0;";
  protected final String TEXT_182 = NL + "    \t\t";
  protected final String TEXT_183 = NL + "            java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_216 = NL + "            \tString tableNameForSearch_";
  protected final String TEXT_217 = " = ";
  protected final String TEXT_218 = ";" + NL + "            \tString dbschemaForSearch_";
  protected final String TEXT_219 = " = null;" + NL + "            \tif(dbschema_";
  protected final String TEXT_220 = " == null || dbschema_";
  protected final String TEXT_221 = ".trim().isEmpty()) {" + NL + "            \t\tdbschemaForSearch_";
  protected final String TEXT_222 = " = dbUser_";
  protected final String TEXT_223 = ".toUpperCase();" + NL + "            \t} else {" + NL + "            \t\tdbschemaForSearch_";
  protected final String TEXT_224 = " = dbschema_";
  protected final String TEXT_225 = ".toUpperCase();" + NL + "            \t}" + NL + "            \t" + NL + "                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_292 = " = false;" + NL + "                String defaultSchema_";
  protected final String TEXT_293 = " = \"public\";" + NL + "                if(dbschema_";
  protected final String TEXT_294 = " == null || dbschema_";
  protected final String TEXT_295 = ".trim().length() == 0) {" + NL + "                    java.sql.Statement stmtSchema_";
  protected final String TEXT_296 = " = conn_";
  protected final String TEXT_297 = ".createStatement();" + NL + "                    java.sql.ResultSet rsSchema_";
  protected final String TEXT_298 = " = stmtSchema_";
  protected final String TEXT_299 = ".executeQuery(\"select current_schema() \");" + NL + "                    while(rsSchema_";
  protected final String TEXT_300 = ".next()){" + NL + "                        defaultSchema_";
  protected final String TEXT_301 = " = rsSchema_";
  protected final String TEXT_302 = ".getString(\"current_schema\");" + NL + "                    }" + NL + "                    rsSchema_";
  protected final String TEXT_303 = ".close();" + NL + "                    stmtSchema_";
  protected final String TEXT_304 = ".close();" + NL + "                }" + NL + "                while(rsTable_";
  protected final String TEXT_305 = ".next()) {" + NL + "                    String table_";
  protected final String TEXT_306 = " = rsTable_";
  protected final String TEXT_307 = ".getString(\"TABLE_NAME\");" + NL + "                    String schema_";
  protected final String TEXT_308 = " = rsTable_";
  protected final String TEXT_309 = ".getString(\"TABLE_SCHEM\");" + NL + "                    if(table_";
  ...
  protected final String TEXT_319 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_320 = ".equals";
  protected final String TEXT_321 = "IgnoreCase";
  protected final String TEXT_322 = "(schema_";
  ...
  protected final String TEXT_340 = ".getTables(null, conn_";
  protected final String TEXT_341 = ".getSchema(), tableForSearch_";
  protected final String TEXT_342 = ", new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_343 = " = false;" + NL + "               \tif(rsTable_";
  protected final String TEXT_344 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_345 = " = true;" + NL + "\t\t\t\t}" + NL + "                rsTable_";
  protected final String TEXT_346 = ".close();";
  protected final String TEXT_347 = NL + "                String schemaForSearch_";
  protected final String TEXT_348 = " = null;" + NL + "\t\t\t\tString tableForSearch_";
  protected final String TEXT_349 = " = ";
  protected final String TEXT_350 = ";" + NL + "\t\t\t\t" + NL + "                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_354 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_355 = ", null, new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_356 = " = false;" + NL + "                while(rsTable_";
  protected final String TEXT_357 = ".next()) {" + NL + "                    if(rsTable_";
  protected final String TEXT_358 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  ...
  protected final String TEXT_364 = ".getMetaData();" + NL + "                java.sql.ResultSet rsTable_";
  protected final String TEXT_365 = " = dbMetaData_";
  protected final String TEXT_366 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_367 = " = false;" + NL + "                while(rsTable_";
  protected final String TEXT_368 = ".next()) {" + NL + "                    String table_";
  protected final String TEXT_369 = " = rsTable_";
  protected final String TEXT_370 = ".getString(\"TABLE_NAME\");" + NL + "                    if(table_";
  protected final String TEXT_371 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_414 = ".commit();";
  ...
  protected final String TEXT_422 = ".close();";
  protected final String TEXT_423 = NL + "    \t\t";
  protected final String TEXT_424 = NL + "        System.out.println(\"Inserting with : \\n\" + insertQuery + \"\\n\");";
  protected final String TEXT_425 = NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_426 = " = conn_";
  protected final String TEXT_427 = ".prepareStatement(insertQuery);" + NL + "        nb_line_inserted_";
  protected final String TEXT_428 = " = pstmt_";
  protected final String TEXT_429 = ".executeUpdate();";
  protected final String TEXT_430 = NL + "        System.out.println(\"--> \" + nb_line_inserted_";
  protected final String TEXT_431 = " + \" rows inserted. \\n\");" + NL + "        pstmt_";
  protected final String TEXT_432 = ".close();" + NL + "\t\t";
  protected final String TEXT_433 = NL + "        System.out.println(\"Updating with : \\n\" + updateQuery +\"\\n\");";
  protected final String TEXT_434 = NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_435 = " = conn_";
  protected final String TEXT_436 = ".prepareStatement(updateQuery);" + NL + "        nb_line_updated_";
  protected final String TEXT_437 = " = pstmt_";
  protected final String TEXT_438 = ".executeUpdate();";
  protected final String TEXT_439 = NL + "    \tSystem.out.println(\"--> \" + nb_line_updated_";
  protected final String TEXT_440 = " + \" rows updated. \\n\");" + NL + "    \tpstmt_";
  protected final String TEXT_441 = ".close();" + NL + "    \t";
  protected final String TEXT_442 = NL + "    \tSystem.out.println(\"Deleting with : \\n\" + deleteQuery +\"\\n\");" + NL + "\t\t";
  protected final String TEXT_443 = NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_444 = " = conn_";
  protected final String TEXT_445 = ".prepareStatement(deleteQuery);" + NL + "\t\tnb_line_deleted_";
  protected final String TEXT_446 = " = pstmt_";
  protected final String TEXT_447 = ".executeUpdate();" + NL + "\t\t";
  protected final String TEXT_448 = NL + "    \tSystem.out.println(\"--> \" + nb_line_deleted_";
  protected final String TEXT_449 = " + \" rows deleted. \\n\");" + NL + "    \tpstmt_";
  protected final String TEXT_450 = ".close();" + NL + "\t\t";
  protected final String TEXT_451 = NL;
  protected final String TEXT_452 = NL + "        if(conn_";
  protected final String TEXT_453 = " != null && !conn_";
  protected final String TEXT_454 = ".isClosed()) {" + NL + "    \t\t";
  protected final String TEXT_455 = NL + "        }";
  protected final String TEXT_456 = NL + "    nb_line_";
  protected final String TEXT_457 = " = nb_line_updated_";
  protected final String TEXT_458 = " + nb_line_inserted_";
  protected final String TEXT_459 = " + nb_line_deleted_";
  protected final String TEXT_460 = ";" + NL + "    globalMap.put(\"";
  protected final String TEXT_461 = "_NB_LINE\",nb_line_";
  protected final String TEXT_462 = ");" + NL + "    globalMap.put(\"";
  protected final String TEXT_463 = "_NB_LINE_UPDATED\",nb_line_updated_";
  protected final String TEXT_464 = ");" + NL + "    globalMap.put(\"";
  protected final String TEXT_465 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_466 = ");" + NL + "    globalMap.put(\"";
  protected final String TEXT_467 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_468 = ");";
  protected final String TEXT_469 = NL + "    \tlog.info(\"";
  protected final String TEXT_470 = " - Has ";
  protected final String TEXT_471 = " records count: \" + nb_line_";
  protected final String TEXT_472 = "_";
