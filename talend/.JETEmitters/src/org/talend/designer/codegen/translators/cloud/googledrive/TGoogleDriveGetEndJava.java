...
public class TGoogleDriveGetEndJava
{
  protected static String nl;
  public static synchronized TGoogleDriveGetEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TGoogleDriveGetEndJava result = new TGoogleDriveGetEndJava();
    nl = null;
    return result;
  }
