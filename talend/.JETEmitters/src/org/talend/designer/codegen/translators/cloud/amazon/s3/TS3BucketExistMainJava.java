...
public class TS3BucketExistMainJava
{
  ...
  protected final String TEXT_178 = NL + "\tboolean bucketExist_";
  protected final String TEXT_179 = "=false;" + NL + "\ttry{" + NL + "\t\tbucketExist_";
  protected final String TEXT_180 = " = conn_";
  protected final String TEXT_181 = ".doesBucketExist(";
  protected final String TEXT_182 = ");" + NL + "\t\t";
  protected final String TEXT_183 = "\t" + NL + "\t\t\tif(bucketExist_";
  protected final String TEXT_184 = "){" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_185 = " - Bucket \"+";
  protected final String TEXT_186 = "+\" exists.\");" + NL + "\t\t\t}else{" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_187 = " - Bucket \"+";
  protected final String TEXT_188 = "+\" does not exist.\");" + NL + "\t\t\t}" + NL + "\t\t";
  ...
  protected final String TEXT_201 = NL + "\t}" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_202 = "_BUCKET_NAME\", ";
  protected final String TEXT_203 = ");" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_204 = "_BUCKET_EXIST\", bucketExist_";
