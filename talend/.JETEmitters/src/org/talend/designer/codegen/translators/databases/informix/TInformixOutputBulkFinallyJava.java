...
public class TInformixOutputBulkFinallyJava
{
  protected static String nl;
  public static synchronized TInformixOutputBulkFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TInformixOutputBulkFinallyJava result = new TInformixOutputBulkFinallyJava();
    nl = null;
    return result;
  }
