...
public class TMysqlSPBeginJava
{
  ...
  protected final String TEXT_50 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_51 = "\");";
  protected final String TEXT_52 = NL + "\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_53 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\tif (null != dataSources_";
  protected final String TEXT_54 = ") {" + NL + "\t\t\tString dsAlias_";
  protected final String TEXT_55 = " = ";
  protected final String TEXT_56 = ";" + NL + "    \t\tif (dataSources_";
  protected final String TEXT_57 = ".get(dsAlias_";
  protected final String TEXT_58 = ") == null) {" + NL + "       \t\t\tthrow new RuntimeException(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_59 = " + \" available!\");" + NL + "          \t}" + NL + "    \t\tconnection_";
  protected final String TEXT_60 = " = dataSources_";
  protected final String TEXT_61 = ".get(dsAlias_";
  protected final String TEXT_62 = ").getConnection();" + NL + "\t\t} else {" + NL + "\t";
  protected final String TEXT_63 = NL + "    String dbProperties_";
  protected final String TEXT_64 = " = ";
  protected final String TEXT_65 = ";" + NL + "    String connectionString_";
  protected final String TEXT_66 = " = null;" + NL + "    if(dbProperties_";
  protected final String TEXT_67 = " == null || dbProperties_";
  protected final String TEXT_68 = ".trim().length() == 0) {" + NL + "        connectionString_";
  protected final String TEXT_69 = " = \"";
  protected final String TEXT_70 = "://\" + ";
  protected final String TEXT_71 = " + \":\" + ";
  protected final String TEXT_72 = " + \"/\" + ";
  protected final String TEXT_73 = ";" + NL + "    } else {" + NL + "        connectionString_";
  protected final String TEXT_74 = " = \"";
  protected final String TEXT_75 = "://\" + ";
  protected final String TEXT_76 = " + \":\" + ";
  protected final String TEXT_77 = " + \"/\" + ";
  protected final String TEXT_78 = " + \"?\" + dbProperties_";
  protected final String TEXT_79 = ";" + NL + "    }" + NL + "    String dbUser_";
  ...
  protected final String TEXT_89 = NL + NL + "    String dbPwd_";
  protected final String TEXT_90 = " = decryptedPassword_";
  protected final String TEXT_91 = ";" + NL + "" + NL + "    java.lang.Class.forName(\"";
  protected final String TEXT_92 = "\");";
  protected final String TEXT_93 = NL + "    connection_";
  protected final String TEXT_94 = " = java.sql.DriverManager.getConnection(connectionString_";
  protected final String TEXT_95 = ", dbUser_";
  protected final String TEXT_96 = ", dbPwd_";
  protected final String TEXT_97 = ");";
  protected final String TEXT_98 = NL + "\t\t}" + NL + "\t";
  protected final String TEXT_99 = NL + NL + "java.sql.CallableStatement statement_";
  protected final String TEXT_100 = " = connection_";
  protected final String TEXT_101 = ".prepareCall(\"{";
  protected final String TEXT_102 = "call \" + ";
