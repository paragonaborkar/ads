...
public class TSQSMessageChangeVisibilityBeginJava
{
  protected static String nl;
  public static synchronized TSQSMessageChangeVisibilityBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSQSMessageChangeVisibilityBeginJava result = new TSQSMessageChangeVisibilityBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_77 = " - Change message visibility recipet handle:\" + ";
  protected final String TEXT_78 = ");" + NL + "\t\t";
  protected final String TEXT_79 = NL + "\t\tconn_";
  protected final String TEXT_80 = ".changeMessageVisibility(new com.amazonaws.services.sqs.model.ChangeMessageVisibilityRequest(";
  protected final String TEXT_81 = ",";
  protected final String TEXT_82 = ",";
  protected final String TEXT_83 = "));" + NL + "\t\t";
  protected final String TEXT_84 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_85 = " - Change message visibility successfully.\");" + NL + "\t\t";
  protected final String TEXT_86 = NL + "\t}catch(java.lang.Exception e_";
  protected final String TEXT_87 = "){" + NL + "\t\t";
  protected final String TEXT_88 = NL + "\t\t\tthrow(e_";
  protected final String TEXT_89 = ");" + NL + "\t\t";
  protected final String TEXT_90 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_91 = " - \" + e_";
  protected final String TEXT_92 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_93 = NL + "\t\t\tSystem.err.println(e_";
  protected final String TEXT_94 = ".getMessage());" + NL + "\t\t";
  protected final String TEXT_95 = NL + "\t}finally{" + NL + "\t\tif(conn_";
  protected final String TEXT_96 = " !=null){" + NL + "\t\t\tconn_";
  protected final String TEXT_97 = ".shutdown();" + NL + "\t\t}" + NL + "\t\t";
  ...
  public String generate(Object argument)
  {
    ...
    stringBuffer.append(recipethandle);
