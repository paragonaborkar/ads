...
public class TMDMBulkLoadEndJava
{
  ...
  protected final String TEXT_45 = NL + "if (inputStreamMerger_";
  protected final String TEXT_46 = "!=null) {" + NL + "    inputStreamMerger_";
  protected final String TEXT_47 = ".close();" + NL + "} " + NL + "bulkloadClient_";
  protected final String TEXT_48 = ".waitForEndOfQueue();" + NL + "bulkloadClient_";
  protected final String TEXT_49 = " = null;";
  protected final String TEXT_50 = NL + "if(inputStreamMerger_";
  protected final String TEXT_51 = "!=null && inputStreamMerger_";
  protected final String TEXT_52 = ".getLastReportedFailure()!=null) {";
  protected final String TEXT_53 = NL + "    throw new Exception(inputStreamMerger_";
  protected final String TEXT_54 = ".getLastReportedFailure());" + NL + "}";
