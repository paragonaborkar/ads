...
public class TSQSInputBeginJava
{
  ...
  protected final String TEXT_92 = ".withMaxNumberOfMessages(";
  protected final String TEXT_93 = ");" + NL + "\t\t" + NL + "\t\tList<com.amazonaws.services.sqs.model.Message> ";
  protected final String TEXT_94 = "_messages = null;" + NL + "\t\tboolean isContinueReceive_";
  protected final String TEXT_95 = " = true;" + NL + "\t\twhile (isContinueReceive_";
  protected final String TEXT_96 = ") {" + NL + "\t\t\t";
  protected final String TEXT_97 = "_messages = conn_";
  protected final String TEXT_98 = ".receiveMessage(";
  protected final String TEXT_99 = "_receiveMessageRequest).getMessages();" + NL + " \t\t\tfor (com.amazonaws.services.sqs.model.Message ";
  protected final String TEXT_100 = "_message : ";
  protected final String TEXT_101 = "_messages) {" + NL + " \t\t\t\tnbline_";
