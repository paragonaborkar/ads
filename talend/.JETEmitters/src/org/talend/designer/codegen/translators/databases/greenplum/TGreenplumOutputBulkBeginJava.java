...
public class TGreenplumOutputBulkBeginJava
{
  protected static String nl;
  public static synchronized TGreenplumOutputBulkBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TGreenplumOutputBulkBeginJava result = new TGreenplumOutputBulkBeginJava();
    nl = null;
    return result;
  }
