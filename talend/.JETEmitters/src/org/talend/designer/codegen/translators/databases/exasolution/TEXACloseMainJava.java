...
public class TEXACloseMainJava
{
  protected static String nl;
  public static synchronized TEXACloseMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TEXACloseMainJava result = new TEXACloseMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_6 = ".isClosed() == false) {" + NL + "\t\tconn_";
