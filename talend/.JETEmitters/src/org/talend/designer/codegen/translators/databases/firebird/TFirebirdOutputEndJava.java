...
public class TFirebirdOutputEndJava
{
  ...
  protected final String TEXT_66 = ".executeBatch();";
  ...
  protected final String TEXT_72 = ");" + NL + "                                }" + NL + "                            }" + NL + "                        }catch (java.sql.BatchUpdateException e){";
  ...
  protected final String TEXT_78 = ");" + NL + "                            }" + NL + "                            System.err.println(e.getMessage());";
  ...
  protected final String TEXT_99 = NL + NL + "        if(pstmt_";
  ...
  protected final String TEXT_104 = " != null && !conn_";
  protected final String TEXT_105 = ".isClosed()) {";
  ...
  protected final String TEXT_114 = NL + "            resourceMap.put(\"finish_";
