...
public class TSAPCommitMainJava
{
  ...
  protected final String TEXT_14 = ".getFunctionTemplate(\"BAPI_TRANSACTION_COMMIT\");" + NL + "\t\t" + NL + "\t\tcom.sap.conn.jco.JCoFunction function_";
  ...
  protected final String TEXT_39 = ".commit();" + NL + "\t    \t} catch (org.talend.sap.exception.SAPException e_";
