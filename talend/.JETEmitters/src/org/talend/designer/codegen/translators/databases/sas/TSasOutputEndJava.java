...
public class TSasOutputEndJava
{
  ...
  protected final String TEXT_63 = NL + "\tif (commitCounter_";
  protected final String TEXT_64 = " > 0) {" + NL + "\t\t";
  protected final String TEXT_65 = NL + "\t    connection_";
  protected final String TEXT_66 = ".commit();" + NL + "\t\t";
  ...
  protected final String TEXT_71 = "\t" + NL + "\tresourceMap.put(\"finish_";
  protected final String TEXT_72 = "\", true);" + NL + "\t";
  protected final String TEXT_73 = NL + NL + "nb_line_deleted_";
  protected final String TEXT_74 = "=nb_line_deleted_";
  protected final String TEXT_75 = " + deletedCount_";
  protected final String TEXT_76 = ";" + NL + "nb_line_update_";
  protected final String TEXT_77 = "=nb_line_update_";
  protected final String TEXT_78 = " + updatedCount_";
  protected final String TEXT_79 = ";" + NL + "nb_line_inserted_";
  protected final String TEXT_80 = "=nb_line_inserted_";
  protected final String TEXT_81 = " + insertedCount_";
  ...
  protected final String TEXT_91 = "_NB_LINE_REJECTED\",nb_line_rejected_";
