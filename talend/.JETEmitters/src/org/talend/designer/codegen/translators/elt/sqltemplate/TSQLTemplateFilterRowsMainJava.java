...
public class TSQLTemplateFilterRowsMainJava {

  protected static String nl;
  public static synchronized TSQLTemplateFilterRowsMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSQLTemplateFilterRowsMainJava result = new TSQLTemplateFilterRowsMainJava();
    nl = null;
    return result;
  }
