...
public class TJDBCOutputEndJava
{
  ...
  protected final String TEXT_59 = NL + "\t\t\t\tint[] status_";
  protected final String TEXT_60 = " = null;" + NL + "\t\t\t\tint countSum_";
  protected final String TEXT_61 = " = 0;" + NL + "                try {" + NL + "                \tif(pstmt_";
  protected final String TEXT_62 = "!=null && batchSizeCounter_";
  protected final String TEXT_63 = " > 0 ){" + NL + "                \t\t";
  protected final String TEXT_64 = NL + "\t\t\t\t\t\tstatus_";
  protected final String TEXT_65 = " = pstmt_";
  protected final String TEXT_66 = ".executeBatch();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_67 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_68 = ": status_";
  protected final String TEXT_69 = ") {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_70 = " += (countEach_";
  protected final String TEXT_71 = " < 0 ? 0 : countEach_";
  protected final String TEXT_72 = ");" + NL + "\t\t\t\t\t\t}" + NL + "            \t    }" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_73 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_74 = NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_75 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_76 = " += (countEach_";
  protected final String TEXT_77 = " < 0 ? 0 : countEach_";
  protected final String TEXT_78 = ");" + NL + "\t\t\t\t\t}" + NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_79 = NL + "            \t}" + NL + "            \tif(pstmt_";
  protected final String TEXT_80 = "!=null && batchSizeCounter_";
  protected final String TEXT_81 = " > 0 ){" + NL + "        \t\t\ttry {" + NL + "        \t\t\t\ttmp_batchUpdateCount_";
  protected final String TEXT_82 = " = pstmt_";
  protected final String TEXT_83 = ".getUpdateCount();" + NL + "\t\t\t\t\t}catch (java.sql.SQLException e){" + NL + "" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\ttmp_batchUpdateCount_";
  ...
  protected final String TEXT_92 = NL + "        \t    \t\tupdatedCount_";
  protected final String TEXT_93 = " += tmp_batchUpdateCount_";
  protected final String TEXT_94 = ";" + NL + "        \t    \t";
  protected final String TEXT_95 = NL + "        \t    \t    deletedCount_";
  protected final String TEXT_96 = " += tmp_batchUpdateCount_";
  protected final String TEXT_97 = ";" + NL + "        \t    \t";
  protected final String TEXT_98 = NL + "            \t}";
  protected final String TEXT_99 = NL + "    if(pstmt_";
  protected final String TEXT_100 = " != null) {" + NL + "" + NL + "        pstmt_";
  protected final String TEXT_101 = ".close();" + NL + "" + NL + "    }";
  protected final String TEXT_102 = NL;
  protected final String TEXT_103 = NL + "\tif (commitCounter_";
  ...
  protected final String TEXT_112 = "\", true);" + NL + "\t";
  protected final String TEXT_113 = NL;
  protected final String TEXT_114 = NL + "\tnb_line_deleted_";
  protected final String TEXT_115 = "=nb_line_deleted_";
  protected final String TEXT_116 = "+ deletedCount_";
  protected final String TEXT_117 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_118 = "=nb_line_update_";
  protected final String TEXT_119 = " + updatedCount_";
  protected final String TEXT_120 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_121 = "=nb_line_inserted_";
  protected final String TEXT_122 = " + insertedCount_";
  protected final String TEXT_123 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_124 = "=nb_line_rejected_";
  protected final String TEXT_125 = " + rejectedCount_";
  protected final String TEXT_126 = ";" + NL + "\t";
  protected final String TEXT_127 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_128 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_129 = "_NB_LINE\",nb_line_";
  protected final String TEXT_130 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_131 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_132 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_133 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_134 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_135 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_136 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_137 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_138 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_139 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_140 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_143 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  ...
  protected final String TEXT_146 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_149 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_150 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_151 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_152 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_155 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  ...
  protected final String TEXT_159 = "_NB_LINE\",nb_line_";
  ...
  protected final String TEXT_165 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_166 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_167 = "_NB_LINE_REJECTED\", nb_line_rejected_";
