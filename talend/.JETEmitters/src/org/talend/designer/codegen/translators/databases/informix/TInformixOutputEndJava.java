...
public class TInformixOutputEndJava
{
  ...
  protected final String TEXT_59 = NL + "\t\t\ttry {" + NL + "\t\t\t\t// when PreparedStatement execute \"executeBatch\" if have no any data to update that will throw \"java.sql.SQLException: Method can be called only once.\"" + NL + "\t\t\t\tif (pstmt_";
  protected final String TEXT_60 = " != null && batchSizeCounter_";
  protected final String TEXT_61 = " > 0) {" + NL + "\t\t\t\t\tint countSum_";
  ...
  protected final String TEXT_83 = NL + "        if(pstmt_";
  protected final String TEXT_84 = " != null) {" + NL + "" + NL + "            pstmt_";
  protected final String TEXT_85 = ".close();" + NL + "" + NL + "        }" + NL;
  ...
  protected final String TEXT_93 = "\", true);" + NL + "\t";
  protected final String TEXT_94 = NL;
  protected final String TEXT_95 = NL + "\tnb_line_deleted_";
  protected final String TEXT_96 = "=nb_line_deleted_";
  protected final String TEXT_97 = "+ deletedCount_";
  protected final String TEXT_98 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_99 = "=nb_line_update_";
  protected final String TEXT_100 = " + updatedCount_";
  protected final String TEXT_101 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_102 = "=nb_line_inserted_";
  protected final String TEXT_103 = " + insertedCount_";
  protected final String TEXT_104 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_105 = "=nb_line_rejected_";
  protected final String TEXT_106 = " + rejectedCount_";
  protected final String TEXT_107 = ";" + NL + "\t";
  protected final String TEXT_108 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_109 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_110 = "_NB_LINE\",nb_line_";
  protected final String TEXT_111 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_112 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_113 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_114 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_115 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_116 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_117 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_118 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_119 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_120 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_121 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_124 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  ...
  protected final String TEXT_127 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_128 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_129 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_130 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_131 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_132 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_133 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_134 = "_NB_LINE_REJECTED\",nb_line_rejected_";
  protected final String TEXT_135 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_136 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
