...
public class TDB2OutputBeginJava {
  ...
  protected final String TEXT_57 = " = 0;" + NL + "int deletedCount_";
  ...
  protected final String TEXT_71 = NL + NL + NL + "boolean whetherReject_";
  protected final String TEXT_72 = " = false;" + NL + "java.sql.Connection conn_";
  protected final String TEXT_73 = " = null;" + NL + "String dbschema_";
  protected final String TEXT_74 = " = null;" + NL + "String dbUser_";
  ...
  protected final String TEXT_80 = "\");" + NL + "    dbUser_";
  ...
  protected final String TEXT_100 = " = \"jdbc:db2://\" + ";
  protected final String TEXT_101 = " + \":\" + ";
  protected final String TEXT_102 = " + \"/\" + ";
  protected final String TEXT_103 = " + \":\" + ";
  protected final String TEXT_104 = ";";
  protected final String TEXT_105 = NL + "    java.lang.Class.forName(\"com.ibm.db2.jcc.DB2Driver\");" + NL + "\t";
  ...
  protected final String TEXT_118 = ";" + NL + "" + NL + "    dbschema_";
  ...
  protected final String TEXT_136 = NL + "   int batchSize_";
  protected final String TEXT_137 = " = ";
  protected final String TEXT_138 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_139 = "=0;";
  protected final String TEXT_140 = NL + "String tableName_";
  protected final String TEXT_141 = " = null;" + NL + "if(dbschema_";
  protected final String TEXT_142 = " == null || dbschema_";
  protected final String TEXT_143 = ".trim().length() == 0) {" + NL + "    tableName_";
  protected final String TEXT_144 = " = ";
  protected final String TEXT_145 = ";" + NL + "} else {" + NL + "    tableName_";
  ...
  protected final String TEXT_155 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  ...
  protected final String TEXT_182 = NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_186 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_187 = "));";
  protected final String TEXT_188 = NL + "                    stmtCreate_";
  protected final String TEXT_189 = ".execute(((\"";
  protected final String TEXT_190 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_191 = ".";
  protected final String TEXT_192 = ", \"";
  protected final String TEXT_193 = "\")";
  protected final String TEXT_194 = ".toUpperCase()";
  ...
  protected final String TEXT_203 = NL + "                    String keyCheckTable_";
  protected final String TEXT_204 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_211 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_212 = " = conn_";
  protected final String TEXT_213 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_214 = " + \"]\";";
  protected final String TEXT_215 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_216 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_217 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  ...
  protected final String TEXT_332 = NL + "\t\t\t\t            \tString tableForSearch_";
  protected final String TEXT_333 = " = ";
  protected final String TEXT_334 = ";" + NL + "\t\t\t\t            \tif(tableForSearch_";
  protected final String TEXT_335 = " != null){" + NL + "\t\t\t\t            \t\tif(tableForSearch_";
  protected final String TEXT_336 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_337 = ".endsWith(\"\\\"\")){" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_338 = " =  tableForSearch_";
  protected final String TEXT_339 = ".substring(1,tableForSearch_";
  protected final String TEXT_340 = ".length()-1);" + NL + "\t\t\t\t            \t\t}else{" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_341 = " =  tableForSearch_";
  protected final String TEXT_342 = ".toUpperCase();" + NL + "\t\t\t\t            \t\t}" + NL + "\t\t\t\t            \t}" + NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_346 = ".getTables(null, conn_";
  protected final String TEXT_347 = ".getSchema(), tableForSearch_";
  protected final String TEXT_348 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_349 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_350 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_351 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  ...
  protected final String TEXT_355 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_356 = " = dbMetaData_";
  protected final String TEXT_357 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_358 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_359 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_360 = ".next()) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_361 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  ...
  protected final String TEXT_369 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_370 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_371 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_372 = " = rsTable_";
  protected final String TEXT_373 = ".getString(\"TABLE_NAME\");" + NL + "                                    if(table_";
  protected final String TEXT_374 = ".equalsIgnoreCase(";
  protected final String TEXT_375 = ")) {" + NL + "                                        whetherExist_";
  protected final String TEXT_376 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_377 = ".close();";
  protected final String TEXT_378 = NL + "                                if(!whetherExist_";
  protected final String TEXT_379 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_400 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_410 = NL + "                                    stmtDrop_";
  protected final String TEXT_411 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_419 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_433 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_450 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_451 = " = stmtTruncCount_";
  protected final String TEXT_452 = ".executeQuery(\"";
  protected final String TEXT_453 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_454 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_455 = ".next()) {" + NL + "                rsTruncCountNumber_";
  ...
  protected final String TEXT_459 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_470 = NL + "                if(!conn_";
  protected final String TEXT_471 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_472 = ".commit();" + NL + "                }";
  protected final String TEXT_473 = NL + "            deletedCount_";
  protected final String TEXT_474 = " += rsTruncCountNumber_";
  ...
  protected final String TEXT_493 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_494 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_495 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_509 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_528 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_529 = " = conn_";
  protected final String TEXT_530 = ".prepareStatement(update_";
  ...
  protected final String TEXT_547 = NL + "\t    String delete_";
  protected final String TEXT_548 = " = \"DELETE FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_552 = ".prepareStatement(delete_";
  ...
  protected final String TEXT_578 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  ...
  protected final String TEXT_585 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_586 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_587 = " =null;" + NL + "\t";
  protected final String TEXT_588 = NL + "\t\tStringBuffer query_";
  ...
  protected final String TEXT_594 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_595 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_596 = " = null;";
  protected final String TEXT_597 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_598 = " = null;";
  protected final String TEXT_599 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_600 = " = null;";
  protected final String TEXT_601 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  ...
  protected final String TEXT_605 = NL + "class SetPrepareStatementUtil_";
  protected final String TEXT_606 = " {";
  protected final String TEXT_607 = NL + "\t\t\tvoid set";
  protected final String TEXT_608 = "_";
  protected final String TEXT_609 = "(" + NL + "\t\t\t\tfinal ";
  protected final String TEXT_610 = "Struct ";
  protected final String TEXT_611 = "," + NL + "\t\t\t\tfinal java.sql.PreparedStatement";
  protected final String TEXT_612 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_613 = NL + "\t\t\t\tpstmtInsert_";
  protected final String TEXT_614 = NL + "\t\t\t\tpstmtUpdate_";
  protected final String TEXT_615 = NL + "\t\t\t\t," + NL + "\t\t\t\tfinal StringBuffer query_";
  protected final String TEXT_616 = NL + "\t\t\t\t," + NL + "\t\t\t\tfinal String[] ";
  protected final String TEXT_617 = NL + "\t\t\t) throws java.sql.SQLException {" + NL + "\t\t\t//}";
  ...
  protected final String TEXT_623 = NL + "}" + NL + "" + NL + "SetPrepareStatementUtil_";
  protected final String TEXT_624 = " setPrepareStatementUtil_";
  protected final String TEXT_625 = " = new SetPrepareStatementUtil_";
  protected final String TEXT_626 = "();" + NL;
  protected final String TEXT_627 = NL + NL + "class DataPropagateUtil_";
  protected final String TEXT_628 = " {";
  protected final String TEXT_629 = NL + "\t\t\tvoid assign_";
  protected final String TEXT_630 = "_";
  protected final String TEXT_631 = "(final ";
  protected final String TEXT_632 = "Struct ";
  protected final String TEXT_633 = ",final ";
  protected final String TEXT_634 = "Struct ";
  ...
  protected final String TEXT_643 = NL + "}" + NL + "" + NL + "DataPropagateUtil_";
  protected final String TEXT_644 = " dataPropagateUtil_";
  protected final String TEXT_645 = " = new DataPropagateUtil_";
