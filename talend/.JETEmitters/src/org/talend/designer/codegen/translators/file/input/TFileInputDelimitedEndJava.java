...
public class TFileInputDelimitedEndJava
{
  ...
  protected final String TEXT_24 = " - Retrieved records count: \"+ fid_";
  protected final String TEXT_25 = ".getRowNumber() + \".\");" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_32 = NL + "\t\t\t}finally{" + NL + "    \t\t\tif(!(filename_";
  protected final String TEXT_33 = " instanceof java.io.InputStream)){" + NL + "    \t\t\t\tif(csvReader";
  protected final String TEXT_34 = "!=null){" + NL + "    \t\t\t\t\tcsvReader";
  protected final String TEXT_35 = ".close();" + NL + "    \t\t\t\t}" + NL + "    \t\t\t}" + NL + "    \t\t\tif(csvReader";
  protected final String TEXT_36 = "!=null){" + NL + "    \t\t\t\tglobalMap.put(\"";
  protected final String TEXT_37 = "_NB_LINE\",nb_line_";
  protected final String TEXT_38 = ");" + NL + "    \t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_39 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_40 = " - Retrieved records count: \"+ nb_line_";
