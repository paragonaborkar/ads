...
public class TRedshiftBulkExecBeginJava {
  ...
  protected final String TEXT_415 = NL + "\tStringBuilder command_";
  protected final String TEXT_416 = " = new StringBuilder();";
  protected final String TEXT_417 = NL + "\t\tchar fieldSeparator_";
  protected final String TEXT_418 = " = ";
  protected final String TEXT_419 = NL + "\t\t',';";
  protected final String TEXT_420 = NL + "\t\tString.valueOf(";
  protected final String TEXT_421 = ").charAt(0);";
  protected final String TEXT_422 = NL + "\t\tchar textEnclosure_";
  protected final String TEXT_423 = " = ";
  protected final String TEXT_424 = NL + "\t\t'\\0';" + NL + "\t";
  protected final String TEXT_425 = NL + "\t\t'\"';";
  protected final String TEXT_426 = NL + "\t\tString.valueOf(";
  protected final String TEXT_427 = ").charAt(0);";
  protected final String TEXT_428 = NL + "\tcommand_";
  protected final String TEXT_429 = ".append(\"COPY \").append(tableName2_";
  protected final String TEXT_430 = ")" + NL + "\t";
  protected final String TEXT_431 = NL + "\t\t.append(\" (\")";
  protected final String TEXT_432 = NL + "\t\t\t.append(\"";
  protected final String TEXT_433 = "\")";
  protected final String TEXT_434 = NL + "\t\t\t.append(\",\")";
  protected final String TEXT_435 = NL + "\t\t.append(\")\")";
  protected final String TEXT_436 = NL + "\t.append(\" FROM '\");";
  protected final String TEXT_437 = NL + "\t";
  protected final String TEXT_438 = " " + NL + "\tfinal String decryptedPwd_";
  protected final String TEXT_439 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_440 = ");" + NL + "\t";
  protected final String TEXT_441 = NL + "\tfinal String decryptedPwd_";
  protected final String TEXT_442 = " = ";
  protected final String TEXT_443 = "; " + NL + "\t";
  protected final String TEXT_444 = NL + "\t";
  protected final String TEXT_445 = NL + "\t\tStringBuilder avro_builder_";
  protected final String TEXT_446 = " = new StringBuilder();" + NL + "\t\tif(\"auto\".equals(";
  protected final String TEXT_447 = ")) {" + NL + "\t\t\tavro_builder_";
  protected final String TEXT_448 = ".append(\"FORMAT AS AVRO '\").append(\"auto\").append(\"' \");" + NL + "\t\t} else {" + NL + "\t\t\tavro_builder_";
  protected final String TEXT_449 = ".append(\"FORMAT AVRO '\").append(";
  protected final String TEXT_450 = ").append(\"' \");" + NL + "\t\t}";
  protected final String TEXT_451 = NL + "\t\tcommand_";
  protected final String TEXT_452 = ".append(\"s3://\").append(";
  protected final String TEXT_453 = ").append(\"/\").append(";
  protected final String TEXT_454 = ")";
  protected final String TEXT_455 = NL + "\t\tString hdfspath_";
  protected final String TEXT_456 = " = ";
  protected final String TEXT_457 = ";" + NL + "\t\tif(hdfspath_";
  protected final String TEXT_458 = "!=null && hdfspath_";
  protected final String TEXT_459 = ".startsWith(\"/\")) {" + NL + "\t\t\thdfspath_";
  protected final String TEXT_460 = " = hdfspath_";
  protected final String TEXT_461 = ".substring(1);" + NL + "\t\t}" + NL + "\t\tcommand_";
  protected final String TEXT_462 = ".append(\"emr://\").append(";
  protected final String TEXT_463 = ").append(\"/\").append(hdfspath_";
  protected final String TEXT_464 = ")";
  protected final String TEXT_465 = NL + "\t\tcommand_";
  protected final String TEXT_466 = ".append(\"dynamodb://\").append(";
  protected final String TEXT_467 = ")";
  protected final String TEXT_468 = NL + "\t\tcommand_";
  protected final String TEXT_469 = ".append(\"s3://\").append(";
  protected final String TEXT_470 = ").append(\"/\").append(";
  protected final String TEXT_471 = ")";
  protected final String TEXT_472 = NL + "\t.append(\"' \")" + NL + "\t" + NL + "\t.append(\"credentials 'aws_access_key_id=\").append(";
  protected final String TEXT_473 = ").append(\";aws_secret_access_key=\").append(decryptedPwd_";
  protected final String TEXT_474 = ")";
  protected final String TEXT_475 = NL + "\t\t.append(\";master_symmetric_key=\").append(";
  protected final String TEXT_476 = ")";
  protected final String TEXT_477 = NL + "\t.append(\"' \")";
  protected final String TEXT_478 = NL + "\t.append(\"READRATIO \").append(";
  protected final String TEXT_479 = ").append(\" \");";
  protected final String TEXT_480 = NL + "\t.append(\"SSH \")";
  protected final String TEXT_481 = NL + "\t.append(\"DELIMITER '\").append(fieldSeparator_";
  protected final String TEXT_482 = ").append(\"' \")";
  protected final String TEXT_483 = NL + "\t.append(\"JSON '\").append(";
  protected final String TEXT_484 = ").append(\"' \")";
  protected final String TEXT_485 = NL + "\t.append(avro_builder_";
  protected final String TEXT_486 = ")";
  protected final String TEXT_487 = NL + "\t.append(\"FIXEDWIDTH '\").append(";
  protected final String TEXT_488 = ").append(\"' \")";
  protected final String TEXT_489 = NL + "\t;";
  protected final String TEXT_490 = NL + "\tif(textEnclosure_";
  protected final String TEXT_491 = "!='\\0') {" + NL + "\t\tcommand_";
  protected final String TEXT_492 = ".append(\"CSV QUOTE '\").append(textEnclosure_";
  protected final String TEXT_493 = ").append(\"' \");" + NL + "\t}";
  protected final String TEXT_494 = NL + "\t\tcommand_";
  protected final String TEXT_495 = ".append(\"ENCODING \").append(";
  ...
  protected final String TEXT_508 = NL + "\t\t\tcommand_";
  protected final String TEXT_509 = ".append(\"MAXERROR \").append(";
  protected final String TEXT_510 = ").append(\" \");";
  protected final String TEXT_511 = NL + "\t\t\t\tcommand_";
  protected final String TEXT_512 = ".append(\"ACCEPTINVCHARS \");";
  protected final String TEXT_513 = NL + "\t\t\t\tcommand_";
  protected final String TEXT_514 = ".append(\"ACCEPTINVCHARS '\").append(";
  protected final String TEXT_515 = ").append(\"' \");";
  protected final String TEXT_516 = NL + "\t\t\t\tcommand_";
  protected final String TEXT_517 = ".append(\"";
  protected final String TEXT_518 = " ON \");";
  protected final String TEXT_519 = NL + "\t\t\t\tcommand_";
  protected final String TEXT_520 = ".append(\"";
  protected final String TEXT_521 = " OFF \");";
  protected final String TEXT_522 = NL + "\t\tcommand_";
  protected final String TEXT_523 = ".append(\"ENCRYPTED \");";
  protected final String TEXT_524 = NL + "\t\tcommand_";
  protected final String TEXT_525 = ".append(\"";
  protected final String TEXT_526 = " \");";
  protected final String TEXT_527 = NL + "\t\tcommand_";
  protected final String TEXT_528 = ".append(\"DATEFORMAT '\").append(";
  protected final String TEXT_529 = ").append(\"' \");";
  protected final String TEXT_530 = NL + "\t\tcommand_";
  protected final String TEXT_531 = ".append(\"DATEFORMAT 'auto' \");";
  protected final String TEXT_532 = NL + "\t\tcommand_";
  protected final String TEXT_533 = ".append(\"TIMEFORMAT '\").append(";
  protected final String TEXT_534 = ").append(\"' \");";
  protected final String TEXT_535 = NL + "\t\tcommand_";
  protected final String TEXT_536 = ".append(\"TIMEFORMAT 'auto' \");";
  protected final String TEXT_537 = NL + "\t\tcommand_";
  protected final String TEXT_538 = ".append(\"TIMEFORMAT 'epochsecs' \");";
  protected final String TEXT_539 = NL + "\t\tcommand_";
  protected final String TEXT_540 = ".append(\"TIMEFORMAT 'epochmillisecs' \");";
  protected final String TEXT_541 = NL + "\t" + NL + "\tjava.sql.Statement stmt_";
  protected final String TEXT_542 = "=conn_";
  protected final String TEXT_543 = ".createStatement();" + NL + "\tstmt_";
  protected final String TEXT_544 = ".execute(command_";
  protected final String TEXT_545 = ".toString());";
  protected final String TEXT_546 = NL + "\t\tif(stmt_";
  protected final String TEXT_547 = ".getWarnings()!=null) {";
  protected final String TEXT_548 = NL + "\t\t\tlog.warn(\"";
  protected final String TEXT_549 = " - \" + stmt_";
  protected final String TEXT_550 = ".getWarnings().getMessage());";
  protected final String TEXT_551 = NL + "\t\t\tSystem.err.println(stmt_";
  protected final String TEXT_552 = ".getWarnings().getMessage());";
  protected final String TEXT_553 = NL + "\t\t}";
  protected final String TEXT_554 = NL + "\t";
  protected final String TEXT_555 = NL + "\t\tlog.info(\"";
  protected final String TEXT_556 = " - Finish loading data to table : \" + tableName2_";
