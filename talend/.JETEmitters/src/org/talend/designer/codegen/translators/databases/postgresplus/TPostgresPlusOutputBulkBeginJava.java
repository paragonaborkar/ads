...
public class TPostgresPlusOutputBulkBeginJava
{
  protected static String nl;
  public static synchronized TPostgresPlusOutputBulkBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TPostgresPlusOutputBulkBeginJava result = new TPostgresPlusOutputBulkBeginJava();
    nl = null;
    return result;
  }
