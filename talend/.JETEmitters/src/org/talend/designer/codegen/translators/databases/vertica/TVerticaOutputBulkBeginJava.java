...
public class TVerticaOutputBulkBeginJava
{
  protected static String nl;
  public static synchronized TVerticaOutputBulkBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TVerticaOutputBulkBeginJava result = new TVerticaOutputBulkBeginJava();
    nl = null;
    return result;
  }
