...
public class TVectorWiseOutputEndJava
{
  ...
  protected final String TEXT_66 = " == -2 || countEach_";
  protected final String TEXT_67 = " == -3) {" + NL + "\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_68 = " += countEach_";
  protected final String TEXT_69 = ";" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_70 = NL + "\t\t\t\t}" + NL + "\t    \t\tinsertedCount_";
  protected final String TEXT_71 = " += countSum_";
  protected final String TEXT_72 = ";" + NL + "            }catch (java.sql.BatchUpdateException e){" + NL + "            \t";
  protected final String TEXT_73 = NL + "            \t\tthrow(e);" + NL + "            \t";
  protected final String TEXT_74 = NL + "            \tint countSum_";
  protected final String TEXT_75 = " = 0;" + NL + "\t\t\t\tfor(int countEach_";
  ...
  protected final String TEXT_79 = ");" + NL + "\t\t\t\t}" + NL + "" + NL + "\t    \t\tinsertedCount_";
  protected final String TEXT_80 = " += countSum_";
  protected final String TEXT_81 = ";" + NL + "\t    \t\t";
  protected final String TEXT_82 = NL + "            \tSystem.err.println(e.getMessage());" + NL + "            \t";
  protected final String TEXT_83 = NL + "        \t}";
  protected final String TEXT_84 = NL + NL + "            if(pstmt_";
  protected final String TEXT_85 = " != null) {" + NL + "    \t\t\tpstmt_";
  protected final String TEXT_86 = ".close();" + NL + "            }" + NL + "        \t";
  protected final String TEXT_87 = NL;
  protected final String TEXT_88 = NL + "\t    if (commitCounter_";
  protected final String TEXT_89 = " > 0) {" + NL + "\t        ";
  protected final String TEXT_90 = NL + "\t        conn_";
  protected final String TEXT_91 = ".commit();" + NL + "\t        ";
  ...
  protected final String TEXT_98 = NL + NL + "\tint rejectedCount_";
  protected final String TEXT_99 = " = 0;";
  protected final String TEXT_100 = NL + "\tnb_line_deleted_";
  ...
  protected final String TEXT_113 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_114 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_115 = "_NB_LINE\",nb_line_";
  protected final String TEXT_116 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_117 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_118 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_119 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_120 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_121 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_122 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_123 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_124 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_125 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_126 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_129 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  ...
  protected final String TEXT_132 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_135 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_136 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_137 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_138 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_141 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  ...
  protected final String TEXT_147 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_148 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_149 = "_NB_LINE_INSERTED\",nb_line_inserted_";
