...
public class TELTSybaseMapMainJava
{
  protected static String nl;
  public static synchronized TELTSybaseMapMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TELTSybaseMapMainJava result = new TELTSybaseMapMainJava();
    nl = null;
    return result;
  }
