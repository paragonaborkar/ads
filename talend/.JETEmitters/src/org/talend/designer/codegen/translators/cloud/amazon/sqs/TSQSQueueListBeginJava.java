...
public class TSQSQueueListBeginJava
{
  protected static String nl;
  public static synchronized TSQSQueueListBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSQSQueueListBeginJava result = new TSQSQueueListBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_75 = NL + "\tint nb_queue_";
  protected final String TEXT_76 = " = 0;" + NL + "\t";
  protected final String TEXT_77 = NL + "\t\tlog.info(\"";
  protected final String TEXT_78 = " - Retrieving queues from the server.\");" + NL + "\t";
  protected final String TEXT_79 = NL + "\t";
  protected final String TEXT_80 = NL + "\t\ttry{" + NL + "\t";
  protected final String TEXT_81 = NL + "\t" + NL + "\tfor (String queueUrl_";
  protected final String TEXT_82 = " : conn_";
  protected final String TEXT_83 = ".listQueues().getQueueUrls()) {" + NL + "\t\tnb_queue_";
  protected final String TEXT_84 = "++;" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_85 = "_CURRENT_QUEUE_NAME\", queueUrl_";
  protected final String TEXT_86 = ");" + NL + "\t\t";
  protected final String TEXT_87 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_88 = " - Retrieving the queue \" + nb_queue_";
  protected final String TEXT_89 = " + \".\");" + NL + "\t\t\tlog.trace(\"";
  protected final String TEXT_90 = " - Name of current queue : \" + queueUrl_";
