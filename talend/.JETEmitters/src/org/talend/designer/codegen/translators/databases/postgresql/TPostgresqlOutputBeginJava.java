...
public class TPostgresqlOutputBeginJava {
  ...
  protected final String TEXT_87 = "=0;" + NL + "" + NL + "boolean whetherReject_";
  protected final String TEXT_88 = " = false;" + NL + "" + NL + "java.sql.Connection conn_";
  protected final String TEXT_89 = " = null;" + NL + "String dbUser_";
  ...
  protected final String TEXT_95 = NL + "\t\tjava.sql.Savepoint  sp_";
  ...
  protected final String TEXT_99 = ") {" + NL + "\t\t\tString dsAlias_";
  protected final String TEXT_100 = " = ";
  protected final String TEXT_101 = ";" + NL + "    \t\tif (dataSources_";
  protected final String TEXT_102 = ".get(dsAlias_";
  protected final String TEXT_103 = ") == null) {" + NL + "       \t\t\tthrow new RuntimeException(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_104 = " + \" available!\");" + NL + "          \t}" + NL + "    \t\tconn_";
  protected final String TEXT_105 = " = dataSources_";
  protected final String TEXT_106 = ".get(dsAlias_";
  protected final String TEXT_107 = ").getConnection();" + NL + "\t\t} else {" + NL + "\t";
  protected final String TEXT_108 = NL + "\t";
  protected final String TEXT_109 = NL + "    java.lang.Class.forName(\"org.postgresql.Driver\");" + NL + "    String url_";
  protected final String TEXT_110 = " = \"jdbc:postgresql://\"+";
  ...
  protected final String TEXT_123 = NL + NL + "    String dbPwd_";
  ...
  protected final String TEXT_128 = ",dbUser_";
  protected final String TEXT_129 = ",dbPwd_";
  protected final String TEXT_130 = ");";
  protected final String TEXT_131 = NL + "\t";
  protected final String TEXT_132 = NL + "\t\t}" + NL + "\t";
  protected final String TEXT_133 = NL + "\tresourceMap.put(\"conn_";
  protected final String TEXT_134 = "\", conn_";
  protected final String TEXT_135 = ");";
  protected final String TEXT_136 = NL + "    \tjava.sql.Savepoint  sp_";
  ...
  protected final String TEXT_141 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_142 = " = 0;";
  protected final String TEXT_143 = NL;
  protected final String TEXT_144 = NL + "    if(conn_";
  protected final String TEXT_145 = ".getAutoCommit()){" + NL + "    \tthrow new RuntimeException(\"Connection autocommit must be off to use savePoint\");" + NL + "    }";
  protected final String TEXT_146 = NL;
  protected final String TEXT_147 = NL + "   int batchSize_";
  protected final String TEXT_148 = " = ";
  protected final String TEXT_149 = ";" + NL + "   int batchSizeCounter_";
  ...
  protected final String TEXT_360 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_361 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_362 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_363 = ".next()) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_364 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_365 = ")) {" + NL + "                                        whetherExist_";
  protected final String TEXT_366 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_367 = ".close();";
  ...
  protected final String TEXT_372 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_373 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_374 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_375 = " = rsTable_";
  protected final String TEXT_376 = ".getString(\"TABLE_NAME\");" + NL + "                                    if(table_";
  protected final String TEXT_377 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_381 = NL + "                                if(!whetherExist_";
  protected final String TEXT_382 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_386 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_403 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_413 = NL + "                                    stmtDrop_";
  protected final String TEXT_414 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_422 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_434 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_435 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_436 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_442 = NL + "            stmtClear_";
  ...
  protected final String TEXT_450 = NL + "                              stmtTruncCount_";
  protected final String TEXT_451 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_452 = "));";
  protected final String TEXT_453 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_454 = " = stmtTruncCount_";
  protected final String TEXT_455 = ".executeQuery(\"";
  protected final String TEXT_456 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_457 = " = 0;" + NL + "            if(rsTruncCount_";
  ...
  protected final String TEXT_462 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_473 = NL + "                if(!conn_";
  protected final String TEXT_474 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_475 = ".commit();" + NL + "                }";
  protected final String TEXT_476 = NL + "            deletedCount_";
  protected final String TEXT_477 = " += rsTruncCountNumber_";
  protected final String TEXT_478 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_479 = ".close();";
  protected final String TEXT_480 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_481 = " = conn_";
  protected final String TEXT_482 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_483 = " = stmtTruncCount_";
  protected final String TEXT_484 = ".executeQuery(\"";
  protected final String TEXT_485 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_541 = ".prepareStatement(update_";
  protected final String TEXT_542 = ");" + NL + "\t    String insert_";
  protected final String TEXT_543 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_544 = " + \"\\\" (";
  protected final String TEXT_545 = ") VALUES (";
  protected final String TEXT_546 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_551 = " = \"DELETE FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_557 = NL + "        StringBuffer query_";
  ...
  protected final String TEXT_567 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_568 = " = update_";
  protected final String TEXT_569 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_570 = " = insert_";
  protected final String TEXT_571 = ".split(\"\\\\?\");";
  protected final String TEXT_572 = NL + "\t\t\tdelete_";
  protected final String TEXT_573 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_574 = " = delete_";
  protected final String TEXT_575 = ".split(\"\\\\?\");";
  protected final String TEXT_576 = NL + "\t\t\treplace_";
  protected final String TEXT_577 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_578 = " = replace_";
  protected final String TEXT_579 = ".split(\"\\\\?\");";
  protected final String TEXT_580 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_581 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_582 = " = insertIgnore_";
  ...
  protected final String TEXT_587 = NL + "    \tString geometryColumnName_";
  protected final String TEXT_588 = " = null;" + NL + "    \t// Initialize SRID" + NL + "    \tint SRID_";
  protected final String TEXT_589 = " = 0;" + NL + "    \tint dimension_";
  protected final String TEXT_590 = " = 0;" + NL + "    \tboolean firstGeometry_";
  protected final String TEXT_591 = " = true;" + NL + "    \t";
  protected final String TEXT_592 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_593 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_594 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_595 = " =null;" + NL + "\t";
  protected final String TEXT_596 = NL + "\t\tStringBuffer query_";
  ...
  protected final String TEXT_602 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_603 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_604 = " = null;";
  protected final String TEXT_605 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_606 = " = null;";
  protected final String TEXT_607 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_608 = " = null;";
  protected final String TEXT_609 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_610 = " = null;";
  protected final String TEXT_611 = NL + "\t\t \tString[] insertSQLSplits_";
