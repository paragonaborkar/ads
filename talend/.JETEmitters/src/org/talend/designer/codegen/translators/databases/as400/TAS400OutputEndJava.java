...
public class TAS400OutputEndJava
{
  ...
  protected final String TEXT_61 = " >0) {" + NL + "    try {" + NL + "    \t";
  ...
  protected final String TEXT_71 = NL + "                updatedCount_";
  ...
  protected final String TEXT_77 = NL + "    }catch (java.sql.BatchUpdateException e_";
  ...
  protected final String TEXT_83 = ": e_";
  protected final String TEXT_84 = ".getUpdateCounts()) {" + NL + "                    countSum_";
  protected final String TEXT_85 = " += (countEach_";
  protected final String TEXT_86 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_97 = NL + "            tmp_batchUpdateCount_";
  protected final String TEXT_98 = " = pstmt_";
  protected final String TEXT_99 = ".getUpdateCount();" + NL + "            insertedCount_";
  protected final String TEXT_100 = "+= (tmp_batchUpdateCount_";
  protected final String TEXT_101 = " >0 ? tmp_batchUpdateCount_";
  protected final String TEXT_102 = ":0);";
  protected final String TEXT_103 = NL + "    }";
  protected final String TEXT_104 = NL + NL + "        if(pstmt_";
  protected final String TEXT_105 = " != null) {" + NL + "" + NL + "            pstmt_";
  protected final String TEXT_106 = ".close();" + NL + "" + NL + "        }";
  protected final String TEXT_107 = NL;
  protected final String TEXT_108 = NL + "                if(commitCounter_";
  protected final String TEXT_109 = " > 0) {" + NL + "                \t";
  protected final String TEXT_110 = NL + "                    conn_";
  protected final String TEXT_111 = ".commit();";
  protected final String TEXT_112 = NL + "                }";
  protected final String TEXT_113 = NL + "        conn_";
  protected final String TEXT_114 = " .close();" + NL + "        resourceMap.put(\"finish_";
  protected final String TEXT_115 = "\", true);";
  protected final String TEXT_116 = NL;
  protected final String TEXT_117 = NL + "\tnb_line_deleted_";
  protected final String TEXT_118 = "=nb_line_deleted_";
  protected final String TEXT_119 = "+ deletedCount_";
  protected final String TEXT_120 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_121 = "=nb_line_update_";
  protected final String TEXT_122 = " + updatedCount_";
  protected final String TEXT_123 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_124 = "=nb_line_inserted_";
  protected final String TEXT_125 = " + insertedCount_";
  protected final String TEXT_126 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_127 = "=nb_line_rejected_";
  protected final String TEXT_128 = " + rejectedCount_";
  protected final String TEXT_129 = ";" + NL + "\t";
  protected final String TEXT_130 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_131 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_132 = "_NB_LINE\",nb_line_";
  protected final String TEXT_133 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_134 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_135 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_136 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_137 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_138 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_139 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_140 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_141 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_142 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_143 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_146 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  ...
  protected final String TEXT_149 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_152 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_153 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_154 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_155 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_156 = "_NB_LINE_REJECTED\",nb_line_rejected_";
  protected final String TEXT_157 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_158 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  ...
  protected final String TEXT_162 = "_NB_LINE\",nb_line_";
  protected final String TEXT_163 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_164 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_165 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_166 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_167 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_168 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_169 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_170 = "_NB_LINE_REJECTED\", nb_line_rejected_";
