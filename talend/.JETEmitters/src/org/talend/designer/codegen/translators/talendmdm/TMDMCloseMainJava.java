...
public class TMDMCloseMainJava
{
  ...
  protected final String TEXT_45 = NL + "java.util.Iterator it_";
  protected final String TEXT_46 = " = globalMap.keySet().iterator();" + NL + "while (it_";
  protected final String TEXT_47 = ".hasNext()) {" + NL + "    String key_";
  protected final String TEXT_48 = " = it_";
  protected final String TEXT_49 = ".next().toString();" + NL + "    if (key_";
  protected final String TEXT_50 = ".startsWith(\"";
  protected final String TEXT_51 = "_\")) {" + NL + "        org.talend.mdm.webservice.TMDMService service_";
  protected final String TEXT_52 = " = (org.talend.mdm.webservice.TMDMService)globalMap.get(key_";
  protected final String TEXT_53 = ");" + NL + "        if(service_";
  protected final String TEXT_54 = " != null) {" + NL + "           service_";
  protected final String TEXT_55 = ".logout(new org.talend.mdm.webservice.WSLogout());";
