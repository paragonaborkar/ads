...
public class TSybaseOutputBulkBeginJava
{
  protected static String nl;
  public static synchronized TSybaseOutputBulkBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSybaseOutputBulkBeginJava result = new TSybaseOutputBulkBeginJava();
    nl = null;
    return result;
  }
