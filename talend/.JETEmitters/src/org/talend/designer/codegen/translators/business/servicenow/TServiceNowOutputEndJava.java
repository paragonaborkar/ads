...
public class TServiceNowOutputEndJava
{
  ...
  protected final String TEXT_48 = "_NB_LINE_INSERTED\", nb_line_inserted_";
  ...
  protected final String TEXT_54 = NL + "\tif (nb_line_inserted_";
  protected final String TEXT_55 = " == 0 && nb_line_update_";
  protected final String TEXT_56 = " == 0 && nb_line_rejected_";
  protected final String TEXT_57 = " != 0) {" + NL + "\t\tlog.warn(\"";
  protected final String TEXT_58 = " - All '\" + \"";
  protected final String TEXT_59 = "\".toUpperCase() + \"' requests have been rejected.\");" + NL + "\t} else {" + NL + "\t\t";
  protected final String TEXT_60 = "log.info(\"";
  protected final String TEXT_61 = " - Inserted records count: \" + nb_line_inserted_";
  protected final String TEXT_62 = " + \".'\");";
  protected final String TEXT_63 = "log.info(\"";
  protected final String TEXT_64 = " - Updated records count: \" + nb_line_update_";
  protected final String TEXT_65 = " + \".'\");";
  protected final String TEXT_66 = NL + "\t}" + NL + "\t";
  protected final String TEXT_67 = NL;
  protected final String TEXT_68 = NL;
  protected final String TEXT_69 = "_httpclient.close();" + NL + "resourceMap.put(\"finish_";
