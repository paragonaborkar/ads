...
public class TMDMBulkLoadMainJava
{
  ...
  protected final String TEXT_45 = NL + "if (count_";
  protected final String TEXT_46 = " % ";
  protected final String TEXT_47 = " == 0) {" + NL + "    if(inputStreamMerger_";
  protected final String TEXT_48 = " != null) {";
  protected final String TEXT_49 = NL + "       inputStreamMerger_";
  protected final String TEXT_50 = ".close();" + NL + "    }" + NL + "" + NL + "    inputStreamMerger_";
  protected final String TEXT_51 = " = bulkloadClient_";
  protected final String TEXT_52 = ".load();" + NL + "        resourceMap.put(\"mdmBulkStream";
  protected final String TEXT_53 = "\", inputStreamMerger_";
  protected final String TEXT_54 = ");" + NL + "}" + NL + "" + NL + "if(";
  protected final String TEXT_55 = ".";
  protected final String TEXT_56 = "!=null){";
  protected final String TEXT_57 = NL + "    inputStreamMerger_";
  protected final String TEXT_58 = ".push(new java.io.ByteArrayInputStream(";
  protected final String TEXT_59 = ".";
  protected final String TEXT_60 = ".toString().getBytes(\"UTF-8\")));" + NL + "}else{" + NL + "    inputStreamMerger_";
  protected final String TEXT_61 = ".push(null);" + NL + "}" + NL + "    count_";
