...
public class Header_additional_boxJava
{
  protected static String nl;
  public static synchronized Header_additional_boxJava create(String lineSeparator)
  {
    nl = lineSeparator;
    Header_additional_boxJava result = new Header_additional_boxJava();
    nl = null;
    return result;
  }
