...
public class TAmazonMysqlInputBeginJava
{
  ...
  protected final String TEXT_200 = ") != null) {" + NL + "\t            String dateString_";
  ...
  protected final String TEXT_204 = ");" + NL + "\t            if (!(\"0000-00-00\").equals(dateString_";
  protected final String TEXT_205 = ") && !(\"0000-00-00 00:00:00\").equals(dateString_";
  protected final String TEXT_206 = ")) {" + NL + "\t                ";
  protected final String TEXT_207 = ".";
  protected final String TEXT_208 = " = rs_";
  protected final String TEXT_209 = ".getTimestamp(";
  protected final String TEXT_210 = "column_index_";
  protected final String TEXT_211 = ");" + NL + "\t            } else {" + NL + "\t                ";
  protected final String TEXT_212 = ".";
  protected final String TEXT_213 = " = (java.util.Date) year0_";
  protected final String TEXT_214 = ".clone();" + NL + "\t            }" + NL + "\t        } else {" + NL + "\t            ";
  protected final String TEXT_215 = ".";
  protected final String TEXT_216 = " =  null;" + NL + "\t        }\t\t\t ";
  protected final String TEXT_217 = NL + "    " + NL + "\t";
  protected final String TEXT_218 = NL + "\t\t    int nb_line_";
  protected final String TEXT_219 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_220 = " = null;";
  protected final String TEXT_221 = NL + "\t\t        conn_";
  protected final String TEXT_222 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_223 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_224 = NL + "\t\t\t\t";
  protected final String TEXT_225 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_226 = " =  conn_";
  protected final String TEXT_227 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_228 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_229 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_230 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_231 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_232 = NL + "                 conn_";
  protected final String TEXT_233 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_234 = NL + "               ";
  protected final String TEXT_235 = " + \"=\" + ";
  protected final String TEXT_236 = " + \";\" +";
  protected final String TEXT_237 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_238 = ".setAutoCommit(currentAutoCommitMode";
  ...
  protected final String TEXT_254 = NL + NL + "\t\t    java.sql.ResultSet rs_";
  ...
  protected final String TEXT_278 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_279 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_280 = ".setName(rsmd_";
  protected final String TEXT_281 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  ...
  protected final String TEXT_290 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_291 = ".setDbTypeId(rsmd_";
  protected final String TEXT_292 = ".getColumnType(i));";
  protected final String TEXT_293 = NL + "                \tdcm_";
  protected final String TEXT_294 = ".setFormat(";
  protected final String TEXT_295 = ");";
  protected final String TEXT_296 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_297 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_298 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_299 = ".setLength(rsmd_";
  protected final String TEXT_300 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_301 = ".setLength(rsmd_";
  protected final String TEXT_302 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_303 = NL + "\t\t\tdcm_";
  protected final String TEXT_304 = ".setLength(rsmd_";
  protected final String TEXT_305 = ".getPrecision(i));";
  protected final String TEXT_306 = NL + "                \tdcm_";
  protected final String TEXT_307 = ".setPrecision(rsmd_";
  protected final String TEXT_308 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_309 = ".setNullable(rsmd_";
  protected final String TEXT_310 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_311 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_312 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_313 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_314 = ".metadatas.add(dcm_";
  protected final String TEXT_315 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_316 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_317 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_318 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_319 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_320 = NL + "\t\t    ";
  protected final String TEXT_321 = NL + "\t\t    \tlog.debug(\"";
  protected final String TEXT_322 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_323 = NL + "\t\t    while (rs_";
  protected final String TEXT_324 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_325 = "++;" + NL + "\t\t        ";
  protected final String TEXT_326 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_327 = " = ";
  protected final String TEXT_328 = " + dcg_";
  protected final String TEXT_329 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_330 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_331 = " = ";
  protected final String TEXT_332 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_333 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_334 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  ...
  protected final String TEXT_346 = " = (List)rs_";
  protected final String TEXT_347 = ".getObject(";
  protected final String TEXT_348 = "column_index_";
  protected final String TEXT_349 = ");";
  protected final String TEXT_350 = NL + "\t                         \t\t";
  protected final String TEXT_351 = NL + "\t                         \t\t";
  protected final String TEXT_352 = NL + "\t                         \t\t";
  protected final String TEXT_353 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_354 = ".getObject(";
  protected final String TEXT_355 = "column_index_";
  protected final String TEXT_356 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_357 = NL + "                                    ";
  protected final String TEXT_358 = ".";
  protected final String TEXT_359 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_368 = ".setEPSG(";
  protected final String TEXT_369 = ");" + NL + "                                        }";
  protected final String TEXT_370 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_371 = NL + "                                  ";
  protected final String TEXT_372 = ".";
  protected final String TEXT_373 = "=dcg_";
  protected final String TEXT_374 = ";";
  protected final String TEXT_375 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_376 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_377 = " = ";
  protected final String TEXT_378 = "; i_";
  protected final String TEXT_379 = "  <= rsmd_";
  protected final String TEXT_380 = ".getColumnCount(); i_";
  ...
  protected final String TEXT_393 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_394 = " " + NL + "\t\t\t\t\t\t   \t\t\t\t\tif(\"NTEXT\".equals(rsmd_";
  protected final String TEXT_395 = ".getColumnTypeName(i_";
  protected final String TEXT_396 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t   \t\t\t\t\t\tlist_";
  protected final String TEXT_397 = ".add(rs_";
  protected final String TEXT_398 = ".getString(i_";
  protected final String TEXT_399 = "));" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_400 = NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  ...
  protected final String TEXT_407 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_408 = ".";
  protected final String TEXT_409 = ", rs_";
  protected final String TEXT_410 = ", fixedColumnCount_";
  protected final String TEXT_411 = ",";
  protected final String TEXT_412 = ");";
  protected final String TEXT_413 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_414 = ".";
  protected final String TEXT_415 = ", rs_";
  protected final String TEXT_416 = ", fixedColumnCount_";
  protected final String TEXT_417 = ",";
  protected final String TEXT_418 = ");";
  protected final String TEXT_419 = NL + "                                  Object geom = rs_";
  protected final String TEXT_420 = ".getObject(";
  protected final String TEXT_421 = "column_index_";
  protected final String TEXT_422 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_423 = ".";
  protected final String TEXT_424 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  ...
  protected final String TEXT_431 = " - Retrieving the record \" + nb_line_";
