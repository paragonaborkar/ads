...
public class TOracleOutputBulkBeginJava
{
  ...
  protected final String TEXT_54 = " = \"\";" + NL + "\t\t}" + NL + "\t\t//create directory only if not exists" + NL + "\t\tif(directory_";
  ...
  protected final String TEXT_69 = ";" + NL + "\t\t" + NL + "\t\tfinal String OUT_DELIM_ROWSEP_";
  protected final String TEXT_70 = " = ";
  protected final String TEXT_71 = ";" + NL + "\t\t" + NL + "\t\tfinal String OUT_DELIM_ROWSEP_WITH_LOB_";
  protected final String TEXT_72 = " = \"|\";";
  protected final String TEXT_73 = "\t\t\t\t" + NL + "\t\tfinal String OUT_FIELDS_ENCLOSURE_LEFT_";
  protected final String TEXT_74 = " = ";
  protected final String TEXT_75 = ";" + NL + "\t\t" + NL + "\t\tfinal String OUT_FIELDS_ENCLOSURE_RIGHT_";
  protected final String TEXT_76 = " = ";
  protected final String TEXT_77 = ";";
  protected final String TEXT_78 = "\t\t" + NL + "\t\tfinal java.io.BufferedWriter out";
  protected final String TEXT_79 = " = new java.io.BufferedWriter(new java.io.OutputStreamWriter(" + NL + "        \t\tnew java.io.FileOutputStream(fileName_";
  protected final String TEXT_80 = ", ";
  protected final String TEXT_81 = "),";
  protected final String TEXT_82 = "),";
  protected final String TEXT_83 = ");" + NL + "       \tresourceMap.put(\"out";
  protected final String TEXT_84 = "\", out";
