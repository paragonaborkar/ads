...
public class TS3BucketListBeginJava
{
  ...
  protected final String TEXT_178 = NL + "\tint nb_bucket_";
  protected final String TEXT_179 = " = 0;" + NL + "\t";
  protected final String TEXT_180 = NL + "\t\tlog.info(\"";
  protected final String TEXT_181 = " - Retrieving buckets from the server.\");" + NL + "\t";
  protected final String TEXT_182 = NL + "\tjava.util.List<com.amazonaws.services.s3.model.Bucket> buckets_";
  protected final String TEXT_183 = " = conn_";
  protected final String TEXT_184 = ".listBuckets();" + NL + "\t";
  protected final String TEXT_185 = NL + "\t\ttry{" + NL + "\t";
  protected final String TEXT_186 = NL + "\tfor (com.amazonaws.services.s3.model.Bucket bucket_";
  protected final String TEXT_187 = " : buckets_";
  protected final String TEXT_188 = ") {" + NL + "\t\tnb_bucket_";
  protected final String TEXT_189 = "++;" + NL + "\t\tString currentBucketName_";
  protected final String TEXT_190 = " = bucket_";
  protected final String TEXT_191 = ".getName();" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_192 = "_CURRENT_BUCKET_NAME\", currentBucketName_";
  protected final String TEXT_193 = ");" + NL + "\t\t";
  protected final String TEXT_194 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_195 = " - Retrieving the bucket \" + nb_bucket_";
  protected final String TEXT_196 = " + \".\");" + NL + "\t\t\tlog.trace(\"";
  protected final String TEXT_197 = " - Name of current bucket : \" + currentBucketName_";
