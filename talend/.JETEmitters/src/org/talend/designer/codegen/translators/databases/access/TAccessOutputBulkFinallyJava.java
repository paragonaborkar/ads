...
public class TAccessOutputBulkFinallyJava
{
  protected static String nl;
  public static synchronized TAccessOutputBulkFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TAccessOutputBulkFinallyJava result = new TAccessOutputBulkFinallyJava();
    nl = null;
    return result;
  }
