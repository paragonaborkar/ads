...
public class TServiceNowOutputFinallyJava
{
  ...
  protected final String TEXT_48 = "\") == null) {" + NL + "\tif(resourceMap.get(\"";
  protected final String TEXT_49 = "_httpclient\") != null) {" + NL + "\t\ttry" + NL + "\t\t{" + NL + "\t\t\t((org.apache.http.impl.client.CloseableHttpClient)resourceMap.get(\"";
  protected final String TEXT_50 = "_httpclient\")).close();" + NL + "\t\t}" + NL + "\t\tcatch(org.apache.http.conn.HttpHostConnectException httpEx_";
  ...
  protected final String TEXT_53 = " :\" + httpEx_";
  protected final String TEXT_54 = ".getMessage();" + NL + "\t\t\t";
  protected final String TEXT_55 = "log.warn(\"errorMessage_";
