...
public class TSQLTemplateAggregateMainJava {

  protected static String nl;
  public static synchronized TSQLTemplateAggregateMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSQLTemplateAggregateMainJava result = new TSQLTemplateAggregateMainJava();
    nl = null;
    return result;
  }
