...
public class TMDMBulkLoadBeginJava
{
  ...
  protected final String TEXT_61 = NL + "    String transKey_";
  protected final String TEXT_62 = " = \"";
  protected final String TEXT_63 = "_\" + Thread.currentThread().getThreadGroup().getName();" + NL + "    com.talend.mdm.transaction.client.MDMTransaction mdmTransaction_";
  protected final String TEXT_64 = " = (com.talend.mdm.transaction.client.MDMTransaction)globalMap.get(transKey_";
  protected final String TEXT_65 = ");" + NL + "    if(mdmTransaction_";
  protected final String TEXT_66 = " == null) {" + NL + "        String murl_";
  protected final String TEXT_67 = " = (String)globalMap.get(\"mdmUrl_";
  ...
  protected final String TEXT_72 = ".length() - 5);" + NL + "        }" + NL + "        String turl_";
  protected final String TEXT_73 = " = com.talend.mdm.transaction.client.MDMTransactionClient.getMDMTransactionURL(murl_";
  protected final String TEXT_74 = ", true);" + NL + "        String username_";
  protected final String TEXT_75 = " = (String)globalMap.get(\"username_";
  protected final String TEXT_76 = "\");" + NL + "        String password_";
  protected final String TEXT_77 = " = (String)globalMap.get(\"password_";
  protected final String TEXT_78 = "\");" + NL + "        if((Boolean)globalMap.get(\"useClientTranId_";
  protected final String TEXT_79 = "\")) {" + NL + "            String sessionID_";
  protected final String TEXT_80 = " = com.talend.mdm.transaction.client.MDMTransactionClient.getSessionID(turl_";
  protected final String TEXT_81 = ",username_";
  protected final String TEXT_82 = ",password_";
  protected final String TEXT_83 = ");" + NL + "            mdmTransaction_";
  protected final String TEXT_84 = " = new com.talend.mdm.transaction.client.MDMTransaction();" + NL + "            mdmTransaction_";
  protected final String TEXT_85 = ".setUrl(turl_";
  protected final String TEXT_86 = ");" + NL + "            mdmTransaction_";
  protected final String TEXT_87 = ".setId(\"";
  protected final String TEXT_88 = "_\" + java.util.UUID.randomUUID());" + NL + "            mdmTransaction_";
  protected final String TEXT_89 = ".setUsername(username_";
  protected final String TEXT_90 = ");" + NL + "            mdmTransaction_";
  protected final String TEXT_91 = ".setPassword(password_";
  protected final String TEXT_92 = ");" + NL + "            mdmTransaction_";
  protected final String TEXT_93 = ".setSessionId(sessionID_";
  protected final String TEXT_94 = ");" + NL + "        } else {";
  protected final String TEXT_95 = NL + "            mdmTransaction_";
  protected final String TEXT_96 = " = com.talend.mdm.transaction.client.MDMTransactionClient.newTransaction(turl_";
  protected final String TEXT_97 = ",username_";
  protected final String TEXT_98 = ",password_";
  protected final String TEXT_99 = ");" + NL + "        }" + NL + "        globalMap.put(transKey_";
  protected final String TEXT_100 = ", mdmTransaction_";
  protected final String TEXT_101 = ");";
  protected final String TEXT_102 = NL + "    }" + NL + "    bulkloadClient_";
  protected final String TEXT_103 = ".setTransactionId(mdmTransaction_";
  protected final String TEXT_104 = ".getId());" + NL + "    bulkloadClient_";
  protected final String TEXT_105 = ".setSessionId(mdmTransaction_";
  protected final String TEXT_106 = ".getSessionId());";
  protected final String TEXT_107 = NL + NL + "bulkloadClient_";
  protected final String TEXT_108 = ".startThreadCount();" + NL + "bulkloadClient_";
  protected final String TEXT_109 = ".setOptions(new org.talend.mdm.bulkload.client.BulkloadOptions(";
  protected final String TEXT_110 = ", ";
  protected final String TEXT_111 = ", ";
  protected final String TEXT_112 = ", ";
  protected final String TEXT_113 = "));" + NL + "int count_";
  protected final String TEXT_114 = " = 0;" + NL + "org.talend.mdm.bulkload.client.InputStreamMerger inputStreamMerger_";
