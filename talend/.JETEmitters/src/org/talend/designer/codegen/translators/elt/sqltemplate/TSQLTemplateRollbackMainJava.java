...
public class TSQLTemplateRollbackMainJava {

  protected static String nl;
  public static synchronized TSQLTemplateRollbackMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSQLTemplateRollbackMainJava result = new TSQLTemplateRollbackMainJava();
    nl = null;
    return result;
  }
