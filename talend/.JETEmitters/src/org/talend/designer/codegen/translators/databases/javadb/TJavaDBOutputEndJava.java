...
public class TJavaDBOutputEndJava
{
  ...
  protected final String TEXT_79 = "=nb_line_update_";
  protected final String TEXT_80 = " + updatedCount_";
  protected final String TEXT_81 = ";" + NL + "\tnb_line_inserted_";
  ...
  protected final String TEXT_85 = "=nb_line_rejected_";
  protected final String TEXT_86 = " + rejectedCount_";
  protected final String TEXT_87 = ";" + NL + "\t";
  protected final String TEXT_88 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_89 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_90 = "_NB_LINE\",nb_line_";
  protected final String TEXT_91 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_92 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_93 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_94 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_95 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_96 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_97 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_98 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_99 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_100 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_101 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_104 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_105 = "_NB_LINE_INSERTED\") + nb_line_inserted_";
  protected final String TEXT_106 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_107 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_110 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_111 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_112 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_113 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_116 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  ...
  protected final String TEXT_128 = "_NB_LINE_REJECTED\", nb_line_rejected_";
