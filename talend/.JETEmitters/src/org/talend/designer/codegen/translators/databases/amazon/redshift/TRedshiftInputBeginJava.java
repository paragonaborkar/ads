...
public class TRedshiftInputBeginJava
{
  ...
  protected final String TEXT_183 = ",true));" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\tStringBuilder sbuilder_";
  protected final String TEXT_184 = " = new StringBuilder();" + NL + "\t\t\tsbuilder_";
  protected final String TEXT_185 = ".append(\"jdbc:redshift://\").append(";
  protected final String TEXT_186 = ").append(\":\").append(";
  protected final String TEXT_187 = ").append(\"/\").append(";
  protected final String TEXT_188 = ").append(\"?loglevel=\").append(";
  protected final String TEXT_189 = ");" + NL + "\t\t\t";
  protected final String TEXT_190 = NL + "        \t\tsbuilder_";
  protected final String TEXT_191 = ".append(\"&\").append(";
  protected final String TEXT_192 = ");" + NL + "        \t";
  protected final String TEXT_193 = NL + "            String url_";
  protected final String TEXT_194 = " = sbuilder_";
  protected final String TEXT_195 = ".toString();";
  protected final String TEXT_196 = NL + "                stmt_";
  protected final String TEXT_197 = ".setFetchSize(";
