...
public class TDB2OutputMainJava {
  ...
  protected final String TEXT_1089 = NL + "                        String errormessage_";
  protected final String TEXT_1090 = " = printSQLException_";
  protected final String TEXT_1091 = ".getSQLException(e,true);";
  protected final String TEXT_1092 = NL + "                        throw(e);" + NL + "                \t";
  protected final String TEXT_1093 = NL + "                \tString errormessage_";
  protected final String TEXT_1094 = " = printSQLException_";
  protected final String TEXT_1095 = ".getSQLException(e,false);" + NL + "                \tint countSum_";
  protected final String TEXT_1096 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1097 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tif(countEach_";
  protected final String TEXT_1098 = " == java.sql.Statement.SUCCESS_NO_INFO ){" + NL + "    \t\t\t\t\t\tcountSum_";
  protected final String TEXT_1099 = " += 1;" + NL + "    \t\t\t\t\t}else{" + NL + "    \t\t\t\t\t\tcountSum_";
  protected final String TEXT_1100 = " += (countEach_";
  protected final String TEXT_1101 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1102 = ");" + NL + "    \t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_1106 = NL + "\t\t\t    \t\tupdatedCount_";
  protected final String TEXT_1107 = " += countSum_";
  protected final String TEXT_1108 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_1109 = NL + "\t\t\t    \t    deletedCount_";
  protected final String TEXT_1110 = " += countSum_";
  protected final String TEXT_1111 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_1112 = NL + "                }" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_1113 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_1114 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_1115 = " <= commitCounter_";
  protected final String TEXT_1116 = ") {";
  protected final String TEXT_1117 = NL + "                if ((batchSize_";
  protected final String TEXT_1118 = " > 0) && (batchSizeCounter_";
  protected final String TEXT_1119 = " > 0)) {" + NL + "                try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_1120 = " = 0;" + NL + "                \t\tint countSum_";
  protected final String TEXT_1121 = " = 0;" + NL + "                \t\t";
  protected final String TEXT_1122 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1123 = ": pstmt_";
  protected final String TEXT_1124 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tif(countEach_";
  ...
  protected final String TEXT_1131 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_1132 = " += countSum_";
  protected final String TEXT_1133 = ";" + NL + "            \t    \t";
  protected final String TEXT_1134 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_1135 = " += countSum_";
  protected final String TEXT_1136 = ";" + NL + "            \t    \t";
  protected final String TEXT_1137 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_1138 = " += countSum_";
  protected final String TEXT_1139 = ";" + NL + "            \t    \t";
  protected final String TEXT_1140 = NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t" + NL + "                \t";
  protected final String TEXT_1141 = NL + "                        String errormessage_";
  protected final String TEXT_1142 = " = printSQLException_";
  protected final String TEXT_1143 = ".getSQLException(e,true);";
  protected final String TEXT_1144 = NL + "                        throw(e);" + NL + "                \t";
  protected final String TEXT_1145 = NL + "                \t\tString errormessage_";
  protected final String TEXT_1146 = " = printSQLException_";
  protected final String TEXT_1147 = ".getSQLException(e,false);" + NL + "                \t\tint countSum_";
  protected final String TEXT_1148 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1149 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\t\tif(countEach_";
  protected final String TEXT_1150 = " == java.sql.Statement.SUCCESS_NO_INFO ){" + NL + "        \t\t\t\t\t\tcountSum_";
  protected final String TEXT_1151 = " += 1;" + NL + "        \t\t\t\t\t}else{" + NL + "        \t\t\t\t\t\tcountSum_";
  protected final String TEXT_1152 = " += (countEach_";
  protected final String TEXT_1153 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1154 = ");" + NL + "        \t\t\t\t\t}" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1155 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_1156 = " += countSum_";
  protected final String TEXT_1157 = ";" + NL + "            \t    \t";
  protected final String TEXT_1158 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_1159 = " += countSum_";
  protected final String TEXT_1160 = ";" + NL + "            \t    \t";
  protected final String TEXT_1161 = NL + "            \t    \t    deletedCount_";
  ...
  protected final String TEXT_1166 = NL + "                \tconn_";
  protected final String TEXT_1167 = ".commit();" + NL + "                \t";
  protected final String TEXT_1168 = NL + "                \tcommitCounter_";
  protected final String TEXT_1169 = "=0;" + NL + "                }";
