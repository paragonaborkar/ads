...
public class TSQSQueueDeleteBeginJava
{
  protected static String nl;
  public static synchronized TSQSQueueDeleteBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSQSQueueDeleteBeginJava result = new TSQSQueueDeleteBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_77 = " - Deleting a queue with name:\" + ";
  protected final String TEXT_78 = ");" + NL + "\t\t";
  protected final String TEXT_79 = NL + "        conn_";
  protected final String TEXT_80 = ".deleteQueue(new com.amazonaws.services.sqs.model.DeleteQueueRequest(";
  protected final String TEXT_81 = "));" + NL + "        " + NL + "\t\t";
  protected final String TEXT_82 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_83 = " - Delete the queue successfully.\");" + NL + "\t\t";
  protected final String TEXT_84 = NL + "\t}catch(java.lang.Exception e_";
  protected final String TEXT_85 = "){" + NL + "\t\t";
  protected final String TEXT_86 = NL + "\t\t\tthrow(e_";
  protected final String TEXT_87 = ");" + NL + "\t\t";
  protected final String TEXT_88 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_89 = " - \" + e_";
  protected final String TEXT_90 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_91 = NL + "\t\t\tSystem.err.println(e_";
  protected final String TEXT_92 = ".getMessage());" + NL + "\t\t";
  protected final String TEXT_93 = NL + "\t}finally{" + NL + "\t\tif(conn_";
  protected final String TEXT_94 = " !=null){" + NL + "\t\t\tconn_";
  protected final String TEXT_95 = ".shutdown();" + NL + "\t\t}" + NL + "\t\t";
