...
public class TSybaseBulkExecBeginJava {
  ...
  protected final String TEXT_428 = NL + NL + "StringBuilder command_";
  protected final String TEXT_429 = " =  new StringBuilder();" + NL + "command_";
  protected final String TEXT_430 = ".append(";
  protected final String TEXT_431 = " + \" \");";
  protected final String TEXT_432 = NL + "    String tmpTableName_";
  protected final String TEXT_433 = " = tableName_";
  protected final String TEXT_434 = ";" + NL + "    tableName_";
  protected final String TEXT_435 = " = \"tmp_";
  protected final String TEXT_436 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "    if(dbschema_";
  protected final String TEXT_437 = " != null && dbschema_";
  protected final String TEXT_438 = ".trim().length() != 0) {" + NL + "    \ttableName_";
  protected final String TEXT_439 = "=dbschema_";
  protected final String TEXT_440 = " + \".\" + tableName_";
  protected final String TEXT_441 = ";" + NL + "    }";
  protected final String TEXT_442 = NL + "if(dbschema_";
  protected final String TEXT_443 = " != null && dbschema_";
  protected final String TEXT_444 = ".trim().length() > 0) {" + NL + "    command_";
  protected final String TEXT_445 = ".append(db_";
  protected final String TEXT_446 = " + \".\" + tableName_";
  protected final String TEXT_447 = ");" + NL + "} else {" + NL + "    command_";
  protected final String TEXT_448 = ".append(db_";
  protected final String TEXT_449 = " + \"..\" + tableName_";
  protected final String TEXT_450 = ");" + NL + "}" + NL + "command_";
  protected final String TEXT_451 = ".append(\" in \" + ";
  protected final String TEXT_452 = ");" + NL + "String headRow_";
  protected final String TEXT_453 = " = ";
  protected final String TEXT_454 = ";" + NL + "if(headRow_";
  protected final String TEXT_455 = " != null && headRow_";
  protected final String TEXT_456 = ".trim().length() > 0) {" + NL + "    command_";
  protected final String TEXT_457 = ".append(\" -F \" + headRow_";
  protected final String TEXT_458 = ");" + NL + "}" + NL;
  protected final String TEXT_459 = NL + "\tcommand_";
  protected final String TEXT_460 = ".append(\" -b \" + ";
  protected final String TEXT_461 = ");";
  protected final String TEXT_462 = NL + NL + "command_";
  protected final String TEXT_463 = ".append(\" -t \" + ";
  protected final String TEXT_464 = ");" + NL + "command_";
  protected final String TEXT_465 = ".append(\" -r \" + ";
  protected final String TEXT_466 = ");" + NL + "command_";
  protected final String TEXT_467 = ".append(\" -c -U \" + dbUser_";
  protected final String TEXT_468 = " + \" -P \" + dbPwd_";
  protected final String TEXT_469 = ");";
  protected final String TEXT_470 = NL + "command_";
  protected final String TEXT_471 = ".append(\" -I \" + ";
  protected final String TEXT_472 = ");";
  protected final String TEXT_473 = NL + "    command_";
  protected final String TEXT_474 = ".append(\" -S \" + ";
  protected final String TEXT_475 = ");";
  protected final String TEXT_476 = NL + "\tcommand_";
  protected final String TEXT_477 = ".append(\" -S \" + host_";
  protected final String TEXT_478 = ");";
  protected final String TEXT_479 = NL + "String encoding_";
  protected final String TEXT_480 = " = ";
  protected final String TEXT_481 = ";" + NL + "if(encoding_";
  protected final String TEXT_482 = " != null && encoding_";
  protected final String TEXT_483 = ".trim().length() > 0) {" + NL + "    command_";
  protected final String TEXT_484 = ".append(\" -J \" + encoding_";
  protected final String TEXT_485 = ");" + NL + "}" + NL;
  protected final String TEXT_486 = NL + "\tlog.info(\"";
  protected final String TEXT_487 = " - Executing command:'\" + command_";
  protected final String TEXT_488 = " + \"'.\");";
  protected final String TEXT_489 = NL + "    Runtime runtime_";
  protected final String TEXT_490 = " = Runtime.getRuntime();" + NL + "    final Process ps_";
  protected final String TEXT_491 = " = runtime_";
  protected final String TEXT_492 = ".exec(command_";
  protected final String TEXT_493 = ".toString());";
  protected final String TEXT_494 = NL + "        java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_495 = " = conn_";
  protected final String TEXT_496 = ".createStatement();";
  protected final String TEXT_497 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_498 = " - Creating temp table ";
  protected final String TEXT_499 = "\" + tableName_";
  protected final String TEXT_500 = " + \"";
  protected final String TEXT_501 = ".\" );" + NL + "\t\t";
  protected final String TEXT_502 = NL + "        stmtCreateTmp_";
  protected final String TEXT_503 = ".execute(\"";
  protected final String TEXT_504 = ")\");" + NL + "        stmtCreateTmp_";
  protected final String TEXT_505 = ".close();            ";
  protected final String TEXT_506 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_507 = " - Create temp table ";
  protected final String TEXT_508 = "\" + tableName_";
  protected final String TEXT_509 = " + \"";
  protected final String TEXT_510 = " has succeeded.\");" + NL + "\t\t";
  protected final String TEXT_511 = NL + "        Runtime runtime_";
  protected final String TEXT_512 = " = Runtime.getRuntime();" + NL + "        final Process ps_";
  protected final String TEXT_513 = " = runtime_";
  protected final String TEXT_514 = ".exec(command_";
  protected final String TEXT_515 = ".toString());       ";
  protected final String TEXT_516 = NL + NL + "Thread normal_";
  protected final String TEXT_517 = " = new Thread() {" + NL + "\tpublic void run() {" + NL + "\t\ttry {" + NL + "\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps_";
  protected final String TEXT_518 = ".getInputStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t    ";
  protected final String TEXT_519 = NL + "\t\t\t\t        System.out.println(line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_520 = NL + "\t\t\t\t        globalMap.put(\"";
  protected final String TEXT_521 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_522 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_523 = NL + "\t\t\t\t}" + NL + "\t\t\t} finally {" + NL + "\t\t\t\treader.close();" + NL + "\t\t\t}" + NL + "\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\t";
  protected final String TEXT_524 = NL + "\t\t\tioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "normal_";
  protected final String TEXT_525 = ".start();" + NL + "" + NL + "Thread error_";
  protected final String TEXT_526 = " = new Thread() {" + NL + "\tpublic void run() {" + NL + "\t\ttry {" + NL + "\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps_";
  protected final String TEXT_527 = ".getErrorStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t    ";
  protected final String TEXT_528 = NL + "\t\t\t\t        System.err.println(line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_529 = NL + "\t\t\t\t        globalMap.put(\"";
  protected final String TEXT_530 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_531 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_532 = NL + "\t\t\t\t}" + NL + "\t\t\t} finally {" + NL + "\t\t\t\treader.close();" + NL + "\t\t\t}" + NL + "\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\t";
  protected final String TEXT_533 = NL + "\t\t\tioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "error_";
  protected final String TEXT_534 = ".start();" + NL + "" + NL + "ps_";
  protected final String TEXT_535 = ".waitFor();" + NL + "normal_";
  protected final String TEXT_536 = ".interrupt();" + NL + "error_";
  protected final String TEXT_537 = ".interrupt();";
  protected final String TEXT_538 = NL + "\tlog.info(\"";
  protected final String TEXT_539 = " - Excute command: '\" + command_";
  protected final String TEXT_540 = " + \"' has finished.\");";
