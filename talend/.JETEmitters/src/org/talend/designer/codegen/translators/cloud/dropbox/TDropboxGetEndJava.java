...
public class TDropboxGetEndJava
{
  protected static String nl;
  public static synchronized TDropboxGetEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TDropboxGetEndJava result = new TDropboxGetEndJava();
    nl = null;
    return result;
  }
