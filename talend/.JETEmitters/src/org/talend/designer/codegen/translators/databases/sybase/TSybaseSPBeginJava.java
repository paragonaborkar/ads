...
public class TSybaseSPBeginJava
{
  ...
  protected final String TEXT_61 = " = \"jdbc:sybase:Tds:\" + ";
  ...
  protected final String TEXT_75 = NL + "    java.sql.Connection connection_";
  protected final String TEXT_76 = " = java.sql.DriverManager.getConnection(connectionString_";
  protected final String TEXT_77 = ", ";
  protected final String TEXT_78 = ", decryptedPassword_";
  protected final String TEXT_79 = ");" + NL + "\t";
  protected final String TEXT_80 = NL + NL + "\tString dbschema_";
  protected final String TEXT_81 = "= ";
  protected final String TEXT_82 = "; ";
  protected final String TEXT_83 = NL + "String spName_";
  protected final String TEXT_84 = " = ";
  protected final String TEXT_85 = ";" + NL + "if(dbschema_";
  protected final String TEXT_86 = " != null && dbschema_";
  protected final String TEXT_87 = ".trim().length() != 0) {" + NL + "\tspName_";
  protected final String TEXT_88 = " = dbschema_";
  protected final String TEXT_89 = " + \".\" + spName_";
  protected final String TEXT_90 = ";" + NL + "} ";
  protected final String TEXT_91 = NL + "java.sql.PreparedStatement statement_";
  protected final String TEXT_92 = " = connection_";
  protected final String TEXT_93 = ".prepareStatement(\"select \" + spName_";
  protected final String TEXT_94 = " + \"(";
  protected final String TEXT_95 = NL + "java.sql.CallableStatement statement_";
  protected final String TEXT_96 = " = connection_";
  protected final String TEXT_97 = ".prepareCall(\"{call \" + ";
  ...
  protected final String TEXT_104 = NL + "    statement_";
  protected final String TEXT_105 = ".setQueryTimeout(";
  protected final String TEXT_106 = ");";
  protected final String TEXT_107 = NL + NL + "java.sql.Date tmpDate_";
  protected final String TEXT_108 = ";" + NL + "String tmpString_";
