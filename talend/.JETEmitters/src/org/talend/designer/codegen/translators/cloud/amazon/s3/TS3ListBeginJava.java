...
public class TS3ListBeginJava
{
  ...
  protected final String TEXT_178 = NL + NL + "\tint nb_bucket_";
  protected final String TEXT_179 = " = 0;" + NL + "\tint nb_bucket_object_";
  protected final String TEXT_180 = " = 0;" + NL + "\ttry{" + NL + "\t\t";
  ...
  protected final String TEXT_183 = ".listBuckets();" + NL + "\t\t\tfor (com.amazonaws.services.s3.model.Bucket bucket_";
  protected final String TEXT_184 = " : buckets_";
  protected final String TEXT_185 = ") {" + NL + "\t\t\t\tString currentBucketName_";
  protected final String TEXT_186 = " = bucket_";
  protected final String TEXT_187 = ".getName();" + NL + "\t\t\t\t";
  protected final String TEXT_188 = NL + "\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_189 = " - Retrieving objects from:\" + currentBucketName_";
  protected final String TEXT_190 = " + \".\");" + NL + "\t\t\t\t";
  protected final String TEXT_191 = NL + "\t\t\t\tcom.amazonaws.services.s3.model.ObjectListing objects_";
  protected final String TEXT_192 = " = null;" + NL + "\t\t\t\ttry{" + NL + "\t\t\t\t\tobjects_";
  protected final String TEXT_193 = " = conn_";
  protected final String TEXT_194 = ".listObjects(currentBucketName_";
  protected final String TEXT_195 = ",";
  protected final String TEXT_196 = ");" + NL + "\t\t\t\t}catch(com.amazonaws.AmazonClientException e_";
  protected final String TEXT_197 = "){" + NL + "\t\t\t\t\t";
  protected final String TEXT_198 = NL + "\t\t\t\t\t\tlog.warn(\"";
  protected final String TEXT_199 = " - Failed to list objects from bucket \"+currentBucketName_";
  protected final String TEXT_200 = ");" + NL + "\t\t\t\t\t\tlog.warn(\"";
  protected final String TEXT_201 = " - \"+e_";
  protected final String TEXT_202 = ".getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_203 = NL + "\t\t\t\t\t\tSystem.err.println(\"WARNING: [";
  protected final String TEXT_204 = "] failed to list objects from bucket \"+currentBucketName_";
  protected final String TEXT_205 = ");" + NL + "\t\t\t\t\t\tSystem.err.println(\"WARNING: [";
  protected final String TEXT_206 = "] \"+e_";
  protected final String TEXT_207 = ".getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_208 = NL + "\t\t\t\t\tcontinue;" + NL + "\t\t\t\t}" + NL + "\t\t";
  protected final String TEXT_209 = NL + "\t\t\tjava.util.List<java.util.Map<String,String>> buckets_map_list_";
  protected final String TEXT_210 = " = new java.util.ArrayList<java.util.Map<String,String>>();" + NL + "\t\t\tjava.util.Map<String,String> bucket_prefix_map_";
  protected final String TEXT_211 = " = null;" + NL + "\t\t\tString object_prefix_";
  protected final String TEXT_212 = " = \"\";" + NL + "\t\t\t";
  protected final String TEXT_213 = NL + "\t\t\t\t\tobject_prefix_";
  protected final String TEXT_214 = " = ";
  protected final String TEXT_215 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_216 = NL + "\t\t\t\tbucket_prefix_map_";
  protected final String TEXT_217 = " = new java.util.HashMap<String,String>();" + NL + "\t\t\t\tbucket_prefix_map_";
  protected final String TEXT_218 = ".put(";
  protected final String TEXT_219 = ",object_prefix_";
  protected final String TEXT_220 = ");" + NL + "\t\t\t\tbuckets_map_list_";
  protected final String TEXT_221 = ".add(bucket_prefix_map_";
  protected final String TEXT_222 = ");" + NL + "\t\t\t\tobject_prefix_";
  protected final String TEXT_223 = " = \"\";" + NL + "\t\t\t";
  protected final String TEXT_224 = NL + "\t\t\tfor (java.util.Map<String,String> bucketMap_";
  protected final String TEXT_225 = ": buckets_map_list_";
  protected final String TEXT_226 = ") {" + NL + "\t\t\t\tString currentBucketName_";
  protected final String TEXT_227 = " = \"\";" + NL + "\t\t\t\tString currentPrefix_";
  protected final String TEXT_228 = " = \"\";" + NL + "\t\t\t\tfor(java.util.Map.Entry<String,String> entry_";
  protected final String TEXT_229 = ":bucketMap_";
  protected final String TEXT_230 = ".entrySet()){" + NL + "\t\t\t\t\tcurrentBucketName_";
  protected final String TEXT_231 = " = entry_";
  protected final String TEXT_232 = ".getKey();" + NL + "\t\t\t\t\tcurrentPrefix_";
  protected final String TEXT_233 = " = entry_";
  protected final String TEXT_234 = ".getValue();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tcom.amazonaws.services.s3.model.ObjectListing objects_";
  protected final String TEXT_235 = " = null;" + NL + "\t\t\t\ttry{" + NL + "\t\t\t\t\t";
  protected final String TEXT_236 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_237 = " - Retrieving objects from:\" + currentBucketName_";
  protected final String TEXT_238 = " + \".\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_239 = NL + "\t\t\t\t\tobjects_";
  protected final String TEXT_240 = " = conn_";
  protected final String TEXT_241 = ".listObjects(currentBucketName_";
  protected final String TEXT_242 = ",currentPrefix_";
  protected final String TEXT_243 = ");" + NL + "\t\t\t\t}catch(com.amazonaws.AmazonClientException e_";
  protected final String TEXT_244 = "){" + NL + "\t\t\t\t\t";
  protected final String TEXT_245 = NL + "\t\t\t\t\t\tlog.warn(\"";
  protected final String TEXT_246 = " - Failed to list objects from bucket \"+currentBucketName_";
  protected final String TEXT_247 = ");" + NL + "\t\t\t\t\t\tlog.warn(\"";
  protected final String TEXT_248 = " - \"+e_";
  protected final String TEXT_249 = ".getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_250 = NL + "\t\t\t\t\t\tSystem.err.println(\"WARNING: [";
  protected final String TEXT_251 = "] failed to list objects from bucket \"+currentBucketName_";
  protected final String TEXT_252 = ");" + NL + "\t\t\t\t\t\tSystem.err.println(\"WARNING: [";
  protected final String TEXT_253 = "] \"+e_";
  protected final String TEXT_254 = ".getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_255 = NL + "\t\t\t\t\tcontinue;" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_256 = NL + "\t\t\t\twhile(true){" + NL + "\t\t\t\t\tjava.util.List<com.amazonaws.services.s3.model.S3ObjectSummary> list_objects_";
  protected final String TEXT_257 = " = objects_";
  protected final String TEXT_258 = ".getObjectSummaries();" + NL + "\t\t\t\t\tif(list_objects_";
  protected final String TEXT_259 = ".size()>0){" + NL + "\t\t\t\t\t\tnb_bucket_";
  protected final String TEXT_260 = "++;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\tfor (com.amazonaws.services.s3.model.S3ObjectSummary objectSummary_";
  protected final String TEXT_261 = " : list_objects_";
  protected final String TEXT_262 = ") {" + NL + "\t\t\t\t\t\tnb_bucket_object_";
  protected final String TEXT_263 = "++;" + NL + "\t\t\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_264 = "_CURRENT_BUCKET\", currentBucketName_";
  protected final String TEXT_265 = ");" + NL + "\t\t\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_266 = "_CURRENT_KEY\", objectSummary_";
  protected final String TEXT_267 = ".getKey());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_268 = NL + "\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_269 = " - Retrieving the object \" + nb_bucket_object_";
  protected final String TEXT_270 = " + \".\");" + NL + "\t\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_271 = " - Key of current object : \" + objectSummary_";
  protected final String TEXT_272 = ".getKey());" + NL + "\t\t\t\t\t\t";
