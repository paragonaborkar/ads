...
public class TAggregateInBeginJava
{
  ...
  protected final String TEXT_45 = NL + "java.util.Collection<AggOperationStruct_";
  protected final String TEXT_46 = "> values_";
  protected final String TEXT_47 = " = hash_";
  protected final String TEXT_48 = ".values();" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_49 = "_NB_LINE\", values_";
  protected final String TEXT_50 = ".size());" + NL;
  protected final String TEXT_51 = NL + "for(AggOperationStruct_";
  protected final String TEXT_52 = " aggregated_row_";
  protected final String TEXT_53 = " : values_";
  protected final String TEXT_54 = ") { // G_AggR_600" + NL + NL;
