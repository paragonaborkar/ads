...
public class TEXAOutputBeginJava {
  ...
  protected final String TEXT_61 = NL + "// schema is mandatory" + NL + "String tableName_";
  ...
  protected final String TEXT_99 = ").getConnection();" + NL + "\t\t} else {";
  protected final String TEXT_100 = NL + "    java.lang.Class.forName(\"com.exasol.jdbc.EXADriver\");" + NL + "    String url_";
  protected final String TEXT_101 = " = \"jdbc:exa:\" + ";
  protected final String TEXT_102 = " + \":\" + ";
  protected final String TEXT_103 = " + \";schema=\" + ";
  ...
  protected final String TEXT_128 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  ...
  protected final String TEXT_144 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  ...
  protected final String TEXT_151 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_159 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_160 = ".";
  protected final String TEXT_161 = ", \"";
  protected final String TEXT_162 = "\")";
  protected final String TEXT_163 = ".toUpperCase()";
  ...
  protected final String TEXT_175 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_176 = "));";
  protected final String TEXT_177 = NL + "                    stmtCreate_";
  protected final String TEXT_178 = ".execute(((\"";
  protected final String TEXT_179 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_208 = NL + "                                java.sql.Statement isExistStmt_";
  protected final String TEXT_209 = " = conn_";
  protected final String TEXT_210 = ".createStatement();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_211 = " = false;" + NL + "                                try {" + NL + "                                    isExistStmt_";
  protected final String TEXT_212 = ".execute(\"SELECT TOP 1 1 FROM [\" + tableName_";
  protected final String TEXT_213 = " + \"]\" );" + NL + "                                    whetherExist_";
  protected final String TEXT_214 = " = true;" + NL + "                                } catch (java.lang.Exception e){" + NL + "                                    whetherExist_";
  protected final String TEXT_215 = " = false;" + NL + "                                }" + NL + "                                isExistStmt_";
  ...
  protected final String TEXT_225 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_226 = " = dbMetaData_";
  protected final String TEXT_227 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_228 = ", tableNameForSearch_";
  protected final String TEXT_229 = ", new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_230 = " = false;" + NL + "                                if(rsTable_";
  protected final String TEXT_231 = ".next()) {" + NL + "                                    whetherExist_";
  protected final String TEXT_232 = " = true;" + NL + "                                }" + NL + "                                rsTable_";
  ...
  protected final String TEXT_253 = ".trim().length() ==0)) {" + NL + "                                        whetherExist_";
  ...
  protected final String TEXT_287 = " = false;" + NL + "                                String defaultSchema_";
  protected final String TEXT_288 = " = \"public\";" + NL + "                                if(dbschema_";
  protected final String TEXT_289 = " == null || dbschema_";
  protected final String TEXT_290 = ".trim().length() == 0) {" + NL + "                                    java.sql.Statement stmtSchema_";
  protected final String TEXT_291 = " = conn_";
  protected final String TEXT_292 = ".createStatement();" + NL + "                                    java.sql.ResultSet rsSchema_";
  protected final String TEXT_293 = " = stmtSchema_";
  protected final String TEXT_294 = ".executeQuery(\"select current_schema() \");" + NL + "                                    while(rsSchema_";
  protected final String TEXT_295 = ".next()){" + NL + "                                        defaultSchema_";
  protected final String TEXT_296 = " = rsSchema_";
  protected final String TEXT_297 = ".getString(\"current_schema\");" + NL + "                                    }" + NL + "                                    rsSchema_";
  protected final String TEXT_298 = ".close();" + NL + "                                    stmtSchema_";
  protected final String TEXT_299 = ".close();" + NL + "                                }" + NL + "                                while(rsTable_";
  ...
  protected final String TEXT_313 = " ==null || dbschema_";
  protected final String TEXT_314 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_315 = ".equals";
  protected final String TEXT_316 = "IgnoreCase";
  protected final String TEXT_317 = "(schema_";
  ...
  protected final String TEXT_321 = NL + "\t\t\t\t            \tString tableForSearch_";
  protected final String TEXT_322 = " = ";
  protected final String TEXT_323 = ";" + NL + "\t\t\t\t            \tif(tableForSearch_";
  protected final String TEXT_324 = " != null){" + NL + "\t\t\t\t            \t\tif(tableForSearch_";
  protected final String TEXT_325 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_326 = ".endsWith(\"\\\"\")){" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_327 = " =  tableForSearch_";
  protected final String TEXT_328 = ".substring(1,tableForSearch_";
  protected final String TEXT_329 = ".length()-1);" + NL + "\t\t\t\t            \t\t}else{" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_330 = " =  tableForSearch_";
  protected final String TEXT_331 = ".toUpperCase();" + NL + "\t\t\t\t            \t\t}" + NL + "\t\t\t\t            \t}" + NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_335 = ".getTables(null, conn_";
  protected final String TEXT_336 = ".getSchema(), tableForSearch_";
  protected final String TEXT_337 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_338 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_339 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_340 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  ...
  protected final String TEXT_344 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_345 = " = dbMetaData_";
  protected final String TEXT_346 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_347 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  ...
  protected final String TEXT_368 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_421 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_422 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_436 = NL + "                              stmtTruncCount_";
  protected final String TEXT_437 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_438 = "));";
  protected final String TEXT_439 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_440 = " = stmtTruncCount_";
  protected final String TEXT_441 = ".executeQuery(\"";
  protected final String TEXT_442 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_443 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_444 = ".next()) {" + NL + "                rsTruncCountNumber_";
  protected final String TEXT_445 = " = rsTruncCount_";
  protected final String TEXT_446 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_447 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_448 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_454 = NL + "                conn_";
  protected final String TEXT_455 = ".commit();";
  protected final String TEXT_456 = NL + "            stmtTrunc_";
  protected final String TEXT_457 = ".executeUpdate(\"";
  protected final String TEXT_458 = "\");";
  protected final String TEXT_459 = NL + "                if(!conn_";
  protected final String TEXT_460 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_461 = ".commit();" + NL + "                }";
  protected final String TEXT_462 = NL + "            deletedCount_";
  protected final String TEXT_463 = " += rsTruncCountNumber_";
  ...
  protected final String TEXT_484 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_552 = NL + "\t\t\tupdate_";
  protected final String TEXT_553 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_554 = " = update_";
  protected final String TEXT_555 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_556 = " = insert_";
  protected final String TEXT_557 = ".split(\"\\\\?\");";
  protected final String TEXT_558 = NL + "\t\t\tdelete_";
  protected final String TEXT_559 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_560 = " = delete_";
  protected final String TEXT_561 = ".split(\"\\\\?\");";
  protected final String TEXT_562 = NL + "\t\t\treplace_";
  protected final String TEXT_563 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_564 = " = replace_";
  protected final String TEXT_565 = ".split(\"\\\\?\");";
  protected final String TEXT_566 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_567 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_568 = " = insertIgnore_";
