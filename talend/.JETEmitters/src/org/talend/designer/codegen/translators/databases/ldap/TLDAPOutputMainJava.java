...
public class TLDAPOutputMainJava
{
  ...
  protected final String TEXT_179 = ",baseDN_";
  ...
  protected final String TEXT_188 = " - \" + nfEx_";
  protected final String TEXT_189 = ".getMessage());" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_190 = NL + "\t\t\t\t\t\t\tctx_";
  protected final String TEXT_191 = ".createSubcontext(dn_";
  protected final String TEXT_192 = ", entry_";
  protected final String TEXT_193 = ");" + NL + "\t\t\t\t\t\t\tnb_line_";
  protected final String TEXT_194 = " ++;" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\tif(found)" + NL + "\t\t\t\t\t\t{" + NL + "\t\t\t\t\t\t\tctx_";
  protected final String TEXT_195 = ".modifyAttributes(dn_";
  protected final String TEXT_196 = ", javax.naming.directory.DirContext.REPLACE_ATTRIBUTE, entry_";
  protected final String TEXT_197 = ");" + NL + "\t\t\t\t\t\t\tnb_line_";
  protected final String TEXT_198 = " ++;" + NL + "\t\t\t\t\t\t}";
  protected final String TEXT_199 = NL + "\t}catch(java.lang.Exception e){" + NL + "        whetherReject_";
  ...
  protected final String TEXT_217 = " - \" + e.getMessage());";
