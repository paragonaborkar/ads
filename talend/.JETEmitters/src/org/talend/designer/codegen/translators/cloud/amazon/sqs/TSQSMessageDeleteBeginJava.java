...
public class TSQSMessageDeleteBeginJava
{
  protected static String nl;
  public static synchronized TSQSMessageDeleteBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSQSMessageDeleteBeginJava result = new TSQSMessageDeleteBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_77 = " - Deleting a message with recipet handle:\" + ";
  protected final String TEXT_78 = ");" + NL + "\t\t";
  protected final String TEXT_79 = NL + "        conn_";
  protected final String TEXT_80 = ".deleteMessage(new com.amazonaws.services.sqs.model.DeleteMessageRequest(";
  protected final String TEXT_81 = ",";
  protected final String TEXT_82 = "));" + NL + "        " + NL + "\t\t";
  protected final String TEXT_83 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_84 = " - Delete the message successfully.\");" + NL + "\t\t";
  protected final String TEXT_85 = NL + "\t}catch(java.lang.Exception e_";
  protected final String TEXT_86 = "){" + NL + "\t\t";
  protected final String TEXT_87 = NL + "\t\t\tthrow(e_";
  ...
  protected final String TEXT_94 = NL + "\t}finally{" + NL + "\t\tif(conn_";
  protected final String TEXT_95 = " !=null){" + NL + "\t\t\tconn_";
  protected final String TEXT_96 = ".shutdown();" + NL + "\t\t}" + NL + "\t\t";
