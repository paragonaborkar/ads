...
public class TPostgresqlOutputMainJava {
  ...
  protected final String TEXT_1099 = NL + "                \t    String errormessage_";
  protected final String TEXT_1100 = " = printSQLException_";
  protected final String TEXT_1101 = ".getSQLException(e,true);" + NL + "                \t    ";
  protected final String TEXT_1102 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_1103 = NL + "                \tString errormessage_";
  protected final String TEXT_1104 = " = printSQLException_";
  protected final String TEXT_1105 = ".getSQLException(e,false);" + NL + "                \tint countSum_";
  protected final String TEXT_1106 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1107 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1108 = " += (countEach_";
  protected final String TEXT_1109 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1110 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_1111 = NL + "\t\t\t    \t\tinsertedCount_";
  protected final String TEXT_1112 = " += countSum_";
  protected final String TEXT_1113 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_1114 = NL + "\t\t\t    \t\tupdatedCount_";
  protected final String TEXT_1115 = " += countSum_";
  protected final String TEXT_1116 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_1117 = NL + "\t\t\t    \t    deletedCount_";
  protected final String TEXT_1118 = " += countSum_";
  protected final String TEXT_1119 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_1120 = NL + "                }" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_1121 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_1122 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_1123 = " <= commitCounter_";
  protected final String TEXT_1124 = ") {";
  protected final String TEXT_1125 = NL + "                if ((batchSize_";
  protected final String TEXT_1126 = " > 0) && (batchSizeCounter_";
  protected final String TEXT_1127 = " > 0)) {" + NL + "                try {" + NL + "                \t\tint countSum_";
  protected final String TEXT_1128 = " = 0;" + NL + "                \t\t    ";
  protected final String TEXT_1129 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1130 = ": pstmt_";
  protected final String TEXT_1131 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1132 = " += (countEach_";
  protected final String TEXT_1133 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1134 = ");" + NL + "\t\t\t\t\t\t}";
  protected final String TEXT_1135 = NL + "            \t    \t";
  protected final String TEXT_1136 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_1137 = " += countSum_";
  protected final String TEXT_1138 = ";" + NL + "            \t    \t";
  protected final String TEXT_1139 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_1140 = " += countSum_";
  protected final String TEXT_1141 = ";" + NL + "            \t    \t";
  protected final String TEXT_1142 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_1143 = " += countSum_";
  protected final String TEXT_1144 = ";" + NL + "            \t    \t";
  protected final String TEXT_1145 = NL + "                batchSizeCounter_";
  protected final String TEXT_1146 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_1147 = NL + "                \t    String errormessage_";
  protected final String TEXT_1148 = " = printSQLException_";
  protected final String TEXT_1149 = ".getSQLException(e,true);" + NL + "                \t    ";
  protected final String TEXT_1150 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_1151 = NL + "                \t    String errormessage_";
  protected final String TEXT_1152 = " = printSQLException_";
  protected final String TEXT_1153 = ".getSQLException(e,false);" + NL + "                \t\tint countSum_";
  protected final String TEXT_1154 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1155 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1156 = " += (countEach_";
  protected final String TEXT_1157 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1158 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1159 = NL + "\t\t\t\t    \t\tinsertedCount_";
  protected final String TEXT_1160 = " += countSum_";
  protected final String TEXT_1161 = ";" + NL + "\t\t\t\t    \t";
  protected final String TEXT_1162 = NL + "\t\t\t\t    \t\tupdatedCount_";
  protected final String TEXT_1163 = " += countSum_";
  protected final String TEXT_1164 = ";" + NL + "\t\t\t\t    \t";
  protected final String TEXT_1165 = NL + "\t\t\t\t    \t    deletedCount_";
  protected final String TEXT_1166 = " += countSum_";
  protected final String TEXT_1167 = ";" + NL + "\t\t\t\t    \t";
  protected final String TEXT_1168 = NL + "                }" + NL + "            }";
  protected final String TEXT_1169 = NL + "                \tconn_";
  protected final String TEXT_1170 = ".commit();" + NL + "                \t";
  protected final String TEXT_1171 = NL + "                \tcommitCounter_";
