...
public class TS3DeleteBeginJava
{
  ...
  protected final String TEXT_178 = NL + "\ttry{" + NL + "\t\tString key_";
  protected final String TEXT_179 = " = ";
  protected final String TEXT_180 = ";" + NL + "\t\tif(key_";
  protected final String TEXT_181 = "!=null && key_";
  protected final String TEXT_182 = ".trim().length()>0){" + NL + "\t\t\t";
  protected final String TEXT_183 = "\t" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_184 = " - Deleting an object with key:\" + ";
  protected final String TEXT_185 = ");" + NL + "\t\t\t";
  protected final String TEXT_186 = NL + "\t\t\tconn_";
  protected final String TEXT_187 = ".deleteObject(";
  protected final String TEXT_188 = ", key_";
  protected final String TEXT_189 = ");" + NL + "\t\t\t";
  protected final String TEXT_190 = "\t" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_191 = " - Delete the object successfully.\");" + NL + "\t\t\t";
  protected final String TEXT_192 = NL + "\t\t}else{" + NL + "\t\t\tthrow(new RuntimeException(\"Please set key!\"));" + NL + "\t\t}" + NL + "\t}catch(java.lang.Exception e_";
