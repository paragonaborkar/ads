...
public class TFileOutputMSDelimitedBeginJava
{
  ...
  protected final String TEXT_31 = ".setSeparator(";
  protected final String TEXT_32 = ");" + NL + " ";
  protected final String TEXT_33 = NL + "String row_";
  protected final String TEXT_34 = " = ";
  protected final String TEXT_35 = ";" + NL + "if(row_";
  protected final String TEXT_36 = ".length() > 0){" + NL + "\tout";
  protected final String TEXT_37 = ".setLineEnd(\"\"+row_";
  protected final String TEXT_38 = ".charAt(0));" + NL + "}else{" + NL + "\tthrow new IllegalArgumentException(\"Row delimited must be assigned a char.\");" + NL + "}" + NL + "" + NL + "String escapeChar_";
  protected final String TEXT_39 = " = ";
  protected final String TEXT_40 = ";" + NL + "if(escapeChar_";
  protected final String TEXT_41 = ".length() <= 0){" + NL + "\tthrow new IllegalArgumentException(\"Escape Char must be assigned a char.\");" + NL + "}" + NL + "" + NL + "String textEnclosure_";
  protected final String TEXT_42 = " = ";
  protected final String TEXT_43 = ";" + NL + "if(textEnclosure_";
  protected final String TEXT_44 = ".length() > 0){" + NL + "\tout";
  protected final String TEXT_45 = ".setQuoteChar(textEnclosure_";
  protected final String TEXT_46 = ".charAt(0));" + NL + "}else{" + NL + "\tthrow new IllegalArgumentException(\"Text Enclosure must be assigned a char.\");" + NL + "}" + NL + "" + NL + "if ((\"\\\\\\\\\").equals(escapeChar_";
  protected final String TEXT_47 = ")) {" + NL + "\tout";
  protected final String TEXT_48 = ".setEscapeChar('\\\\');" + NL + "} else if (escapeChar_";
  protected final String TEXT_49 = ".equals(textEnclosure_";
  protected final String TEXT_50 = ")) {" + NL + "\tout";
  protected final String TEXT_51 = ".setEscapeChar(textEnclosure_";
  protected final String TEXT_52 = ".charAt(0));" + NL + "} else {" + NL + "\tout";
  protected final String TEXT_53 = ".setEscapeChar(textEnclosure_";
  protected final String TEXT_54 = ".charAt(0));" + NL + "}" + NL + "out";
  protected final String TEXT_55 = ".setQuoteStatus(com.talend.csv.CSVWriter.QuoteStatus.FORCE);" + NL;
  protected final String TEXT_56 = NL;
  protected final String TEXT_57 = NL + "\tjava.util.List<";
  protected final String TEXT_58 = "Struct> ";
  protected final String TEXT_59 = "List_";
  protected final String TEXT_60 = " = new java.util.ArrayList<";
  protected final String TEXT_61 = "Struct>();";
  protected final String TEXT_62 = NL + "\torg.talend.commons.utils.data.map.MultiLazyValuesMap ";
  protected final String TEXT_63 = "Map_";
  protected final String TEXT_64 = " = new org.talend.commons.utils.data.map.MultiLazyValuesMap(" + NL + "                    new java.util.HashMap()) {" + NL + "" + NL + "                public java.util.Collection instanciateNewCollection() {" + NL + "                    return new org.apache.commons.collections.list.GrowthList(3);" + NL + "                }" + NL + "" + NL + "            };" + NL + "   final ";
  protected final String TEXT_65 = "Struct[] EMPTY_ARRAY_";
  protected final String TEXT_66 = "_";
  protected final String TEXT_67 = " = new ";
  protected final String TEXT_68 = "Struct[0];";
