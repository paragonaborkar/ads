...
public class TMDMRollbackMainJava
{
  ...
  protected final String TEXT_45 = NL + NL + "String transKey_";
  protected final String TEXT_46 = " = \"";
  protected final String TEXT_47 = "_\" + Thread.currentThread().getThreadGroup().getName();" + NL + "com.talend.mdm.transaction.client.MDMTransaction mdmTransaction_";
  protected final String TEXT_48 = " = (com.talend.mdm.transaction.client.MDMTransaction)globalMap.get(transKey_";
  protected final String TEXT_49 = ");" + NL + "if(mdmTransaction_";
  protected final String TEXT_50 = " != null) {";
  protected final String TEXT_51 = NL + "    mdmTransaction_";
  protected final String TEXT_52 = ".rollback();";
  protected final String TEXT_53 = NL + "}" + NL;
  protected final String TEXT_54 = NL + "    String connKey_";
  protected final String TEXT_55 = " = \"";
  protected final String TEXT_56 = "_\" + Thread.currentThread().getThreadGroup().getName();" + NL + "    org.talend.mdm.webservice.TMDMService service_";
  protected final String TEXT_57 = " = (org.talend.mdm.webservice.TMDMService)globalMap.get(connKey_";
  protected final String TEXT_58 = ");" + NL + "    if(service_";
  protected final String TEXT_59 = " != null) {" + NL + "        service_";
  protected final String TEXT_60 = ".logout(new org.talend.mdm.webservice.WSLogout());";
