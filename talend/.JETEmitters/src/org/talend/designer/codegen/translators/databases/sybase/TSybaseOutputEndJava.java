...
public class TSybaseOutputEndJava
{
  ...
  protected final String TEXT_101 = NL + "        stmt_";
  protected final String TEXT_102 = ".execute(\"SET IDENTITY_INSERT \"+ ";
  protected final String TEXT_103 = " +\" OFF\");" + NL + "        stmt_";
  ...
  protected final String TEXT_112 = NL + "        resourceMap.put(\"finish_";
