...
public class TEXARollbackMainJava
{
  protected static String nl;
  public static synchronized TEXARollbackMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TEXARollbackMainJava result = new TEXARollbackMainJava();
    nl = null;
    return result;
  }
