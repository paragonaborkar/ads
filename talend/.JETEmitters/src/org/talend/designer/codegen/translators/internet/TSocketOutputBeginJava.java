...
public class TSocketOutputBeginJava
{
  ...
  protected final String TEXT_16 = ");" + NL + "        }" + NL + "    }" + NL + "}" + NL + "    " + NL + "com.talend.csv.CSVWriter CsvWriter";
  protected final String TEXT_17 = " = " + NL + "   new com.talend.csv.CSVWriter(" + NL + "      new java.io.BufferedWriter(new java.io.OutputStreamWriter(socket";
  protected final String TEXT_18 = ".getOutputStream(),";
  protected final String TEXT_19 = ")));" + NL + "CsvWriter";
  protected final String TEXT_20 = ".setSeparator('";
