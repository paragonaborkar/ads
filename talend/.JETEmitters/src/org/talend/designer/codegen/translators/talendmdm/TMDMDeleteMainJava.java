...
public class TMDMDeleteMainJava
{
  ...
  protected final String TEXT_45 = NL + "List<String> wsIds_";
  protected final String TEXT_46 = " = new java.util.ArrayList<String>();" + NL + "{";
  protected final String TEXT_47 = NL + "    wsIds_";
  protected final String TEXT_48 = ".add(";
  protected final String TEXT_49 = ".";
  protected final String TEXT_50 = ");";
  protected final String TEXT_51 = "};" + NL + "org.talend.mdm.webservice.WSItemPK wsPK_";
  protected final String TEXT_52 = " = new org.talend.mdm.webservice.WSItemPK(";
  protected final String TEXT_53 = ", wsIds_";
  protected final String TEXT_54 = ", dataCluster_";
  protected final String TEXT_55 = ");" + NL + "///////////////////////" + NL + "" + NL + "try{";
  protected final String TEXT_56 = NL + "        org.talend.mdm.webservice.WSDropItem item_";
  protected final String TEXT_57 = " = new org.talend.mdm.webservice.WSDropItem();" + NL + "        item_";
  protected final String TEXT_58 = ".setPartPath(";
  protected final String TEXT_59 = ");";
  protected final String TEXT_60 = NL + "        org.talend.mdm.webservice.WSDeleteItem item_";
  protected final String TEXT_61 = " = new org.talend.mdm.webservice.WSDeleteItem();";
  protected final String TEXT_62 = NL + "    item_";
  protected final String TEXT_63 = ".setWsItemPK(wsPK_";
  protected final String TEXT_64 = ");" + NL + "    item_";
  protected final String TEXT_65 = ".setOverride(false);";
  protected final String TEXT_66 = NL + "        item_";
  protected final String TEXT_67 = ".setWithReport(true);" + NL + "        item_";
  protected final String TEXT_68 = ".setSource(";
  protected final String TEXT_69 = ");" + NL + "        item_";
  protected final String TEXT_70 = ".setInvokeBeforeDeleting(";
  protected final String TEXT_71 = ");";
  protected final String TEXT_72 = NL + "        service_";
  protected final String TEXT_73 = " .dropItem(item_";
  protected final String TEXT_74 = ");";
  protected final String TEXT_75 = NL + "        service_";
  protected final String TEXT_76 = " .deleteItem(item_";
  protected final String TEXT_77 = ");";
  protected final String TEXT_78 = NL + "}catch(java.lang.Exception e){";
  protected final String TEXT_79 = NL + "    throw(e);";
  protected final String TEXT_80 = NL + "    System.err.println(e.getMessage());";
  protected final String TEXT_81 = NL + "}" + NL + "nb_line_";
  ...
  protected final String TEXT_111 = NL + "   }" + NL + "" + NL + "try{";
  ...
  protected final String TEXT_119 = ");" + NL + "}catch(java.lang.Exception e){";
