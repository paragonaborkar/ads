...
public class TSSHMainJava
{
  ...
  protected final String TEXT_61 = " - Command line standard result: \" + stringStdout_";
  protected final String TEXT_62 = ".toString());" + NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_63 = " - Command line error result: \" + stringStderr_";
  protected final String TEXT_64 = ".toString());" + NL + "\t\t";
  protected final String TEXT_65 = NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_66 = "_STDOUT\", stringStdout_";
  protected final String TEXT_67 = ".toString());";
  protected final String TEXT_68 = NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_69 = "_STDOUT\", stringStdout_";
  protected final String TEXT_70 = ".toString());";
  protected final String TEXT_71 = NL + "\t\t\toutput_";
  protected final String TEXT_72 = ".add(stringStdout_";
  protected final String TEXT_73 = ".toString());" + NL + "\t\t\tstringStdout_";
  protected final String TEXT_74 = ".delete(0,stringStdout_";
  protected final String TEXT_75 = ".length());";
  protected final String TEXT_76 = NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_77 = "_STDERR\", stringStderr_";
  protected final String TEXT_78 = ".toString());";
  protected final String TEXT_79 = NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_80 = "_STDERR\", stringStderr_";
  protected final String TEXT_81 = ".toString());";
  protected final String TEXT_82 = NL + "\t\t\toutput_";
  protected final String TEXT_83 = ".add(stringStderr_";
  protected final String TEXT_84 = ".toString());" + NL + "\t\t\tstringStderr_";
  protected final String TEXT_85 = ".delete(0, stringStderr_";
  protected final String TEXT_86 = ".length());";
  protected final String TEXT_87 = NL + "\t\t\t\tfor(String tmp_";
  protected final String TEXT_88 = ":output_";
  protected final String TEXT_89 = "){ // C_01";
  protected final String TEXT_90 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_91 = ".outputline = tmp_";
