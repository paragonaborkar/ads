...
public class FooterJava
{
  ...
  protected final String TEXT_6 = NL + NL + "    private PropertiesWithType context_param = new PropertiesWithType();" + NL + "    public java.util.Map<String, Object> parentContextMap = new java.util.HashMap<String, Object>();" + NL + "" + NL + "    public String status= \"\";" + NL + "" + NL + "    public static void main(String[] args){" + NL + "        final ";
  ...
  protected final String TEXT_68 = NL + "\t\t\t\t    context.setContextType(\"";
  protected final String TEXT_69 = "\", \"";
  protected final String TEXT_70 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_71 = NL + "            \t\tString pwd_";
  protected final String TEXT_72 = "_value = context.getProperty(\"";
  protected final String TEXT_73 = "\");" + NL + "            \t\tcontext.";
  protected final String TEXT_74 = " = null;" + NL + "            \t\tif(pwd_";
  protected final String TEXT_75 = "_value!=null) {" + NL + "            \t\t\tif(context_param.containsKey(\"";
  protected final String TEXT_76 = "\")) {//no need to decrypt if it come from program argument or parent job runtime" + NL + "            \t\t\t\tcontext.";
  protected final String TEXT_77 = " = pwd_";
  protected final String TEXT_78 = "_value;" + NL + "            \t\t\t} else if (!pwd_";
  protected final String TEXT_79 = "_value.isEmpty()) {" + NL + "            \t\t\t\ttry {" + NL + "            \t\t\t\t\tcontext.";
  protected final String TEXT_80 = " = routines.system.PasswordEncryptUtil.decryptPassword(pwd_";
  protected final String TEXT_81 = "_value);" + NL + "            \t\t\t\t\tcontext.put(\"";
  protected final String TEXT_82 = "\",context.";
  protected final String TEXT_83 = ");" + NL + "            \t\t\t\t} catch (java.lang.RuntimeException e) {" + NL + "            \t\t\t\t\t//do nothing" + NL + "            \t\t\t\t}" + NL + "            \t\t\t}" + NL + "            \t\t}";
  protected final String TEXT_84 = NL + "            try{" + NL + "                String context_";
  protected final String TEXT_85 = "_value = context.getProperty(\"";
  protected final String TEXT_86 = "\");" + NL + "                if (context_";
  protected final String TEXT_87 = "_value == null){" + NL + "                    context_";
  protected final String TEXT_88 = "_value = \"\";" + NL + "                }" + NL + "                int context_";
  protected final String TEXT_89 = "_pos = context_";
  protected final String TEXT_90 = "_value.indexOf(\";\");" + NL + "                String context_";
  protected final String TEXT_91 = "_pattern =  \"yyyy-MM-dd HH:mm:ss\";" + NL + "                if(context_";
  protected final String TEXT_92 = "_pos > -1){" + NL + "                    context_";
  protected final String TEXT_93 = "_pattern = context_";
  protected final String TEXT_94 = "_value.substring(0, context_";
  protected final String TEXT_95 = "_pos);" + NL + "                    context_";
  protected final String TEXT_96 = "_value = context_";
  protected final String TEXT_97 = "_value.substring(context_";
  protected final String TEXT_98 = "_pos + 1);" + NL + "                }" + NL + "" + NL + "                context.";
  protected final String TEXT_99 = "=(java.util.Date)(new java.text.SimpleDateFormat(context_";
  protected final String TEXT_100 = "_pattern).parse(context_";
  protected final String TEXT_101 = "_value));" + NL + "" + NL + "            }catch(ParseException e)" + NL + "            {" + NL + "                context.";
  protected final String TEXT_102 = "=null;" + NL + "            }";
  protected final String TEXT_103 = NL + "                context.";
  protected final String TEXT_104 = "=(";
  protected final String TEXT_105 = ") context.getProperty(\"";
  protected final String TEXT_106 = "\");";
  protected final String TEXT_107 = NL + "             context.";
  protected final String TEXT_108 = "= new java.text.StringCharacterIterator(context.getProperty(\"";
  protected final String TEXT_109 = "\")).first();";
  protected final String TEXT_110 = NL + "             try{" + NL + "                 context.";
  protected final String TEXT_111 = "=routines.system.ParserUtils.parseTo_";
  protected final String TEXT_112 = " (context.getProperty(\"";
  protected final String TEXT_113 = "\"));" + NL + "             }catch(NumberFormatException e){" + NL + "                 context.";
  protected final String TEXT_114 = "=null;" + NL + "              }";
  protected final String TEXT_115 = NL + "        } catch (java.io.IOException ie) {" + NL + "            System.err.println(\"Could not load context \"+contextStr);" + NL + "            ie.printStackTrace();" + NL + "        }" + NL + "" + NL + "" + NL + "        // get context value from parent directly" + NL + "        if (parentContextMap != null && !parentContextMap.isEmpty()) {";
  protected final String TEXT_116 = "if (parentContextMap.containsKey(\"";
  protected final String TEXT_117 = "\")) {" + NL + "                context.";
  protected final String TEXT_118 = " = (";
  protected final String TEXT_119 = ") parentContextMap.get(\"";
  protected final String TEXT_120 = "\");" + NL + "            }";
  protected final String TEXT_121 = NL + "        }" + NL + "" + NL + "        //Resume: init the resumeUtil" + NL + "        resumeEntryMethodName = ResumeUtil.getResumeEntryMethodName(resuming_checkpoint_path);" + NL + "        resumeUtil = new ResumeUtil(resuming_logs_dir_path, isChildJob, rootPid);" + NL + "        resumeUtil.initCommonInfo(pid, rootPid, fatherPid, projectName, jobName, contextStr, jobVersion);" + NL + "" + NL + "\t\tList<String> parametersToEncrypt = new java.util.ArrayList<String>();";
  protected final String TEXT_122 = NL + "\t\t\tparametersToEncrypt.add(\"";
  protected final String TEXT_123 = "\");";
  protected final String TEXT_124 = NL + "        //Resume: jobStart" + NL + "        resumeUtil.addLog(\"JOB_STARTED\", \"JOB:\" + jobName, parent_part_launcher, Thread.currentThread().getId() + \"\", \"\",\"\",\"\",\"\",resumeUtil.convertToJsonText(context,parametersToEncrypt));" + NL;
  ...
  protected final String TEXT_127 = NL + "    try {" + NL + "        runTrace.openSocket(!isChildJob);" + NL + "        runTrace.startThreadTrace(clientHost, portTraces);" + NL + "    } catch (java.io.IOException ioException) {" + NL + "        ioException.printStackTrace();" + NL + "    }";
  protected final String TEXT_128 = NL;
  protected final String TEXT_129 = NL;
  protected final String TEXT_130 = NL + "\t";
  protected final String TEXT_131 = NL + "\t    java.util.concurrent.ConcurrentHashMap<Object, Object> concurrentHashMap = new java.util.concurrent.ConcurrentHashMap<Object, Object>();" + NL + "\t    globalMap.put(\"concurrentHashMap\", concurrentHashMap);" + NL + "\t";
  protected final String TEXT_132 = NL + NL + "    long startUsedMemory = Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory();" + NL + "    long endUsedMemory = 0;" + NL + "    long end = 0;" + NL + "" + NL + "    startTime = System.currentTimeMillis();";
  protected final String TEXT_133 = NL + "        ";
  protected final String TEXT_134 = ".addMessage(\"begin\");";
  protected final String TEXT_135 = NL;
  protected final String TEXT_136 = NL + "    System.err.println(\"Only one hadoop configuration is allowed in one job!\");";
  protected final String TEXT_137 = NL;
  protected final String TEXT_138 = NL;
  protected final String TEXT_139 = NL;
  protected final String TEXT_140 = NL;
  protected final String TEXT_141 = NL + NL + "this.globalResumeTicket = true;//to run tPreJob" + NL;
  protected final String TEXT_142 = NL;
  protected final String TEXT_143 = NL + NL;
  protected final String TEXT_144 = NL + "        try {";
  protected final String TEXT_145 = NL + "            ";
  protected final String TEXT_146 = "Process(globalMap);" + NL + "        } catch (java.lang.Exception e) {" + NL + "            e.printStackTrace();" + NL + "        }";
  protected final String TEXT_147 = NL + NL + "this.globalResumeTicket = false;//to run others jobs" + NL;
  protected final String TEXT_148 = "final Thread launchingThread = Thread.currentThread();";
  protected final String TEXT_149 = NL + "        runningThreadCount.add(1);" + NL + "        new Thread(){" + NL + "            public void run() {" + NL + "                java.util.Map threadRunResultMap = new java.util.HashMap();" + NL + "                threadRunResultMap.put(\"errorCode\", null);" + NL + "                threadRunResultMap.put(\"status\", \"\");" + NL + "                threadLocal.set(threadRunResultMap);" + NL;
  protected final String TEXT_150 = NL + "                ";
  protected final String TEXT_151 = NL + "                finally {" + NL + "                    Integer localErrorCode = (Integer)(((java.util.Map)threadLocal.get()).get(\"errorCode\"));" + NL + "                    String localStatus = (String)(((java.util.Map)threadLocal.get()).get(\"status\"));" + NL + "                    if (localErrorCode != null) {" + NL + "                        if (errorCode == null || localErrorCode.compareTo(errorCode) > 0) {" + NL + "                           errorCode = localErrorCode;" + NL + "                        }" + NL + "                    }" + NL + "                    if (!status.equals(\"failure\")){" + NL + "                        status = localStatus;" + NL + "                    }" + NL + "" + NL + "                    if (\"true\".equals(((java.util.Map) threadLocal.get()).get(\"JobInterrupted\"))) {" + NL + "                        launchingThread.interrupt();" + NL + "                    }" + NL + "" + NL + "                    runningThreadCount.add(-1);" + NL + "                }" + NL + "            }" + NL + "        }.start();" + NL;
  protected final String TEXT_152 = NL + "    boolean interrupted = false;" + NL + "    while (runningThreadCount.getCount() > 0) {" + NL + "        try {" + NL + "            Thread.sleep(10);" + NL + "        } catch (java.lang.InterruptedException e) {" + NL + "            interrupted = true;" + NL + "        } catch (java.lang.Exception e) {" + NL + "            e.printStackTrace();" + NL + "        }" + NL + "    }" + NL + "" + NL + "    if (interrupted) {" + NL + "        Thread.currentThread().interrupt();" + NL + "    }" + NL + NL;
  protected final String TEXT_153 = NL;
  protected final String TEXT_154 = NL + NL + "this.globalResumeTicket = true;//to run tPostJob" + NL;
  protected final String TEXT_155 = NL;
  protected final String TEXT_156 = NL;
  protected final String TEXT_157 = NL;
  protected final String TEXT_158 = NL + NL + "        end = System.currentTimeMillis();" + NL + "" + NL + "        if (watch) {" + NL + "            System.out.println((end-startTime)+\" milliseconds\");" + NL + "        }" + NL + "" + NL + "        endUsedMemory = Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory();" + NL + "        if (false) {" + NL + "            System.out.println((endUsedMemory - startUsedMemory) + \" bytes memory increase when running : ";
  protected final String TEXT_159 = "\");" + NL + "        }";
  protected final String TEXT_160 = NL + "        ";
  protected final String TEXT_161 = ".addMessage(status==\"\"?\"end\":status, (end-startTime));" + NL + "        try {";
  protected final String TEXT_162 = NL + "            ";
  protected final String TEXT_163 = "Process(globalMap);" + NL + "        } catch (java.lang.Exception e) {" + NL + "            e.printStackTrace();" + NL + "        }";
  protected final String TEXT_164 = NL;
  protected final String TEXT_165 = NL + "    closeJmsConnections();";
  protected final String TEXT_166 = NL;
  protected final String TEXT_167 = NL + "    closeScpConnections();";
  protected final String TEXT_168 = NL;
  protected final String TEXT_169 = NL + "    if (false";
  protected final String TEXT_170 = " || null == eventFeature";
  protected final String TEXT_171 = " || null == registry";
  protected final String TEXT_172 = ") { // TESB-8574: Fix SAM timeout issue in Studio" + NL + "        try {" + NL + "            Thread.sleep(5000);" + NL + "        } catch (InterruptedException e) {" + NL + "        }" + NL + "    }";
  protected final String TEXT_173 = NL + NL;
  protected final String TEXT_174 = NL + "if (execStat) {" + NL + "    runStat.updateStatOnJob(RunStat.JOBEND, fatherNode);" + NL + "    runStat.stopThreadStat();" + NL + "}";
  protected final String TEXT_175 = NL + "        runTrace.stopThreadTrace();";
  protected final String TEXT_176 = NL + "    int returnCode = 0;" + NL + "    if(errorCode == null) {" + NL + "         returnCode = status != null && status.equals(\"failure\") ? 1 : 0;" + NL + "    } else {" + NL + "         returnCode = errorCode.intValue();" + NL + "    }" + NL + "    resumeUtil.addLog(\"JOB_ENDED\", \"JOB:\" + jobName, parent_part_launcher, Thread.currentThread().getId() + \"\", \"\",\"\" + returnCode,\"\",\"\",\"\");" + NL + "" + NL + "    return returnCode;" + NL + "" + NL + "  }" + NL + "" + NL + "    // only for OSGi env" + NL + "    public void destroy() {";
  protected final String TEXT_177 = NL + "    closeJmsConnections();";
  protected final String TEXT_178 = NL + "    closeScpConnections();";
  protected final String TEXT_179 = NL + "    closeSqlDbConnections();";
  protected final String TEXT_180 = NL + "    closeCassandraConnections();";
  protected final String TEXT_181 = NL + "    closeHBaseConnections();";
  protected final String TEXT_182 = NL + "    closeFtpConnections();";
  protected final String TEXT_183 = NL + "    closeS3Connections();";
  protected final String TEXT_184 = NL + "    closeLDAPConnections();";
  protected final String TEXT_185 = NL + "    closeMDMConnections();";
  protected final String TEXT_186 = NL + "    closePaloConnections();";
  protected final String TEXT_187 = NL + "    closeEXistConnections();";
  protected final String TEXT_188 = NL + "    closeGSConnections();";
  protected final String TEXT_189 = NL + NL + NL + "    }" + NL;
  protected final String TEXT_190 = NL + "    private void closeJmsConnections() {" + NL + "        try {" + NL + "            Object obj_conn;";
  protected final String TEXT_191 = NL + "            obj_conn = globalMap.remove(\"connection_";
  protected final String TEXT_192 = "\");" + NL + "            if (null != obj_conn) {" + NL + "                ((javax.jms.Connection) obj_conn).close();" + NL + "            }";
  protected final String TEXT_193 = NL + "        } catch (java.lang.Exception e) {" + NL + "        }" + NL + "    }";
  protected final String TEXT_194 = NL;
  protected final String TEXT_195 = NL + "    private void closeScpConnections() {" + NL + "        try {" + NL + "            Object obj_conn;";
  protected final String TEXT_196 = NL + "            obj_conn = globalMap.remove(\"conn_";
  protected final String TEXT_197 = "\");" + NL + "            if (null != obj_conn) {" + NL + "                ((ch.ethz.ssh2.Connection) obj_conn).close();" + NL + "            }";
  protected final String TEXT_198 = NL + "        } catch (java.lang.Exception e) {" + NL + "        }" + NL + "    }";
  protected final String TEXT_199 = NL;
  protected final String TEXT_200 = NL + "    private void closeSqlDbConnections() {" + NL + "        try {" + NL + "            Object obj_conn;";
  protected final String TEXT_201 = NL + "            obj_conn = globalMap.remove(\"conn_";
  protected final String TEXT_202 = "\");" + NL + "            if (null != obj_conn) {" + NL + "                ((java.sql.Connection) obj_conn).close();" + NL + "            }";
  protected final String TEXT_203 = NL + "        } catch (java.lang.Exception e) {" + NL + "        }" + NL + "    }";
  protected final String TEXT_204 = NL;
  protected final String TEXT_205 = NL + "    private void closeCassandraConnections() {" + NL + "        try {" + NL + "            Object obj_cluster;" + NL + "            Object obj_conn;";
  protected final String TEXT_206 = NL + "            obj_cluster = globalMap.remove(\"cluster_";
  protected final String TEXT_207 = "\");" + NL + "            obj_conn = globalMap.remove(\"connection_";
  protected final String TEXT_208 = "\");" + NL + "            if(obj_conn != null) {" + NL + "                ((com.datastax.driver.core.Session) obj_conn).close();" + NL + "            }" + NL + "            if(obj_cluster != null) {" + NL + "                ((com.datastax.driver.core.Cluster) obj_cluster).close();" + NL + "            }";
  protected final String TEXT_209 = NL + "            obj_conn = globalMap.remove(\"cluster_";
  protected final String TEXT_210 = "\");" + NL + "            if(obj_conn!=null) {" + NL + "                ((me.prettyprint.hector.api.Cluster) obj_conn).getConnectionManager().shutdown();" + NL + "            }";
  protected final String TEXT_211 = NL + "        } catch (java.lang.Exception e) {" + NL + "        }" + NL + "    }";
  protected final String TEXT_212 = NL;
  protected final String TEXT_213 = NL + "    private void closeHBaseConnections() {" + NL + "        try {";
  protected final String TEXT_214 = NL + "   \t\t\torg.apache.hadoop.conf.Configuration conn_";
  protected final String TEXT_215 = " =(org.apache.hadoop.conf.Configuration)globalMap.get(\"conn_";
  protected final String TEXT_216 = "\");" + NL + "\t\t\tif(conn_";
  protected final String TEXT_217 = " != null )" + NL + "\t        {" + NL + "\t\t\t";
  protected final String TEXT_218 = NL + "\t\t        org.apache.hadoop.hbase.client.HConnection hConnection_";
  protected final String TEXT_219 = " = org.apache.hadoop.hbase.client.HConnectionManager.getConnection(conn_";
  protected final String TEXT_220 = ");" + NL + "\t\t        if ((hConnection_";
  protected final String TEXT_221 = " != null) && (!hConnection_";
  protected final String TEXT_222 = ".isClosed())) {" + NL + "\t\t\t\t    hConnection_";
  protected final String TEXT_223 = ".close();" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_224 = NL + "\t\t\t\torg.apache.hadoop.hbase.client.HConnectionManager.deleteConnection(conn_";
  protected final String TEXT_225 = ",true);" + NL + "\t\t\t";
  protected final String TEXT_226 = NL + "\t\t\t}" + NL + "      globalMap.remove(\"conn_";
  protected final String TEXT_227 = "\");" + NL + "\t";
  protected final String TEXT_228 = NL + "        } catch (java.lang.Exception e) {" + NL + "        }" + NL + "    }";
  protected final String TEXT_229 = NL;
  protected final String TEXT_230 = NL + "    private void closeFtpConnections() {" + NL + "        try {" + NL + "            Object obj_conn;";
  protected final String TEXT_231 = NL + "            obj_conn = globalMap.remove(\"conn_";
  protected final String TEXT_232 = "\");" + NL + "            if (obj_conn != null) {";
  protected final String TEXT_233 = NL + "                ((com.enterprisedt.net.ftp.FTPClient) obj_conn).quit();";
  protected final String TEXT_234 = NL + "                ((com.jcraft.jsch.ChannelSftp) obj_conn).quit();";
  protected final String TEXT_235 = NL + "                ((it.sauronsoftware.ftp4j.FTPClient) obj_conn).disconnect(true);";
  protected final String TEXT_236 = NL + "            }";
  protected final String TEXT_237 = NL + "        } catch (java.lang.Exception e) {" + NL + "        }" + NL + "    }";
  protected final String TEXT_238 = NL;
  protected final String TEXT_239 = NL + "    private void closeS3Connections() {" + NL + "        try {";
  protected final String TEXT_240 = NL + "    \tcom.amazonaws.services.s3.AmazonS3Client conn_";
  protected final String TEXT_241 = " = (com.amazonaws.services.s3.AmazonS3Client)globalMap.get(\"conn_";
  protected final String TEXT_242 = "\");" + NL + "\t    if(conn_";
  protected final String TEXT_243 = " !=null){" + NL + "\t\t\tconn_";
  protected final String TEXT_244 = ".shutdown();" + NL + "\t\t}";
  protected final String TEXT_245 = NL + "        } catch (java.lang.Exception e) {" + NL + "        }" + NL + "    }";
  protected final String TEXT_246 = NL;
  protected final String TEXT_247 = NL + "    private void closeLDAPConnections() {" + NL + "        try {" + NL + "            Object obj_conn;";
  protected final String TEXT_248 = NL + "            obj_conn = globalMap.remove(\"conn_";
  protected final String TEXT_249 = "\");" + NL + "            if (obj_conn != null) {" + NL + "                ((javax.naming.ldap.InitialLdapContext) obj_conn).close();" + NL + "            }";
  ...
  protected final String TEXT_254 = NL + "    private void closePaloConnections() {" + NL + "        try {";
  protected final String TEXT_255 = NL + "    \torg.talend.jpalo.paloconnection pConn_";
  protected final String TEXT_256 = " = (org.talend.jpalo.paloconnection)globalMap.get(\"pConn_";
  protected final String TEXT_257 = "\");" + NL + "\t    if(pConn_";
  protected final String TEXT_258 = " !=null){" + NL + "\t\t\t\t\tpConn_";
  protected final String TEXT_259 = ".logout();" + NL + "" + NL + "\t\t}";
  ...
  protected final String TEXT_270 = NL + "    private void closeGSConnections() {" + NL + "        try {";
  protected final String TEXT_271 = NL + "\t\torg.jets3t.service.impl.rest.httpclient.GoogleStorageService service_";
  protected final String TEXT_272 = " =" + NL + "\t\t\t\t(org.jets3t.service.impl.rest.httpclient.GoogleStorageService)globalMap.get(\"service_";
  protected final String TEXT_273 = "\");" + NL + "\t\tif(service_";
  protected final String TEXT_274 = " !=null){" + NL + "\t\t\t\tservice_";
  protected final String TEXT_275 = ".shutdown();" + NL + "\t    }" + NL;
  protected final String TEXT_276 = NL + "        } catch (java.lang.Exception e) {" + NL + "        }" + NL + "    }";
  protected final String TEXT_277 = NL + NL + "    private java.util.Map<String, Object> getSharedConnections4REST() {" + NL + "        java.util.Map<String, Object> connections = new java.util.HashMap<String, Object>();";
  protected final String TEXT_278 = NL + "            connections.put(\"connection_";
  protected final String TEXT_279 = "\", globalMap.get(\"connection_";
  protected final String TEXT_280 = "\"));" + NL + "            connections.put(\"session_";
  protected final String TEXT_281 = "\", globalMap.get(\"session_";
  protected final String TEXT_282 = "\"));";
  protected final String TEXT_283 = NL + "            connections.put(\"conn_";
  protected final String TEXT_284 = "\", globalMap.get(\"conn_";
  protected final String TEXT_285 = "\"));";
  protected final String TEXT_286 = NL + "            connections.put(\"conn_";
  protected final String TEXT_287 = "\", globalMap.get(\"conn_";
  protected final String TEXT_288 = "\"));";
  protected final String TEXT_289 = NL + "            connections.put(\"connection_";
  protected final String TEXT_290 = "\", globalMap.get(\"connection_";
  protected final String TEXT_291 = "\"));" + NL + "            connections.put(\"cluster_";
  protected final String TEXT_292 = "\", globalMap.get(\"cluster_";
  protected final String TEXT_293 = "\"));";
  protected final String TEXT_294 = NL + "            connections.put(\"cluster_";
  protected final String TEXT_295 = "\", globalMap.get(\"cluster_";
  ...
  protected final String TEXT_302 = NL + "            connections.put(\"conn_";
  protected final String TEXT_303 = "\", globalMap.get(\"conn_";
  protected final String TEXT_304 = "\"));";
  protected final String TEXT_305 = NL + "            connections.put(\"conn_";
  protected final String TEXT_306 = "\", globalMap.get(\"conn_";
  protected final String TEXT_307 = "\"));";
  protected final String TEXT_308 = NL + "            connections.put(\"conn_";
  protected final String TEXT_309 = "\", globalMap.get(\"conn_";
  protected final String TEXT_310 = "\"));" + NL + "            connections.put(\"connBaseDN_";
  protected final String TEXT_311 = "\", globalMap.get(\"connBaseDN_";
  protected final String TEXT_312 = "\"));";
  protected final String TEXT_313 = NL;
  protected final String TEXT_314 = NL + "            connections.put(\"mdmUrl_";
  protected final String TEXT_315 = "\", globalMap.get(\"mdmUrl_";
  protected final String TEXT_316 = "\"));" + NL + "            connections.put(\"username_";
  protected final String TEXT_317 = "\", globalMap.get(\"username_";
  protected final String TEXT_318 = "\"));" + NL + "            connections.put(\"password_";
  protected final String TEXT_319 = "\", globalMap.get(\"password_";
  protected final String TEXT_320 = "\"));" + NL + "            connections.put(\"useTransaction_";
  protected final String TEXT_321 = "\", globalMap.get(\"useTransaction_";
  protected final String TEXT_322 = "\"));" + NL + "            connections.put(\"useClientTranId_";
  protected final String TEXT_323 = "\", globalMap.get(\"useClientTranId_";
  protected final String TEXT_324 = "\"));";
  protected final String TEXT_325 = NL;
  protected final String TEXT_326 = NL + "            connections.put(\"p_";
  protected final String TEXT_327 = "\", globalMap.get(\"p_";
  protected final String TEXT_328 = "\"));" + NL + "            connections.put(\"pConn_";
  protected final String TEXT_329 = "\", globalMap.get(\"pConn_";
  protected final String TEXT_330 = "\"));";
  protected final String TEXT_331 = NL + "            connections.put(\"col_";
  protected final String TEXT_332 = "\", globalMap.get(\"col_";
  protected final String TEXT_333 = "\"));";
  protected final String TEXT_334 = NL;
  protected final String TEXT_335 = NL + "            connections.put(\"conn_";
  protected final String TEXT_336 = "\", globalMap.get(\"conn_";
  protected final String TEXT_337 = "\"));";
  protected final String TEXT_338 = NL + "            connections.put(\"conn_";
  protected final String TEXT_339 = "\", globalMap.get(\"conn_";
  protected final String TEXT_340 = "\"));";
  protected final String TEXT_341 = NL + "            connections.put(\"service_";
  protected final String TEXT_342 = "\", globalMap.get(\"service_";
