...
public class TSybaseOutputBulkFinallyJava
{
  protected static String nl;
  public static synchronized TSybaseOutputBulkFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSybaseOutputBulkFinallyJava result = new TSybaseOutputBulkFinallyJava();
    nl = null;
    return result;
  }
