...
public class TAssertMainJava
{
  ...
  protected final String TEXT_15 = "){" + NL + "   if (junitGlobalMap.get(\"tests.log\") == null) {" + NL + "        junitGlobalMap.put(\"tests.log\", new String());" + NL + "   }" + NL + "   if (junitGlobalMap.get(\"tests.nbFailure\") == null) {" + NL + "        junitGlobalMap.put(\"tests.nbFailure\", new Integer(0));" + NL + "   }" + NL + "   junitGlobalMap.put(\"tests.log\",((String)junitGlobalMap.get(\"tests.log\"))+\"";
  protected final String TEXT_16 = ":\"+ ";
  protected final String TEXT_17 = "+java.lang.System.getProperty(\"line.separator\"));" + NL + "   junitGlobalMap.put(\"tests.nbFailure\",((Integer)junitGlobalMap.get(\"tests.nbFailure\"))+1);" + NL + "}else{" + NL + "   assertTrue(";
