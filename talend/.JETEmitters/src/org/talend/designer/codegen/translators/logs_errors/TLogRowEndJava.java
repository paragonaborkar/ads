...
public class TLogRowEndJava
{
  ...
  protected final String TEXT_46 = NL + NL + "                    " + NL + "                    java.io.PrintStream consoleOut_";
  protected final String TEXT_47 = " = null;" + NL + "                    if (globalMap.get(\"tLogRow_CONSOLE\")!=null)" + NL + "                    {" + NL + "                    \tconsoleOut_";
  protected final String TEXT_48 = " = (java.io.PrintStream) globalMap.get(\"tLogRow_CONSOLE\");" + NL + "                    }" + NL + "                    else" + NL + "                    {" + NL + "                    \tconsoleOut_";
  protected final String TEXT_49 = " = new java.io.PrintStream(new java.io.BufferedOutputStream(System.out));" + NL + "                    \tglobalMap.put(\"tLogRow_CONSOLE\",consoleOut_";
  protected final String TEXT_50 = ");" + NL + "                    }" + NL + "                    " + NL + "                    consoleOut_";
  protected final String TEXT_51 = ".println(util_";
  protected final String TEXT_52 = ".format().toString());" + NL + "                    consoleOut_";
