...
public class TBufferOutputMainJava
{
  ...
  protected final String TEXT_37 = "] = ParserUtils.parseTo_String(";
  ...
  protected final String TEXT_45 = "                \t\t\t    " + NL + "\t    }else{" + NL + "\t    \trow_";
  protected final String TEXT_46 = "[";
  protected final String TEXT_47 = "] = null;" + NL + "\t    }";
  protected final String TEXT_48 = NL + "\tglobalBuffer.add(row_";
