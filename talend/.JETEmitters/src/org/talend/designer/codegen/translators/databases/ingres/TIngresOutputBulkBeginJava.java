...
public class TIngresOutputBulkBeginJava
{
  protected static String nl;
  public static synchronized TIngresOutputBulkBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TIngresOutputBulkBeginJava result = new TIngresOutputBulkBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_7 = ";" + NL + "\t\t" + NL + "\t\t/***********************************************************************/" + NL + "\t\t/** Set up file writer and create output (copied code)                **/" + NL + "\t\t/***********************************************************************/" + NL + "\t\t" + NL + "\t\tjava.io.File file_";
