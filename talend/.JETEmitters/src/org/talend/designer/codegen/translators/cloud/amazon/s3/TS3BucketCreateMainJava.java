...
public class TS3BucketCreateMainJava
{
  ...
  protected final String TEXT_180 = " - Creating a bucket with name:\" + ";
  protected final String TEXT_181 = ");" + NL + "\t\t";
  protected final String TEXT_182 = NL + "\t\tconn_";
  protected final String TEXT_183 = ".createBucket(";
  protected final String TEXT_184 = ");" + NL + "\t\t";
  protected final String TEXT_185 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_186 = " - Create the bucket successfully.\");" + NL + "\t\t";
  protected final String TEXT_187 = NL + "\t}catch(java.lang.Exception e_";
  protected final String TEXT_188 = "){" + NL + "\t\t";
  protected final String TEXT_189 = NL + "\t\t\tthrow(e_";
  protected final String TEXT_190 = ");" + NL + "\t\t";
  protected final String TEXT_191 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_192 = " - \" + e_";
  protected final String TEXT_193 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_194 = NL + "\t\t\tSystem.err.println(e_";
  protected final String TEXT_195 = ".getMessage());" + NL + "\t\t";
  protected final String TEXT_196 = NL + "\t}finally{" + NL + "\t\tif(conn_";
  protected final String TEXT_197 = " !=null){" + NL + "\t\t\tconn_";
  protected final String TEXT_198 = ".shutdown();" + NL + "\t\t}" + NL + "\t\t";
