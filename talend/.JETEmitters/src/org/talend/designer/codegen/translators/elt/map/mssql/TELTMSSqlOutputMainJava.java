...
public class TELTMSSqlOutputMainJava
{
  ...
  protected final String TEXT_93 = " = \"net.sourceforge.jtds.jdbc.Driver\";";
  protected final String TEXT_94 = NL + "    String driverClass_";
  protected final String TEXT_95 = " = \"com.microsoft.sqlserver.jdbc.SQLServerDriver\";";
  protected final String TEXT_96 = NL + "    java.lang.Class.forName(driverClass_";
  protected final String TEXT_97 = ");" + NL + "    String port_";
  ...
  protected final String TEXT_106 = " = \"jdbc:sqlserver://\" + ";
  protected final String TEXT_107 = " ;";
  protected final String TEXT_108 = NL + "    if (!\"\".equals(port_";
  protected final String TEXT_109 = ")) {" + NL + "    \turl_";
  protected final String TEXT_110 = " += \":\" + ";
  protected final String TEXT_111 = ";" + NL + "    }" + NL + "    if (!\"\".equals(dbname_";
  protected final String TEXT_112 = ")) {" + NL + "    \t";
  protected final String TEXT_113 = NL + "    \turl_";
  protected final String TEXT_114 = " += \"//\" + ";
  protected final String TEXT_115 = "; " + NL + "    \t";
  protected final String TEXT_116 = NL + "    \turl_";
  protected final String TEXT_117 = " += \";databaseName=\" + ";
  ...
  protected final String TEXT_126 = "String decryptedPassword_";
  protected final String TEXT_127 = " = null;";
  protected final String TEXT_128 = " " + NL + "\tdecryptedPassword_";
  ...
  protected final String TEXT_139 = NL + NL + NL + "java.sql.PreparedStatement pstmt_";
  protected final String TEXT_140 = " =null;" + NL + "\t";
  protected final String TEXT_141 = "\t" + NL + "\tString insertQuery = \"INSERT INTO \"+tableName_";
  protected final String TEXT_142 = "+\"(";
  protected final String TEXT_143 = ")  (\"+select_query+\")\";" + NL + "\tpstmt_";
  protected final String TEXT_144 = " = conn_";
  protected final String TEXT_145 = ".prepareStatement(insertQuery);" + NL;
  protected final String TEXT_146 = NL + "\tString updateQuery = \"UPDATE \"+tableName_";
  protected final String TEXT_147 = "+\" SET ";
  protected final String TEXT_148 = " \"";
  protected final String TEXT_149 = NL + "\t\t+\"  WHERE \" + ";
  protected final String TEXT_150 = NL + "\t;" + NL + "\tpstmt_";
  protected final String TEXT_151 = " = conn_";
  protected final String TEXT_152 = ".prepareStatement(updateQuery);" + NL;
  protected final String TEXT_153 = NL + "\t" + NL + "\tString deleteQuery = \"DELETE  FROM \"+ tableName_";
  protected final String TEXT_154 = "+\" WHERE EXISTS (\"+select_query+\") \" " + NL + "\t";
  ...
  protected final String TEXT_159 = ".prepareStatement(deleteQuery);" + NL + "" + NL + "\t";
  ...
  protected final String TEXT_165 = NL + NL + "System.out.println(\"Inserting with : \\n\" + insertQuery + \"\\n\");";
  ...
  protected final String TEXT_169 = NL + "System.out.println(\"--> \" + nb_line_inserted_";
  protected final String TEXT_170 = " + \" rows inserted. \\n\");" + NL + "" + NL + "\t";
  protected final String TEXT_171 = NL + "System.out.println(\"Updating with : \\n\" + updateQuery +\"\\n\");";
  protected final String TEXT_172 = " " + NL + "nb_line_updated_";
  protected final String TEXT_173 = " = pstmt_";
  protected final String TEXT_174 = ".executeUpdate();";
  protected final String TEXT_175 = NL + "\tSystem.out.println(\"--> \" + nb_line_updated_";
  protected final String TEXT_176 = " + \" rows updated. \\n\");" + NL + "\t";
  protected final String TEXT_177 = NL + "\tSystem.out.println(\"Deleting with : \\n\" + deleteQuery +\"\\n\");" + NL + "\t\t";
  protected final String TEXT_178 = " " + NL + "\t\tnb_line_deleted_";
  protected final String TEXT_179 = " = pstmt_";
  protected final String TEXT_180 = ".executeUpdate();" + NL + "\t\t";
  protected final String TEXT_181 = NL + "\tSystem.out.println(\"--> \" + nb_line_deleted_";
  protected final String TEXT_182 = " + \" rows deleted. \\n\");" + NL + "\t\t";
  protected final String TEXT_183 = NL + NL + "pstmt_";
  protected final String TEXT_184 = ".close();" + NL;
  protected final String TEXT_185 = NL + "    if(conn_";
  protected final String TEXT_186 = " != null && !conn_";
  protected final String TEXT_187 = ".isClosed()) {" + NL + "\t\t";
  protected final String TEXT_188 = NL + "    }";
  protected final String TEXT_189 = NL + "nb_line_";
  protected final String TEXT_190 = " = nb_line_updated_";
  protected final String TEXT_191 = " + nb_line_inserted_";
  protected final String TEXT_192 = " + nb_line_deleted_";
  protected final String TEXT_193 = ";" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_194 = "_NB_LINE\",nb_line_";
  protected final String TEXT_195 = ");" + NL + "globalMap.put(\"";
  protected final String TEXT_196 = "_NB_LINE_UPDATED\",nb_line_updated_";
  protected final String TEXT_197 = ");" + NL + "globalMap.put(\"";
  protected final String TEXT_198 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  ...
  protected final String TEXT_203 = " - Has ";
  protected final String TEXT_204 = " records count: \" + nb_line_";
