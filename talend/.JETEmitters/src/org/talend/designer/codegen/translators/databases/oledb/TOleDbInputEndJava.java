...
public class TOleDbInputEndJava
{
  ...
  protected final String TEXT_45 = NL + "oBool_";
  protected final String TEXT_46 = " = (Boolean)reader_";
  protected final String TEXT_47 = ".invokeGeneric(\"Read\");" + NL + "bool_";
  protected final String TEXT_48 = " = oBool_";
  protected final String TEXT_49 = " != null && oBool_";
  protected final String TEXT_50 = ".booleanValue();" + NL + "}" + NL + "//stmt_";
  protected final String TEXT_51 = ".close();" + NL + "//conn_";
  protected final String TEXT_52 = " .close();" + NL + "globalMap.put(\"";
