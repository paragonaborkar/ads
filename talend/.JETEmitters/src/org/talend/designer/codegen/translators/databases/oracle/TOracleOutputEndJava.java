...
public class TOracleOutputEndJava
{
  ...
  protected final String TEXT_105 = NL + "        \t    }" + NL + "            }catch (java.sql.BatchUpdateException e){" + NL + "            \t";
  protected final String TEXT_106 = NL + "           \t\t    String errormessage_";
  protected final String TEXT_107 = " = printSQLException_";
  protected final String TEXT_108 = ".getSQLException(e,true);" + NL + "           \t\t    ";
  protected final String TEXT_109 = NL + "            \t\tthrow(e);" + NL + "            \t";
  protected final String TEXT_110 = NL + "            \t    String errormessage_";
  protected final String TEXT_111 = " = printSQLException_";
  protected final String TEXT_112 = ".getSQLException(e,false);" + NL + "            \t    ";
  ...
  protected final String TEXT_121 = NL + "    \t    \t    deletedCount_";
  protected final String TEXT_122 = NL + "    \t    \t";
  protected final String TEXT_123 = NL + "    \t    \t+= (tmp_batchUpdateCount_";
  protected final String TEXT_124 = "!=-1?tmp_batchUpdateCount_";
  ...
  protected final String TEXT_130 = NL + "\t\t\t\tSharedDBPreparedStatement.releasePreparedStatement(keyPsmt_";
  protected final String TEXT_131 = ");" + NL + "\t\t\t";
  protected final String TEXT_132 = NL + "        }";
  protected final String TEXT_133 = NL + "\t\tif(commitCounter_";
  ...
  protected final String TEXT_141 = NL + "\t\tresourceMap.put(\"finish_";
  protected final String TEXT_142 = "\", true);" + NL + "   \t";
  protected final String TEXT_143 = NL + NL + NL + "\t";
  protected final String TEXT_144 = NL + "\tnb_line_deleted_";
  protected final String TEXT_145 = "=nb_line_deleted_";
  protected final String TEXT_146 = "+ deletedCount_";
  protected final String TEXT_147 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_148 = "=nb_line_update_";
  protected final String TEXT_149 = " + updatedCount_";
  protected final String TEXT_150 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_151 = "=nb_line_inserted_";
  protected final String TEXT_152 = " + insertedCount_";
  protected final String TEXT_153 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_154 = "=nb_line_rejected_";
  protected final String TEXT_155 = " + rejectedCount_";
  protected final String TEXT_156 = ";" + NL + "\t";
  protected final String TEXT_157 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_158 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_159 = "_NB_LINE\",nb_line_";
  protected final String TEXT_160 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_161 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_162 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_163 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_164 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_165 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_166 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_167 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_168 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_169 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_170 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_173 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  ...
  protected final String TEXT_176 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_181 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_182 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_183 = "_NB_LINE_REJECTED\",nb_line_rejected_";
  protected final String TEXT_184 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_185 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_186 = "_NB_LINE_REJECTED\") + nb_line_rejected_";
