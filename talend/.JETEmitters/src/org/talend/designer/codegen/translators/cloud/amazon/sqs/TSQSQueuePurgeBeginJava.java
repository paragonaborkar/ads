...
public class TSQSQueuePurgeBeginJava
{
  ...
  protected final String TEXT_77 = " - Purging a queue with name:\" + ";
  protected final String TEXT_78 = ");" + NL + "\t\t";
  protected final String TEXT_79 = NL + "        conn_";
  protected final String TEXT_80 = ".purgeQueue(new com.amazonaws.services.sqs.model.PurgeQueueRequest(";
  protected final String TEXT_81 = "));" + NL + "        " + NL + "\t\t";
  protected final String TEXT_82 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_83 = " - Purge queue successfully.\");" + NL + "\t\t";
