...
public class TPaloOutputMainJava
{
  ...
  protected final String TEXT_15 = NL + "\t\t\t\t\tstrArrTalendQuery[";
  ...
  protected final String TEXT_29 = " - Committing cube .\");" + NL + "\t\t\t\t";
  protected final String TEXT_30 = NL + "\t\t\t\tplDb_";
  protected final String TEXT_31 = ".commitCube(cube_";
  protected final String TEXT_32 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_33 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_34 = " - Commit has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_35 = NL + "\t\t\t\tnb_commit_count_";
  protected final String TEXT_36 = " =0;" + NL + "\t\t\t}" + NL + "\t\t\t";
