...
@Injectable()
export class OwnersOfAVolumeService {

  constructor(private http: Http) { }

  private serviceUrl = 'http://localhost:8080/owners-of-a-volume.json';
  
  getOwners(jsonUrl?:string): Observable<SpringRestResponse> {
    console.log(jsonUrl);
    if (jsonUrl) {
