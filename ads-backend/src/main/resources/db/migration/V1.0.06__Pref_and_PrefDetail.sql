...
INSERT INTO `preference_detail` ( `preference_id`, `field_name`, `field_order`, `field_visible`, `field_prop`) VALUES (2,  'userRole', 1, '1', 'userRole.userRole');
...
INSERT INTO `preference_detail` ( `preference_id`, `field_name`, `field_order`, `field_visible`, `field_prop`) VALUES (3,  'userRole', 1, '1', 'userRole.userRole');
