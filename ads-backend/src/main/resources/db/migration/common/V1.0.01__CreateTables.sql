...
#--  `vserver` varchar(255) DEFAULT NULL COMMENT 'vServer of the Activity', 
  `will_decommission` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Boolean indicating if the Owner(s) will decommission the QTree.',
  `decommission_date` date DEFAULT NULL COMMENT 'Date on which the QTree can be decommissioned.',
...
#  -- `is_latest` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'DEV TBD -  Boolean indicating if the Activity is the latest. We may be able to get this from the create time. So this may not be needed. Could save us time/code to set this column.',
  ...
  `unidentified_reason` varchar(1024) DEFAULT NULL COMMENT 'Why the Activity doesnt have a potential Owner.',
