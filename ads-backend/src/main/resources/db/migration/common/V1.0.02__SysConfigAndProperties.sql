...
INSERT INTO `sys_config` (`property_name`, `property_value`, `property_type_id`, `encrypted`, `grouping`) VALUES('security.jwt.client-secret', 'sdjlh9#$380231funej01382#$','1',0,'Security');
