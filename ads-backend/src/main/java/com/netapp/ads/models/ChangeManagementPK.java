...
/**
 * The primary key class for the change_management database table.
 * 
 */
@Embeddable
public class ChangeManagementPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof ChangeManagementPK)) {
			return false;
		}
		ChangeManagementPK castOther = (ChangeManagementPK)other;
		return 
