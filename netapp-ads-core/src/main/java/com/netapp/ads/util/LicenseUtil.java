...
public class LicenseUtil {
    ...
    public static HashMap<String, String> LICENSE_INFO; 
    
    public static boolean isLicenseActive() throws Exception {
    	if(ACTIVE_MODULES == null) {
    		...
    		LICENSE_INFO = completeLicenseInfo.get("licenseInfo");
    		log.info("The following ADS modules are enabled:");
    	}
		...
		boolean isActive = Boolean.parseBoolean(LICENSE_INFO.get("license_active"));
		return isActive;
    }
    
   private static HashMap<String, HashMap>  checkLicense() throws Exception {
